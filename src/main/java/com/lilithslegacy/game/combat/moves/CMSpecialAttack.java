...
public class CMSpecialAttack {
    ...
    public static final AbstractCombatMove HORSE_KICK = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "hoof kick",
            1,
            2,
            1,
    ...
    public static final AbstractCombatMove CAT_SCRATCH = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "scratch",
            1,
            1,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove TAIL_SWIPE = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "tail swipe",
            2,
            3,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove SQUIRREL_SCRATCH = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "squirrel scratch",
            1,
            1,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove WOLF_SAVAGE = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "savage attack",
            6,
            3,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove ANTLER_HEADBUTT = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "antler headbutt",
            1,
            2,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove COW_HEADBUTT = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "horn headbutt",
            1,
            2,
            CombatMoveType.ATTACK,
    ...
    public static final AbstractCombatMove BITE = new AbstractCombatMove(CombatMoveCategory.SPECIAL,
            "feral bite",
            1,
            2,
            CombatMoveType.ATTACK,
