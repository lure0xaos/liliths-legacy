    ...
    public static float getModifiedDamage(GameCharacter attacker, GameCharacter defender, CombatMoveType combatMoveType, Attack attackType, AbstractWeapon weapon, DamageType damageType, float attackersDamage) {
        ...
        if (attacker != null && attacker.isElemental()) {
            switch (attacker.getBodyMaterial()) {
                case AIR:
                    damageDoubledFromElemental = attacker.hasStatusEffect(StatusEffect.ELEMENTAL_AIR_SERVANT_OF_AIR_ELEMENTAL_BUFF);
                    break;
                case ARCANE:
                    damageDoubledFromElemental = attacker.hasStatusEffect(StatusEffect.ELEMENTAL_ARCANE_SERVANT_OF_ARCANE_ELEMENTAL_BUFF);
                    break;
                case FIRE:
                    damageDoubledFromElemental = attacker.hasStatusEffect(StatusEffect.ELEMENTAL_FIRE_SERVANT_OF_FIRE_ELEMENTAL_BUFF);
                    break;
                case FLESH:
                case SLIME:
                case SILICONE:
                ...
                case RUBBER:
                case STONE:
                    damageDoubledFromElemental = attacker.hasStatusEffect(StatusEffect.ELEMENTAL_EARTH_SERVANT_OF_EARTH_ELEMENTAL_BUFF);
                    break;
                case ICE:
                case WATER:
                    damageDoubledFromElemental = attacker.hasStatusEffect(StatusEffect.ELEMENTAL_WATER_SERVANT_OF_WATER_ELEMENTAL_BUFF);
                    break;
            }
        }
