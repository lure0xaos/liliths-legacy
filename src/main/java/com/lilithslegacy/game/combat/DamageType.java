...
public enum DamageType {
    ...
    private final String weaponDescriptor;
    private final AbstractAttribute resistAttribute;
    private final AbstractAttribute multiplierAttribute;
    private final SpellSchool spellSchool;
    private final DamageType parentDamageType;

    DamageType(String name, Colour colour, String weaponDescriptor, AbstractAttribute resistAttribute, AbstractAttribute multiplierAttribute, SpellSchool spellSchool, DamageType parentDamageType) {
        this.name = name;
        this.colour = colour;
