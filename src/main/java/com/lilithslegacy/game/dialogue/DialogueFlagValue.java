...
//						System.out.println("modded DFV: "+innerEntry.getKey()+" "+loadedFlag.getId());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded dialogueFlagValue failed at 'DialogueFlagValue'. FSPath path: " + innerEntry.getValue());
...
//						System.out.println("res DFV: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading dialogueFlagValue failed at 'DialogueFlagValue'. FSPath path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
