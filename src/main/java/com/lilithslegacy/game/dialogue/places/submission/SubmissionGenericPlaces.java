package com.lilithslegacy.game.dialogue.places.submission;
...
import com.lilithslegacy.game.dialogue.story.LyssiethReveal;
...
public class SubmissionGenericPlaces {
    ...
    public static final DialogueNode TUNNEL = new DialogueNode("Tunnels", "", false) {
        ...
        public String getContent() {
            ...
            if (!pacified) {
                UtilText.nodeContentSB.append("<span style='color:").append(Main.game.getPlayer().getLocationPlace().getPlaceType().getColour().toWebHexString()).append(";'>").append(UtilText.parseFromXMLFile("places/submission/submissionPlaces", "TUNNEL_IMP_CONTROL")).append("</span>");
            }

            for (NPC npc : Main.game.getCharactersTreatingCellAsHome(Main.game.getPlayerCell())) {
                UtilText.nodeContentSB.append(npc.getPresentInTileDescription(!pacified));
            }
