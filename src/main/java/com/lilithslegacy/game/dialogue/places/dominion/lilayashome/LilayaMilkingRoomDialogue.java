...
public class LilayaMilkingRoomDialogue {
    ...
    public static final DialogueNode MILKING_ROOM = new DialogueNode("Room", "", false) {
        ...
        public String getContent() {
            ...
            sb.append("<p>" + "<b style='color:").append(PlaceUpgrade.LILAYA_MILKING_ROOM.getColour().toWebHexString()).append(";'>").append(PlaceUpgrade.LILAYA_MILKING_ROOM.getName()).append("</b><br/>").append("This large room has been converted into a milking room, in which eight of your slaves can be milked of their various fluids.").append(" Four machines are set along the left-hand side of the wall, with the other four being placed on the opposite side of the room.").append("</p>");
                ...
                if (getMilkingTarget().getBreastRawStoredMilkValue() == 0) {
                    ...
                    return new Response(
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append("<p style='text-align:center; color:").append(PresetColour.MILK.toWebHexString()).append(";'>").append(Units.fluid(milked)).append(UtilText.parse(getMilkingTarget(), " of [npc.milk] added to this room's storage!")).append("</p>");
                        }
                ...
                if (!getMilkingTarget().hasPenisIgnoreDildo()) {
                    ...
                    return new Response(
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append("<p style='text-align:center; color:").append(PresetColour.CUM.toWebHexString()).append(";'>").append(Units.fluid(milked)).append(UtilText.parse(getMilkingTarget(), " of [npc.cum] added to this room's storage!")).append("</p>");
                        }
                ...
                if (!getMilkingTarget().hasVagina()) {
                    ...
                    return new Response(
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append("<p style='text-align:center; color:").append(PresetColour.GIRLCUM.toWebHexString()).append(";'>").append(Units.fluid(milked)).append(UtilText.parse(getMilkingTarget(), " of [npc.girlcum] added to this room's storage!")).append("</p>");
                        }
                ...
                if (!getMilkingTarget().hasBreastsCrotch()) {
                    ...
                    return new Response(
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append("<p style='text-align:center; color:").append(PresetColour.MILK.toWebHexString()).append(";'>").append(Units.fluid(milked)).append(UtilText.parse(getMilkingTarget(), " of [npc.crotchMilk] added to this room's storage!")).append("</p>");
                        }
