...
import com.lilithslegacy.game.character.npc.submission.RatGangMember;
...
import com.lilithslegacy.game.dialogue.places.submission.dicePoker.Dice;
import com.lilithslegacy.game.dialogue.places.submission.dicePoker.DiceFace;
...
import com.lilithslegacy.game.sex.managers.submission.SMVengarDominantSex;
...
public class RatWarrensDialogue {
    ...
    public static final DialogueNode CORRIDOR = new DialogueNode("Twisting Passageway", "", false) {
        ...
        public boolean isTravelDisabled() {
            return (Main.game.getPlayerCell().getPlace().getPlaceType() == PlaceType.RAT_WARRENS_CHECKPOINT_LEFT
                    && Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.ratWarrensClearedLeft) != Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.ratWarrensClearedCentre))
    ...
    public static final DialogueNode VENGARS_HALL_APPROACH_SEDUCE_NO_SEX = new DialogueNode("", "", true) {
        ...
        @Override
        public String getContent() {
            String sb = UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "VENGARS_HALL_APPROACH_SEDUCE_NO_SEX", getGuards(true)) +
                    UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "VENGARS_HALL_QUITTING_TALK", getGuards(true));
            return sb;
        }
    ...
    public static final DialogueNode VENGARS_HALL_APPROACH_SEDUCE_AFTER_SEX = new DialogueNode("Finished", "Vengar is satisfied, and brings an end to the sex...", true) {
        ...
        @Override
        public String getContent() {
            String sb = UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "VENGARS_HALL_APPROACH_SEDUCE_AFTER_SEX", getGuards(true)) +
                    UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "VENGARS_HALL_QUITTING_TALK", getGuards(true));
            return sb;
        }
...
//				}
    ...
    public static final DialogueNode DICE_DEN = new DialogueNode("Dice Den", "", false) {
        ...
        @Override
        public String getContent() {
            String sb = UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "DICE_DEN", getGuards(true)) +
                    UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "DICE_DEN_ENTRY", getGuards(true));
            return sb;
        }
                ...
                if (index == 1) {
                    ...
                    return new Response("Rum (" + UtilText.formatAsMoney(price, "span") + ")", "Buy a glass of rum from the rat behind the bar.", DICE_DEN_RUM) {
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append(Main.game.getItemGen().generateItem("innoxia_race_rat_black_rats_rum").applyEffect(Main.game.getPlayer(), Main.game.getPlayer())).append(Main.game.getPlayer().incrementMoney(-price));
                        }
                    };
                    ...
                    return new Response("Rum (" + UtilText.parse(getMainCompanion(), "[npc.name]") + ") (" + UtilText.formatAsMoney(price, "span") + ")",
                        ...
                        public void effects() {
                            ...
                            Main.game.getTextEndStringBuilder().append(UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "DICE_DEN_RUM_OFFER", getGuards(true)));
                            Main.game.getTextEndStringBuilder().append(Main.game.getItemGen().generateItem("innoxia_race_rat_black_rats_rum").applyEffect(getMainCompanion(), getMainCompanion())).append(Main.game.getPlayer().incrementMoney(-price));
                        }
                    };
    ...
    public static final DialogueNode DICE_DEN_POST_GAMBLING = new DialogueNode("Dice Den", "", false) {
        ...
        public String getContent() {
            String sb = UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "DICE_DEN", getGuards(true)) +
                    UtilText.parseFromXMLFile("places/submission/ratWarrens/core", "DICE_DEN_POST_GAMBLING", getGuards(true));
            return sb;
        }
    ...
    public static final DialogueNode AFTER_DICE_DEN_ORAL = new DialogueNode("Finished", "", false) {
        ...
        @Override
        public String getDescription() {
            return UtilText.parse(getGuards(false).get(0), "[npc.Name] has finished...");
        }
    ...
    public static List<GameCharacter> getGuards(boolean includeCompanion) {
        List<GameCharacter> guards = new ArrayList<>(Main.game.getCharactersPresent());
