...
import com.lilithslegacy.game.character.npc.dominion.DominionExpressCentaur;
...
import com.lilithslegacy.game.sex.managers.dominion.SMDominionExpress;
        ...
        public String getContent() {
            ...
            if (!wearingFillyCollar()) {
                ...
                for (FillyReward fr : fillyRewards) {
                    ...
                    sb.append(available.getKey() ? "[style.boldPink(" : "[style.boldBad(").append(fr.getName()).append(":)] ");
                    sb.append(points < fr.getCost() ? "[style.colourBad(" : "[style.colourPinkLight(").append(fr.getCost()).append(")] [style.colourPinkLight(Filly Points)]<br/>");
                    sb.append(fr.getDescription());
                    if (!available.getKey()) {
                        sb.append("<br/>[style.italicsBad(").append(available.getValue()).append(")]");
                    }
                    sb.append("</div>");
                }
                sb.append("</div>");
