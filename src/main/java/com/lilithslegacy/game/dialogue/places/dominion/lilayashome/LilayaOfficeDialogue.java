...
public class LilayaOfficeDialogue {
    ...
    public static final DialogueNode ROOM_OFFICE = new DialogueNode("Room", "", false) {
        ...
        public String getContent() {
            ...
            sb.append("<p>" + "<b style='color:").append(PlaceUpgrade.LILAYA_OFFICE.getColour().toWebHexString()).append(";'>").append(PlaceUpgrade.LILAYA_OFFICE.getName()).append("</b><br/>").append(PlaceUpgrade.LILAYA_OFFICE.getRoomDescription(Main.game.getPlayerCell())).append("</p>");
