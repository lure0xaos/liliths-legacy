...
public class RatWarrensCaptiveDialogue {
    ...
    private static String incrementPlayerObedience(int increment) {
        ...
        if (increment != 0) {
            sb.append("You ").append(increment > 0 ? "[style.boldGrow(gained)]" : "[style.boldShrink(lost)]").append(" <b>").append(Math.abs(increment)).append("</b> [style.boldObedience(obedience)]!<br/>");
        }
        sb.append("You are <span style='color:").append(level.getColour().toWebHexString()).append(";'>").append(level.getName()).append("</span>").append(" (<span style='color:").append(level.getColour().toWebHexString()).append(";'>").append(obedience).append("</span>/100), ");
        switch (level) {
            ...
            case POSITIVE_TWO_OBEDIENT:
                ...
                sb.append("<br/><i>At ").append(ObedienceLevel.POSITIVE_THREE_DISCIPLINED.getMinimumValue()).append("/100, you will be unable to refuse Murk's orders!</i>");
                break;
            ...
            case POSITIVE_FOUR_DUTIFUL:
                ...
                sb.append("<br/><i>At ").append(ObedienceLevel.POSITIVE_FIVE_SUBSERVIENT.getMinimumValue()).append("/100, you will do absolutely anything to please Murk!</i>");
                break;
                ...
                return new Response("Open wide",
                    ...
                    public void effects() {
                        ...
                        for (Entry<String, String> entry : effects.entrySet()) {
                            Main.game.getTextStartStringBuilder().append("<p>").append(UtilText.parse(getMurk(), "[npc.speech(" + entry.getKey() + ")]")).append("</p>").append(entry.getValue());
                        }
                    }
                };
