...
import com.lilithslegacy.game.character.npc.misc.BasicSlave;
...
import com.lilithslegacy.game.dialogue.places.dominion.helenaHotel.HelenaHotel;
...
import com.lilithslegacy.game.sex.managers.universal.SMStanding;
...
//				};
    ...
    public static final DialogueNode HELENAS_SHOP_CUSTOM_SLAVE_PERSONALITY = new DialogueNode("Customise Slave", "", true) {
        ...
        public String getHeaderContent() {
            ...
            String sb = UtilText.parseFromXMLFile("places/dominion/slaverAlley/helenasBoutique", "HELENAS_SHOP_CUSTOM_SLAVE_PERSONALITY") +
                    "<div class='container-full-width' style='padding:8px;'>" + "<div style='width:22%; float:left; font-weight:bold; margin:0 13% 0 0; padding:0; text-align:center;'>" + "Name" + "</div>" + "<div style='width:22%; float:left; font-weight:bold; margin:0 13% 0 0; padding:0; text-align:center;'>" + "Surname" + "</div>" + "<div style='width:24%; float:left; font-weight:bold; margin:0 6% 0 0; padding:0; text-align:center;'>" + UtilText.parse(getSlaveForCustomisation(), "What [npc.she] calls you") + "</div>" + "<form style='float:left; width:22%; margin:0; padding:0;'><input type='text' id='slaveNameInput'" + " value='" + UtilText.parseForHTMLDisplay(getSlaveForCustomisation().getName(false)) + "' style='width:100%; margin:0; padding:0;'></form>" + "<div class='normal-button' id='" + getSlaveForCustomisation().getId() + "_RENAME' style='float:left; width:5%; height:28px; line-height:28px; margin:0 0 0 0.5%; padding:0; text-align:center;'>" + "&#10003;" + "</div>" + "<div class='normal-button' id='" + getSlaveForCustomisation().getId() + "_RENAME_RANDOM' style='float:left; width:5%; height:28px; line-height:28px; margin:0 2% 0 0.5%; padding:0; text-align:center;'>" + "&#127922;" + "</div>" + "<form style='float:left; width:22%; margin:0; padding:0;'><input type='text' id='slaveSurnameInput'" + " value='" + UtilText.parseForHTMLDisplay(getSlaveForCustomisation().getSurname()) + "' style='width:100%; margin:0; padding:0;'></form>" + "<div class='normal-button' id='" + getSlaveForCustomisation().getId() + "_RENAME_SURNAME' style='float:left; width:5%; height:28px; line-height:28px; margin:0 0 0 0.5%; padding:0; text-align:center;'>" + "&#10003;" + "</div>" + "<div class='normal-button' id='" + getSlaveForCustomisation().getId() + "_RENAME_SURNAME_RANDOM' style='float:left; width:5%; height:28px; line-height:28px; margin:0 2% 0 0.5%; padding:0; text-align:center;'>" + "&#127922;" + "</div>" + "<form style='float:left; width:24%; margin:0; padding:0;'><input type='text' id='slaveToPlayerNameInput' value='" + UtilText.parseForHTMLDisplay(getSlaveForCustomisation().getPetName(Main.game.getPlayer())) + "' style='width:100%; margin:0; padding:0;'></form>" + "<div class='normal-button' id='" + getSlaveForCustomisation().getId() + "_CALLS_PLAYER' style='float:left; width:5%; height:28px; line-height:28px; margin:0 0 0 0.5%; padding:0; text-align:center;'>" + "&#10003;" + "</div>" + "</div>" +
                    "<div class='cosmetics-container' style='background:transparent;'>" + CharacterModificationUtils.getAgeChoiceDiv() + CharacterModificationUtils.getOrientationChoiceDiv() + CharacterModificationUtils.getPersonalityChoiceDiv(true) + CharacterModificationUtils.getObedienceChoiceDiv() + CharacterModificationUtils.getAffectionChoiceDiv() + CharacterModificationUtils.getFetishChoiceDiv() + "</div>" +
    ...
    public static final DialogueNode HELENAS_SHOP_CUSTOM_SLAVE_FINISH = new DialogueNode("Order Slave", "", true) {
        ...
        public String getHeaderContent() {
            ...
            sb.append("<div class='container-full-width' style='text-align:center;'>" + "<i>" + "More sexual experience will result in your slave gaining more corruption." + "</i>" + "</div>").append(CharacterModificationUtils.getSexualExperienceDiv());

            sb.append("<div class='container-full-width'>").append(UtilText.parse(BodyChanging.getTarget(), "<p style='text-align:center;'><b>[npc.NamePos] Appearance</b></p>")).append(BodyChanging.getTarget().getBodyDescription()).append("</div>");
