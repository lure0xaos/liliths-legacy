        ...
        public Response getResponse(int responseTab, int index) {
            if (index == 1) {
                return new Response("Thank her", "Thank Lilaya for showing you how to enchant items.", LAB_EXIT) {
                    @Override
                    public void effects() {
                        Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("places/dominion/lilayasHome/lab", "LILAYA_EXPLAINS_ESSENCES_END")).append(Main.game.getPlayer().setQuestProgress(QuestLine.SIDE_ENCHANTMENT_DISCOVERY, Quest.SIDE_UTIL_COMPLETE));
                    }
                };
                    ...
                    if (Main.game.getPlayer().getEssenceCount() >= 1) {
                        return new Response("Extract (1)", "Extract one of your arcane essences.", ESSENCE_EXTRACTION_BOTTLED) {
                            ...
                            public void effects() {
                                ...
                                Main.game.getTextEndStringBuilder().append("<p style='text-align:center;'>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Item added to inventory:</b> <b>").append((ItemType.BOTTLED_ESSENCE_ARCANE).getDisplayName(true)).append("</b>").append("</p>").append("<p>").append("You now have <b>").append(count).append(" ").append(count > 1 ? ItemType.BOTTLED_ESSENCE_ARCANE.getNamePlural(true) : ItemType.BOTTLED_ESSENCE_ARCANE.getName(true)).append("</b> in your inventory.").append("</p>");
                                Main.game.getPlayer().incrementEssenceCount(-1, false);
                            }
                        };
                    ...
                    if (Main.game.getPlayer().getEssenceCount() >= 5) {
                        return new Response("Extract (5)", "Extract five of your arcane essences.", ESSENCE_EXTRACTION_BOTTLED) {
                            ...
                            public void effects() {
                                ...
                                int count = Main.game.getPlayer().getItemCount(Main.game.getItemGen().generateItem(ItemType.BOTTLED_ESSENCE_ARCANE));
                                Main.game.getTextEndStringBuilder().append("<p>" + "Grabbing another vial, you set about repeating the process several times..." + "</p>" + "<p style='text-align:center;'>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Items added to inventory:</b> <b>5x</b> <b>").append(ItemType.BOTTLED_ESSENCE_ARCANE.getDisplayName(true)).append("</b>").append("</p>").append("<p>").append("You now have <b>").append(count).append(" ").append(count > 1 ? ItemType.BOTTLED_ESSENCE_ARCANE.getNamePlural(true) : ItemType.BOTTLED_ESSENCE_ARCANE.getName(true)).append("</b> in your inventory.").append("</p>");
                    ...
                    if (Main.game.getPlayer().getEssenceCount() >= 25) {
                        return new Response("Extract (25)", "Extract twenty-five of your arcane essences.", ESSENCE_EXTRACTION_BOTTLED) {
                            ...
                            public void effects() {
                                ...
                                int count = Main.game.getPlayer().getItemCount(Main.game.getItemGen().generateItem(ItemType.BOTTLED_ESSENCE_ARCANE));
                                Main.game.getTextEndStringBuilder().append("<p>" + "Grabbing another vial, you set about repeating the process several times..." + "</p>" + "<p style='text-align:center;'>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Items added to inventory:</b> <b>25x</b> <b>").append(ItemType.BOTTLED_ESSENCE_ARCANE.getDisplayName(true)).append("</b>").append("</p>").append("<p>").append("You now have <b>").append(count).append(" ").append(count > 1 ? ItemType.BOTTLED_ESSENCE_ARCANE.getNamePlural(true) : ItemType.BOTTLED_ESSENCE_ARCANE.getName(true)).append("</b> in your inventory.").append("</p>");
                    ...
                    if (Main.game.getPlayer().getEssenceCount() >= 1) {
                        return new Response("Extract (all)", "Extract all of your arcane essences.", ESSENCE_EXTRACTION_BOTTLED) {
                            ...
                            public void effects() {
                                ...
                                int count = Main.game.getPlayer().getItemCount(Main.game.getItemGen().generateItem(ItemType.BOTTLED_ESSENCE_ARCANE));
                                Main.game.getTextEndStringBuilder().append("<p>" + "Grabbing another vial, you set about repeating the process several times..." + "</p>" + "<p style='text-align:center;'>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Items added to inventory:</b> <b>").append(Main.game.getPlayer().getEssenceCount()).append("x</b> <b>").append(ItemType.BOTTLED_ESSENCE_ARCANE.getDisplayName(true)).append("</b>").append("</p>").append("<p>").append("You now have <b>").append(count).append(" ").append(count > 1 ? ItemType.BOTTLED_ESSENCE_ARCANE.getNamePlural(true) : ItemType.BOTTLED_ESSENCE_ARCANE.getName(true)).append("</b> in your inventory.").append("</p>");
