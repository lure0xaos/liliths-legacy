    ...
    public static final DialogueNode DEMON_HOME_STREET = new DialogueNode("Demon Home", "Demon Home", false) {
        ...
        public String getContent() {
            ...
            if (Main.game.getPlayerCell().getPlace().getPlaceType().equals(PlaceType.DOMINION_DEMON_HOME_DADDY)) {
                UtilText.nodeContentSB.append("<p>" + "<b style='color:").append(PresetColour.RACE_DEMON.toWebHexString()).append(";'>[daddy.NamePos] residence:</b><br/>").append("[daddy.NamePos] apartment is located in this particular area of Demon Home.").append(Daddy.getAvailabilityText()).append("</p>");
            }

            if (Main.game.getPlayerCell().getPlace().getPlaceType().equals(PlaceType.DOMINION_DEMON_HOME_ARTHUR)) {
                UtilText.nodeContentSB.append("<p>" + "<b style='color:").append(PresetColour.RACE_HUMAN.toWebHexString()).append(";'>Sawlty Towers:</b><br/>").append("Arthur's apartment building, 'Sawlty Towers', is located in this particular area of Demon Home.").append("</p>");
            }
...
//			sb.append(getAdditionalDescriptions());
    ...
    private static String getAdditionalDescriptions() {
        ...
        if (Main.game.getDateNow().getMonth() == Month.OCTOBER) {
            sb.append("<p>" + "<b style='color:").append(PresetColour.BASE_ORANGE.toWebHexString()).append(";'>October;</b> <b style='color:").append(PresetColour.GENERIC_ARCANE.toWebHexString()).append(";'>Lilith's Month:</b><br/>").append("Orange, black, and purple flags fly from almost every window, and you look up to see that large banners have been hung across the street, each one bearing a different slogan celebrating Lilith's rule.").append(" The occasional demon that you see is usually dressed up in a Halloween-esque costume for the occasion, which does nothing to help alleviate the eerie atmosphere.").append("</p>");
        }
