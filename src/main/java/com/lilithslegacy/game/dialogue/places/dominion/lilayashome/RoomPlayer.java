    ...
    private static String getCalendarImageDescription(Month month) {
        ...
        if (Util.random.nextInt() < 15) {
            ...
            switch (month) {
                ...
                case MAY:
                    if (Main.game.getPlayer().getSexualOrientation() == SexualOrientation.ANDROPHILIC) {
                        sb.append("a powerful dragon, who's sitting on a golden legacy perched on the top of a huge pile of treasure."
                        ...
                        sb.append("a powerful dragoness, who's sitting on a golden legacy perched on the top of a huge pile of treasure."
