package com.lilithslegacy.game.dialogue.places.submission.impFortress;
...
import com.lilithslegacy.game.sex.managers.universal.SMAllFours;
import com.lilithslegacy.game.sex.managers.universal.SMLyingDown;
                    ...
                    public void effects() {
                        if (isAlphaFortress() || Main.game.getPlayer().getLocationPlace().getPlaceType().equals(PlaceType.SUBMISSION_IMP_FORTRESS_ALPHA)) {
                            ...
                            if ((boss).isAbleToEquipGag(Main.game.getPlayer())) {
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced you to wear:<br/>").append(Main.game.getPlayer().getClothingInSlot(ringGag.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            ...
                            if (ImpFortressDialogue.getMainCompanion() != null && Main.sex.getAllParticipants().contains(ImpFortressDialogue.getMainCompanion())
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced ").append(UtilText.parse(ImpFortressDialogue.getMainCompanion(), "[npc.name]")).append(" to wear:<br/>").append(ImpFortressDialogue.getMainCompanion().getClothingInSlot(ringGag.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            ...
                            if (boss.isAbleToEquipButtPlug(Main.game.getPlayer())) {
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced you to wear:<br/>").append(Main.game.getPlayer().getClothingInSlot(buttPlug.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            ...
                            if (ImpFortressDialogue.getMainCompanion() != null && Main.sex.getAllParticipants().contains(ImpFortressDialogue.getMainCompanion())
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced ").append(UtilText.parse(ImpFortressDialogue.getMainCompanion(), "[npc.name]")).append(" to wear:<br/>").append(ImpFortressDialogue.getMainCompanion().getClothingInSlot(buttPlug.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            ...
                            if (boss.isAbleToEquipThong(Main.game.getPlayer())) {
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced you to wear:<br/>").append(Main.game.getPlayer().getClothingInSlot(thong.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            if (boss.isAbleToEquipDildo(Main.game.getPlayer())) {
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced you to wear:<br/>").append(Main.game.getPlayer().getClothingInSlot(dildo.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            ...
                            if (ImpFortressDialogue.getMainCompanion() != null && Main.sex.getAllParticipants().contains(ImpFortressDialogue.getMainCompanion())
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced ").append(UtilText.parse(ImpFortressDialogue.getMainCompanion(), "[npc.name]")).append(" to wear:<br/>").append(ImpFortressDialogue.getMainCompanion().getClothingInSlot(thong.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                            if (ImpFortressDialogue.getMainCompanion() != null && boss.isAbleToEquipDildo(ImpFortressDialogue.getMainCompanion())) {
                                ...
                                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>").append(UtilText.parse(boss, "[npc.Name]")).append(" has forced ").append(UtilText.parse(ImpFortressDialogue.getMainCompanion(), "[npc.name]")).append(" to wear:<br/>").append(ImpFortressDialogue.getMainCompanion().getClothingInSlot(dildo.getClothingType().getEquipSlots().get(0)).getDisplayName(true)).append("</p>");
                            }
                        }
                    }
                };
    ...
    public static List<GameCharacter> getImpBossGroup(AbstractWorldType fortress, boolean includeBoss) {
        ...
        if (fortress == WorldType.IMP_FORTRESS_ALPHA) {
            for (GameCharacter character : Main.game.getCharactersPresent(WorldType.IMP_FORTRESS_ALPHA, PlaceType.FORTRESS_ALPHA_KEEP)) {
                if ((character instanceof ImpAttacker || (includeBoss && character instanceof FortressAlphaLeader)) && character.getPartyLeader() == null && !character.isSlave()) {
            ...
            for (GameCharacter character : Main.game.getCharactersPresent(WorldType.IMP_FORTRESS_FEMALES, PlaceType.FORTRESS_FEMALES_KEEP)) {
                if ((character instanceof ImpAttacker || (includeBoss && character instanceof FortressFemalesLeader)) && character.getPartyLeader() == null && !character.isSlave()) {
                    bossGroup.add(character);
                }
            }
            ...
            for (GameCharacter character : Main.game.getCharactersPresent(WorldType.IMP_FORTRESS_MALES, PlaceType.FORTRESS_MALES_KEEP)) {
                if ((character instanceof ImpAttacker || (includeBoss && character instanceof FortressMalesLeader)) && character.getPartyLeader() == null && !character.isSlave()) {
                    bossGroup.add(character);
                }
            }
        }
