...
public class LilayaDiningHallDialogue {
    ...
    public static final DialogueNode ROOM_DINING_HALL = new DialogueNode("", "", false) {
        ...
        public String getContent() {
            ...
            sb.append("<p>" + "<b style='color:").append(PlaceUpgrade.LILAYA_DINING_HALL.getColour().toWebHexString()).append(";'>").append(PlaceUpgrade.LILAYA_DINING_HALL.getName()).append("</b><br/>").append(PlaceUpgrade.LILAYA_DINING_HALL.getRoomDescription(Main.game.getPlayerCell())).append("</p>");
