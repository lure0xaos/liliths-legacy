...
import com.lilithslegacy.game.sex.managers.submission.SMEatenOut;
import com.lilithslegacy.game.sex.managers.submission.SMEatingOut;
import com.lilithslegacy.game.sex.managers.submission.SMShadowSilence;
import com.lilithslegacy.game.sex.managers.submission.SMVengarDominantSex;
import com.lilithslegacy.game.sex.managers.universal.SMAgainstWall;
import com.lilithslegacy.game.sex.managers.universal.SMLyingDown;
import com.lilithslegacy.game.sex.managers.universal.SMOverDesk;
...
public class VengarCaptiveDialogue {
    ...
    private static List<GameCharacter> getCharactersPresent(boolean includeCompanion) {
        List<GameCharacter> characters = new ArrayList<>(Main.game.getCharactersPresent());
