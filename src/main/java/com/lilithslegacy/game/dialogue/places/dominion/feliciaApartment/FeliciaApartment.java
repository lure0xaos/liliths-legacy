package com.lilithslegacy.game.dialogue.places.dominion.feliciaApartment;
...
public class FeliciaApartment {
    ...
    public static final DialogueNode TALK_MENU_ABOUT_HER = new DialogueNode("", "", true, true) {
        ...
        public Response getResponse(int responseTab, int index) {
            if (index == 1) {
                return new Response("Surname", "Ask Felicia about her unusual surname.", TALK_ABOUT_HER_NAME) {
                    @Override
                    public void effects() {
    ...
    public static final DialogueNode TALK_LEWD_PUSH = new DialogueNode("", "", true, true) {
        ...
        public Response getResponse(int responseTab, int index) {
            if (index == 1) {
                return new Response("Dig deep",
                        "You <i>must</i> know!"
                                + "<br/>[style.italicsBad(You get the sneaking suspicion that this will end very badly!)]",
                        TALK_LEWD_DIG_DEEP) {
                    @Override
