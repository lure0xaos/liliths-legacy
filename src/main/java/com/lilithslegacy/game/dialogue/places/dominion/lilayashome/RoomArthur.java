...
public class RoomArthur {
    ...
    public static final DialogueNode ROOM_ARTHUR_ARCANE_LIGHTNING_END_FINAL = new DialogueNode("", "", true, true) {
        ...
        public void applyPreParsingEffects() {
            ...
            Main.game.getTextEndStringBuilder().append("<p style='text-align:center;'>" + "You have learned the following spells:" + "<br/><b style='color:").append(PresetColour.SPELL_SCHOOL_ARCANE.toWebHexString()).append(";'>").append(Spell.ARCANE_CHAIN_LIGHTNING.getName()).append("</b>").append("<br/><b style='color:").append(PresetColour.SPELL_SCHOOL_ARCANE.toWebHexString()).append(";'>").append(Spell.ARCANE_LIGHTNING_SUPERBOLT.getName()).append("</b>").append("</p>");
