package com.lilithslegacy.game.dialogue.places.dominion.zaranixHome;
...
import com.lilithslegacy.game.sex.managers.dominion.zaranix.SMAmberDoggyFucked;
import com.lilithslegacy.game.sex.managers.dominion.zaranix.SMPetMounting;
import com.lilithslegacy.game.sex.managers.dominion.zaranix.SMPetOral;
...
public class ZaranixHomeGroundFloorRepeat {
    ...
    public static void resetHouseAfterLeaving() {
        ...
        Main.game.getNpc(Amber.class).setStartingBody(false);
                        ...
                        public void effects() {
                            if (Main.game.getPlayer().getClothingInSlot(InventorySlot.NECK) == null || !Main.game.getPlayer().getClothingInSlot(InventorySlot.NECK).getClothingType().getId().equals("innoxia_neck_ambers_bitch_collar")) {
                                ...
                                if (Main.game.getPlayer().isAbleToEquip(collar, true, Main.game.getNpc(Amber.class))) {
                                    ...
                                    Main.game.getTextEndStringBuilder().append("<p style='text-align:center;'>").append(Main.game.getPlayer().equipClothingFromNowhere(collar, true, Main.game.getNpc(Amber.class))).append("</p>");
                                } else {
