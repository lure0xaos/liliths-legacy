...
//				com.lilithslegacy.utils.log.Log.log("Warning: Player's elemental not found when accessing ParserTarget.ELEMENTAL!");
...
//			com.lilithslegacy.utils.log.Log.log("Warning: Parser target of '"+tag+"' has been replaced!");
