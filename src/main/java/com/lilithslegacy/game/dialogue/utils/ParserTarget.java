...
public class ParserTarget {
    ...
    public static final AbstractParserTarget STYLE = new AbstractParserTarget(Util.newArrayListOfValues(
            "style",
            "game",
            "util"),
    ...
    public static final AbstractParserTarget UNIT = new AbstractParserTarget(Util.newArrayListOfValues(
            "unit",
            "units",
            "game"),
    ...
    public static final AbstractParserTarget PC = new AbstractParserTarget(Util.newArrayListOfValues(
            "pc",
            "player"),
     ...
     */
    public static final AbstractParserTarget NPC = new AbstractParserTarget(Util.newArrayListOfValues(
            "npc",
            "npc1",
            "npc2",
            "npc3",
     ...
     */
    public static final AbstractParserTarget COMPANION = new AbstractParserTarget(Util.newArrayListOfValues(
            "com",
            "com1",
            "com2",
            "com3",
     ...
     */
    public static final AbstractParserTarget NON_COMPANION = new AbstractParserTarget(Util.newArrayListOfValues(
            "ncom",
            "ncom1",
            "ncom2",
            "ncom3",
...
//				System.getLogger("").log(System.Logger.Level.ERROR,"Warning: Player's elemental not found when accessing ParserTarget.ELEMENTAL!");
    ...
    public static AbstractParserTarget HAZMAT_RAT = new AbstractParserTarget(Util.newArrayListOfValues("hazmatRat"), "") {
        public String getDescription() {
            return Main.game.getNpc(HazmatRat.class).getDescription();
        }

        @Override
        public GameCharacter getCharacter(String tag, List<GameCharacter> specialNPCList) {
            return Main.game.getNpc(HazmatRat.class);
        }
    };
    ...
    public static AbstractParserTarget IMP_FORTRESS_ALPHA_LEADER = new AbstractParserTarget(Util.newArrayListOfValues("impAlphaLeader", "fyrsia"), "") {
        public String getDescription() {
    ...
    public static AbstractParserTarget IMP_FORTRESS_FEMALES_LEADER = new AbstractParserTarget(Util.newArrayListOfValues("impFemalesLeader", "impFemaleLeader", "hyorlyss"), "") {
        public String getDescription() {
    ...
    public static AbstractParserTarget IMP_FORTRESS_MALES_LEADER = new AbstractParserTarget(Util.newArrayListOfValues("impMalesLeader", "impMaleLeader", "jhortrax"), "") {
        public String getDescription() {
     ...
     */
    private static final List<AbstractParserTarget> coreParserTargets = new ArrayList<>();

    private static final List<AbstractParserTarget> allParserTargets = new CopyOnWriteArrayList<>(); // Need this to be thread safe as it has elements added to it during Game.class's 'Load NPCs' section
    private static final Map<AbstractParserTarget, String> parserTargetToIdMap = new HashMap<>();
    private static final Map<String, AbstractParserTarget> idToParserTargetMap = new HashMap<>();
...
//			System.getLogger("").log(System.Logger.Level.ERROR,"Warning: Parser target of '"+tag+"' has been replaced!");
