...
public class UtilText {
    ...
    public static final List<ParserCommand> commandsList = new ArrayList<>();
    public static final Map<BodyPartType, List<ParserCommand>> commandsMap = new EnumMap<>(BodyPartType.class);
    ...
    private static final Map<String, String> americanEnglishConversions = Util.<String, String>newHashMapOfValues(
            // -our to -or:
...
//					break;
    ...
    public static String getRequirementsDescription(AbstractPerk perkRequired, Gender... gendersRequired) {
        ...
        descriptionSB.append("You require the perk '<b style='color:").append(perkRequired.getPerkCategory().getColour().toWebHexString()).append(";'>").append(perkRequired.getName(Main.game.getPlayer())).append("</b>'");
        ...
        if (gendersRequired.length == 0) {
            ...
            for (int i = 0; i < gendersRequired.length; i++) {
                ...
                descriptionSB.append("<b style='color:").append(gendersRequired[i].getColour().toWebHexString()).append(";'>").append(gendersRequired[i].getName()).append("</b>");
            }
    ...
    public static String getRequirementsDescription(CorruptionLevel corruptionNeeded, AbstractPerk... perkRequired) {
        ...
        descriptionSB.append("You require a corruption level of <b style='color:").append(corruptionNeeded.getColour().toWebHexString()).append(";'>").append(corruptionNeeded.getName()).append("</b>");

        if (perkRequired.length == 0) {
            descriptionSB.append(".");
        } else {
            descriptionSB.append(", or the perk").append(perkRequired.length > 1 ? "s " : " ");
            ...
            for (int i = 0; i < perkRequired.length; i++) {
                ...
                descriptionSB.append("<b style='color:").append(perkRequired[i].getPerkCategory().getColour().toWebHexString()).append(";'>").append(perkRequired[i].getName(Main.game.getPlayer())).append("</b>");
            }
...
//		return "<span style='font-family:serif; font-weight:normal; font-size:1.25em;'>&#8734;</span>";
    ...
    public static String parseFromXMLFile(List<ParserTag> parserTags, Path folderPath, String pathName, String tag, List<GameCharacter> specialNPC) {
        Path file = FS.newPath(folderPath + System.getProperty("file.separator") + pathName + ".xml");
...
//				String rootElelemnt = doc.getDocumentElement().getTagName();
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Error in UtilText.parseFromXMLFile(): File '" + (folderPath + System.getProperty("file.separator") + pathName + ".xml") + "' does not exist!");
        }
        ...
        if (strings.isEmpty()) {
            ...
            for (Entry<String, List<String>> s : strings.entrySet()) {
                if (s.getValue().size() > 1) {
                    duplicationSB.append("[style.italicsMinorBad(XML test duplication: tag '").append(s.getKey()).append("' is repeated ").append(s.getValue().size()).append(" times!)]<br/>");
                }
                for (String savedString : s.getValue()) {
                    sb.append("<p>" + "<b>Dialogue tag: ").append(s.getKey()).append("</b>").append("</p>").append(parse(specialNPC, savedString, true)).append("<br/><br/>");
                }
            }
            return duplicationSB.toString() + sb;
        }
    }
...
//							System.out.println("noConditionalBrackets");
            ...
            if (startIndex != 0) {
                ...
                if (target != null) {
                    errMsg.append(" Target: '").append(target).append("'");
                }
                if (command != null) {
                ...
                {
                    int errContext = 30;
                    errMsg.append("\nContext:  ").append(input.substring(Math.max(0, startIndex - errContext), Math.min(input.length(), startIndex + errContext)));
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, errMsg);
...
//					System.getLogger("").log(System.Logger.Level.ERROR,"Parsing error: Could not initialise npc");
                }
            }
            ...
            try {
                ...
                for (String s : parserVariableCalls) {
                    commandWithVariableCalls.append(s).append(";");
                }
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, e.getMessage());
//				System.getLogger("").log(System.Logger.Level.ERROR,e.getMessage(),e);
...
//					System.getLogger("").log(System.Logger.Level.ERROR,"Parsing error: Could not initialise npc 2");
                }
            }
...
//		initScriptEngine();
    ...
    public static void initScriptEngine() {
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "ENGINE_SCOPE binding removal error.");
        }
...
//		engine.put("Packages.com.lilithslegacy.utils.Util");
...
//		System.out.println(sb.toString());
    ...
    public static boolean evaluateConditional(List<GameCharacter> specialNPCs, String conditionalStatement, boolean hasXmlVariables) throws ScriptException {
        ...
        if (Main.game.isStarted()) {
            if (!specialNPCs.isEmpty()) {
                ...
                try { // Getting the target NPC can throw a NullPointerException, so if it does (i.e., there's no NPC suitable for parsing), just catch it and carry on.
                    ...
                    //				System.getLogger("").log(System.Logger.Level.ERROR,"Parsing error 2: Could not initialise npc");
                }
            }
        ...
        if (hasXmlVariables) {
            for (String s : parserVariableCalls) {
                conditionalStatementWithVariables.append(s).append(";");
            }
        }
...
//				if (memo.size() == memo_limit) {
//					System.getLogger("").log(System.Logger.Level.ERROR,"Memo has reached capacity! Additional script commands will not be memoized.");
//				}
//			}
//		} else {
        ...
        commandsList.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                try {
                    ...
                    if (!set.isEmpty() && Math.random() < 0.5f) {
...
//					return character.getRelationshipStrTo(targetedCharacter);
                        ...
                        if (arguments != null) {
                            if (c.getRainbowColours() != null) {
                                ...
                                for (char ch : characters) {
                                    ...
                                    if (openBrackets == 0) {
                                        sb.append("<span style='color:").append(c.getRainbowColours().get(i % c.getRainbowColours().size())).append(";'>");
                                        sb.append(ch);
                                        sb.append("</span>");
                                        i++;
                                    } else {
                        ...
                        if (arguments != null) {
                            if (c.getRainbowColours() != null) {
                                ...
                                for (char ch : characters) {
                                    ...
                                    if (openBrackets == 0) {
                                        sb.append("<b style='color:").append(c.getRainbowColours().get(i % c.getRainbowColours().size())).append(";'>");
                                        sb.append(ch);
                                        sb.append("</b>");
                                        i++;
                                    } else {
                        ...
                        if (arguments != null) {
                            if (c.getRainbowColours() != null) {
                                ...
                                for (char ch : characters) {
                                    ...
                                    if (openBrackets == 0) {
                                        sb.append("<i style='color:").append(c.getRainbowColours().get(i % c.getRainbowColours().size())).append(";'>");
                                        sb.append(ch);
                                        sb.append("</i>");
                                        i++;
                                    } else {
        ...
        commandsList.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                ...
                if (character.getPenisSize() != PenisLength.TWO_AVERAGE) {
                    if (coloured) {
                        sb.append("<span style='color:").append(character.getPenisSize().getColour().toWebHexString()).append(";'>");
                    }
                ...
                if (character.getPenisGirth() != PenetrationGirth.THREE_AVERAGE) {
                    ...
                    if (coloured) {
                        sb.append("<span style='color:").append(character.getPenisGirth().getColour().toWebHexString()).append(";'>");
                    }
                ...
                sb.append(" ");
                if (coloured) {
                    sb.append("<span style='color:").append(character.getPenisRace().getColour().toWebHexString()).append(";'>");
                }
                if (character.getPenisRace() != Race.HUMAN) {
                    sb.append(character.getPenisRace().getName(true)).append("-cock");
        ...
        commandsList.add(new ParserCommand(
            ...
            public String parse(List<GameCharacter> specialNPCs, String command, String arguments, String target, GameCharacter character) {
                ...
                if (character.getPenisSize() != PenisLength.TWO_AVERAGE) {
                    if (coloured) {
                        sb.append("<span style='color:").append(length.getColour().toWebHexString()).append(";'>");
                    }
                ...
                if (character.getPenisGirth() != PenetrationGirth.THREE_AVERAGE) {
                    ...
                    if (coloured) {
                        sb.append("<span style='color:").append(girth.getColour().toWebHexString()).append(";'>");
                    }
