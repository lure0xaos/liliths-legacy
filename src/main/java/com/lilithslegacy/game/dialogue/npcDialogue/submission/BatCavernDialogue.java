package com.lilithslegacy.game.dialogue.npcDialogue.submission;
...
import com.lilithslegacy.game.inventory.item.FetishPotion;
import com.lilithslegacy.game.inventory.item.ItemType;
import com.lilithslegacy.game.inventory.item.TransformativePotion;
...
public class BatCavernDialogue {
    ...
    public static final DialogueNode CAVERN_PEACEFUL_TALK = new DialogueNode("Talk", "", true, true) {

        @Override
        public String getContent() {
            UtilText.nodeContentSB.setLength(0);

            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_TALK", getAllCharacters()));
            ...
            if (getMugger().isAffectionHighEnoughToInviteHome()) {
                if (Main.game.getPlayer().isQuestCompleted(QuestLine.SIDE_ACCOMMODATION)) {
                    UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_CAN_INVITE_HOME", getAllCharacters()));
                } else {
                    UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_CAN_INVITE_HOME_REQUIRES_LILAYA_PERMISSION", getAllCharacters()));
                }
            }
    ...
    public static final DialogueNode CAVERN_PEACEFUL_OFFER_MONEY = new DialogueNode("Offer money", "", true, true) {

        @Override
        public String getContent() {
            UtilText.nodeContentSB.setLength(0);

            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_OFFER_MONEY", getAllCharacters()));
    ...
    public static final DialogueNode CAVERN_PEACEFUL_OFFER_ROOM_BACK_HOME = new DialogueNode("New Room", "", true) {

        @Override
        public String getContent() {
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_OFFER_ROOM_BACK_HOME", getAllCharacters());
        }
    ...
    public static final DialogueNode CAVERN_PEACEFUL_OFFER_ROOM = new DialogueNode("Offer room", "", true, true) {

        @Override
        public String getContent() {
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_OFFER_ROOM", getAllCharacters());
        }

        @Override
        public Response getResponse(int responseTab, int index) {
            if (index == 1) {
                return new Response("Take home", "Take [npc.name] to [npc.her] new room.", CAVERN_PEACEFUL_OFFER_ROOM_BACK_HOME) {
                    @Override
                    public void effects() {
    ...
    public static final DialogueNode CAVERN_PEACEFUL_ATTACK = new DialogueNode("Attack", "", true, true) {
        ...
        @Override
        public String getContent() {
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_PEACEFUL_ATTACK", getAllCharacters());
        }
    ...
    public static final DialogueNode AFTER_SEX_PEACEFUL = new DialogueNode("Continue", "Step away from [npc.name] and prepare to continue on your way.", true) {
        ...
        public String getContent() {
            if (getMugger().isSatisfiedFromLastSex()) {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_PEACEFUL", getAllCharacters());
            } else {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_PEACEFUL_NO_ORGASM", getAllCharacters());
            }
        }
    ...
    public static final DialogueNode AFTER_SEX_PEACEFUL_THREESOME = new DialogueNode("Continue", "Step away from [npc.name] and prepare to continue on your way.", true) {
        ...
        @Override
        public String getContent() {
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_PEACEFUL_THREESOME", getAllCharacters());
        }
    ...
    public static final DialogueNode AFTER_SEX_PEACEFUL_OFFERED_COMPANION = new DialogueNode("Continue", "Step away from [npc.name] and prepare to continue on your way.", true) {
        ...
        public String getContent() {
            if (getMainCompanion().isAttractedTo(getMugger())) {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_PEACEFUL_OFFERED_COMPANION", getAllCharacters());
            } else {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_PEACEFUL_OFFERED_COMPANION_RELUCTANT", getAllCharacters());
            }
        }
    ...
    public static final DialogueNode AFTER_COMBAT_VICTORY_TALK = new DialogueNode("Talk", "", true) {
        ...
        @Override
        public String getContent() {
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_TALK", getAllCharacters());
        }
    ...
    public static final DialogueNode CAVERN_ATTACK = new DialogueNode("Assaulted!", "A figure jumps out from the shadows!", true) {
            ...
            if (getMugger().getLastTimeEncountered() != -1) {
                if (isWantsToFight()) {
                    ...
                    if (getMugger().isVisiblyPregnant()) {
                        ...
                        if (!getMugger().isCharacterReactedToPregnancy(Main.game.getPlayer())) {
                            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_PREGNANCY_REVEAL", getAllCharacters()));

                        } else {
                            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_STILL_PREGNANT", getAllCharacters()));
                        }
                    }
                    ...
                    if (Main.game.getPlayer().isVisiblyPregnant() || (isCompanionDialogue() && getMainCompanion().isVisiblyPregnant())) {
                        ...
                        if ((Main.game.getPlayer().isVisiblyPregnant() && !Main.game.getPlayer().isCharacterReactedToPregnancy(getMugger()))
                                || (isCompanionDialogue() && getMainCompanion().isVisiblyPregnant() && !getMainCompanion().isCharacterReactedToPregnancy(getMugger()))) {
                            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_PLAYER_PREGNANCY", getAllCharacters()));

                        } else {
                            UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_CONTINUED_PLAYER_PREGNANCY", getAllCharacters()));
                        }
                    }

                    if (!pregnancyReaction) {
                        UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL", getAllCharacters()));
                    }

                    UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_END", getAllCharacters()));

                    UtilText.nodeContentSB.append(getStatus());
                }

            } else {
                UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_INTRO", getAllCharacters()));

                UtilText.nodeContentSB.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK", getAllCharacters()));
            }
        ...
        public Response getResponse(int responseTab, int index) {
            ...
            if (isWantsToFight()) {
                if (index == 1) {
                    ...
                    if (!Main.game.getPlayer().hasItemType(ItemType.MUSHROOM)) {
                        ...
                        return new Response("Offer mushroom", "Offer one of your Glowing Mushrooms to [npc.name] in exchange for leaving you alone.", Main.game.getDefaultDialogue(false)) {
                            ...
                            public void effects() {
                                ...
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("characters/submission/batCavernSlime", "ATTACK_PAID_OFF_WITH_MUSHROOM")).append("<p>").append(Main.game.getPlayer().removedItemFromInventoryText(ItemType.MUSHROOM)).append("</p>");
                            }
                        };
                    }
                    ...
                    if (!getMugger().isAttractedTo(Main.game.getPlayer())) {
                        ...
                        return new ResponseSex(UtilText.parse(companion, "Offer threesome"),
                                ...
                                AFTER_SEX_DEFEAT,
                                UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_OFFER_BODY_WITH_COMPANION", getMugger(), companion)) {
                            @Override
                            public void effects() {
                                applyPregnancyReactions();
                            }
                ...
                if (index == 1) {
                    return new Response("Talk", "Talk to [npc.name] for a while in order to get to know [npc.herHim] a little better.", CAVERN_PEACEFUL_TALK) {
                        @Override
                        public void effects() {
                            applyPregnancyReactions();
                    ...
                    if (!getMugger().isAttractedTo(Main.game.getPlayer())) {
                        ...
                        return new ResponseSex(UtilText.parse(companion, "Offer threesome"),
                                ...
                                new SMGeneric(
                                        ...
                                        null,
                                        ResponseTag.PREFER_DOGGY),
                                AFTER_SEX_PEACEFUL_THREESOME, UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "CAVERN_ATTACK_PEACEFUL_OFFER_BODY_WITH_COMPANION", getMugger(), companion)) {
                            @Override
                            public void effects() {
                                applyPregnancyReactions();
                            }
    ...
    private static String getDialogueId() {
        if (getMugger().getBodyMaterial() == BodyMaterial.SLIME) {
            if (isCompanionDialogue()) {
                return "slimeCompanions";
            }
            return "slime";

        }
        if (getMugger().getRace() == Race.BAT_MORPH) {
            if (isCompanionDialogue()) {
                return "batCompanions";
            }
            return "bat";

        } else {
            if (isCompanionDialogue()) {
                return "genericCompanions";
            }
            return "generic";
        }
    }
    ...
    public static final DialogueNode AFTER_COMBAT_VICTORY = new DialogueNode("Victory", "", true) {
        ...
        public String getContent() {
            if (getMugger().isAttractedTo(Main.game.getPlayer())
                ...
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_ATTRACTION", getMugger());

            } else {
                if (getMugger().hasFlag(NPCFlagValue.genericNPCBetrayedByPlayer)) {
                    return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_BETRAYED", getMugger());
                } else {
                    return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_NO_ATTRACTION", getMugger());
                }
            }
        }
                ...
                if (!getMugger().isAttractedTo(Main.game.getPlayer()) && !Main.game.isNonConEnabled()) {
                    ...
                    return new ResponseSex(
                            ...
                            new SMGeneric(
                                    ...
                                    null),
                            AFTER_SEX_VICTORY,
                            UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_RAPE", getAllCharacters()));
                }
                ...
                if (!getMugger().isAttractedTo(Main.game.getPlayer()) && !Main.game.isNonConEnabled()) {
                    ...
                    return new ResponseSex("Rape [npc.herHim] (gentle)",
                            ...
                            new SMGeneric(
                                    ...
                                    ResponseTag.START_PACE_PLAYER_DOM_GENTLE),
                            AFTER_SEX_VICTORY,
                            UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_RAPE_GENTLE", getAllCharacters()));
                }
                ...
                if (!getMugger().isAttractedTo(Main.game.getPlayer()) && !Main.game.isNonConEnabled()) {
                    ...
                    return new ResponseSex("Rape [npc.herHim] (rough)",
                            ...
                            new SMGeneric(
                                    ...
                                    ResponseTag.START_PACE_PLAYER_DOM_ROUGH),
                            AFTER_SEX_VICTORY,
                            UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_RAPE_ROUGH", getAllCharacters()));
                }
                ...
                if (!Main.game.isNonConEnabled() && (!getMugger().isAttractedTo(Main.game.getPlayer()) || !getMugger().isAttractedTo(companion))) {
                    ...
                    return new ResponseSex(UtilText.parse(companion, "Threesome"),
                            ...
                            new SMGeneric(
                                    ...
                                    null,
                                    ResponseTag.PREFER_DOGGY),
                            AFTER_SEX_VICTORY, UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_VICTORY_THREESOME", getMugger(), companion));
                }
    ...
    public static final DialogueNode AFTER_COMBAT_DEFEAT = new DialogueNode("Defeat", "", true) {
        ...
        public String getContent() {
            if (getMugger().hasFlag(NPCFlagValue.genericNPCBetrayedByPlayer)) {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_BETRAYED", getAllCharacters());
            }

            StringBuilder sb = new StringBuilder();
            sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_GENERIC_START", getAllCharacters()));
                ...
                if (((forcedTF && potion != null) || (forcedFetish && fetishPotion != null))
                    ...
                    if (companionFetishPotion != null && companionForcedFetish) {
                        if (companionPotion != null && companionForcedTF) {
                            sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_TF_AND_FETISH", getAllCharacters()));
                        } else {
                            sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_FETISH", getAllCharacters()));
                        }
                    } else {
                        sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_TF", getAllCharacters()));
                    }
                    ...
                    if (companionFetishPotion != null && companionForcedFetish) {
                        if (potion != null && forcedTF) {
                            sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_SOLO_TF_AND_FETISH", getAllCharacters()));
                        } else {
                            sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_SOLO_FETISH", getAllCharacters()));
                        }
                    } else {
                        sb.append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_COMBAT_DEFEAT_COMPANION_SOLO_TF", getAllCharacters()));
                    }
                    return sb.toString();
                }
            }
            ...
            if ((!forcedTF || potion == null)
                ...
                if (index == 1) {
                        ...
                        return new Response("Spit",
                            ...
                            public void effects() {
                                ...
                                if (getMainCompanion().getFetishDesire(Fetish.FETISH_TRANSFORMATION_RECEIVING).isPositive()) {
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_SPIT", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_COMPANION_SWALLOW", getAllCharacters()));
                                    ...
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_BOTH_SPIT", getAllCharacters()));
                                }
                            }
                        };
                    }
                    ...
                    return new Response("Swallow",
                        ...
                        public void effects() {
                            transformationsApplied = true;
                            Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_SWALLOW", getAllCharacters()));
                            ...
                            if (getMainCompanion().getFetishDesire(Fetish.FETISH_TRANSFORMATION_RECEIVING).isPositive()) {
                                ...
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_COMPANION_SPIT", getAllCharacters()));
                            }
                        }
                    };
                        ...
                        return new Response("Spit (both)",
                            ...
                            public void effects() {
                                ...
                                if (getMainCompanion().hasFetish(Fetish.FETISH_TRANSFORMATION_RECEIVING)) {
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_SPIT", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "ORDER_SPIT_REFUSED", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_COMPANION_SWALLOW", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(applyTransformation(getMainCompanion(), companionPotion, companionForcedTF, companionFetishPotion, companionForcedFetish));

                                } else {
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_SPIT", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "ORDER_SPIT", getAllCharacters()));
                                }
                            }
                        };
                    ...
                    return new Response("Swallow (both)",
                        ...
                        public void effects() {
                            ...
                            if (!getMainCompanion().getFetishDesire(Fetish.FETISH_TRANSFORMATION_RECEIVING).isNegative()) {
                                ...
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "ORDER_SWALLOW", getAllCharacters()));
                                Main.game.getTextStartStringBuilder().append(applyTransformation(getMainCompanion(), companionPotion, companionForcedTF, companionFetishPotion, companionForcedFetish));

                            } else {
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "TF_SWALLOW", getAllCharacters()));
                                Main.game.getTextStartStringBuilder().append(applyTransformation(Main.game.getPlayer(), potion, forcedTF, fetishPotion, forcedFetish));
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "ORDER_SWALLOW_REFUSED", getAllCharacters()));
                            }
                        }
                    };
                }
    ...
    public static final DialogueNode AFTER_COMBAT_TRANSFORMATION = new DialogueNode("Transformed", "", true) {
        ...
        public String getContent() {
            if (isCompanionDialogue()) {
                if (getMugger().isAttractedTo(Main.game.getPlayer())) {
                    if (getMugger().isAttractedTo(getMainCompanion())) {
                        if (getMugger().isWillingToRape()) {
                            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "RAPE_BOTH", getAllCharacters());
                        } else {
                            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "OFFER_SEX_BOTH", getAllCharacters());
                        }

                    } else {
                        if (getMugger().isWillingToRape()) {
                            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "RAPE_PLAYER_SOLO", getAllCharacters());
                        } else {
                            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "OFFER_SEX_SOLO", getAllCharacters());
                        }
                    }

                } else if (getMugger().isAttractedTo(getMainCompanion()) && Main.getProperties().hasValue(PropertyValue.involuntaryNTR)) {
                    if (getMugger().isWillingToRape()) {
                        return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "RAPE_COMPANION", getAllCharacters());
                    } else {
                        return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "OFFER_SEX_COMPANION", getAllCharacters());
                    }
                }
                ...
                if (getMugger().isAttractedTo(Main.game.getPlayer())) {
                    if (getMugger().isWillingToRape()) {
                        return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "RAPE_PLAYER", getAllCharacters());
                    } else {
                        return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "OFFER_SEX", getAllCharacters());
                    }
                }
            }

            if (transformationsApplied) {
                return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "NO_SEX_POST_TRANSFORM", getAllCharacters());
            }
            return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "NO_SEX", getAllCharacters());
        }
                    ...
                    if (getMugger().isAttractedTo(getMainCompanion())) { // Threesome sex:
                        if (index == 1) {
                                    ...
                                    new SMGeneric(
                                            ...
                                            Util.newArrayListOfValues(
                                                    companionSex
                                                            ...
                                                            : getMainCompanion())),
                                    AFTER_SEX_DEFEAT,
                                    UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "START_DEFEATED_SEX_THREESOME", getAllCharacters()));
                            ...
                            return new ResponseSex("Resist Sex",
                                    ...
                                    AFTER_SEX_DEFEAT,
                                    UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "START_DEFEATED_SEX_THREESOME_RESIST", getAllCharacters()));
    ...
    public static final DialogueNode AFTER_SEX_VICTORY = new DialogueNode("Step back", "", true) {
        ...
        public String getContent() {
            if ((getMugger().isAttractedTo(Main.game.getPlayer()) || !Main.game.isNonConEnabled())
                ...
                if (getMugger().hasFlag(NPCFlagValue.genericNPCBetrayedByPlayer)) {
                    return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_VICTORY_RAPE_BETRAYED", getAllCharacters());
                } else {
                    return UtilText.parseFromXMLFile("encounters/submission/batCavern/" + getDialogueId(), "AFTER_SEX_VICTORY_RAPE", getAllCharacters());
                }
            }
        }
