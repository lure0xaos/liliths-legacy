package com.lilithslegacy.game.dialogue.npcDialogue.elemental;
        ...
        public String getContent() {
            ...
            for (AbstractFetish fetish : Fetish.getAllFetishes()) {
                if (!fetish.getFetishesForAutomaticUnlock().isEmpty()) {
                    sb.append("<div id='FETISH_").append(Fetish.getIdFromFetish(fetish)).append("' class='fetish-icon").append(Main.game.getPlayer().hasFetish(fetish)
