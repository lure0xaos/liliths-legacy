                        ...
                        return new Response("Spit",
                            ...
                            public void effects() {
                                if (getMainCompanion().getFetishDesire(Fetish.FETISH_TRANSFORMATION_RECEIVING).isPositive()) {
                                    ...
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "COMBAT_DEFEAT_TF_REFUSED", getAllCharacters()) // Re-use description
                                    ).append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "IMP_ATTACK_OFFER_THREESOME_COMPANION_SWALLOWS", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(getImpLeader().applyPotion(companionPotion, getMainCompanion()));
                                } else {
                        ...
                        return new Response("Spit (both)",
                            ...
                            public void effects() {
                                if (getMainCompanion().hasFetish(Fetish.FETISH_TRANSFORMATION_RECEIVING)) {
                                    ...
                                    Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "COMBAT_DEFEAT_TF_REFUSED", getAllCharacters())).append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "IMP_ATTACK_OFFER_THREESOME_REFUSES_ORDER_TO_SPIT", getAllCharacters())).append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "IMP_ATTACK_OFFER_THREESOME_COMPANION_SWALLOWS", getAllCharacters()));
                                    Main.game.getTextStartStringBuilder().append(getImpLeader().applyPotion(companionPotion, getMainCompanion()));
                                } else {
                    ...
                    return new Response("Swallow (both)",
                        ...
                        public void effects() {
                            ...
                            if (!getMainCompanion().getFetishDesire(Fetish.FETISH_TRANSFORMATION_RECEIVING).isNegative()) {
                                ...
                                Main.game.getTextStartStringBuilder().append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "IMP_ATTACK_OFFER_THREESOME_OBEYS_ORDER_TO_SWALLOW", getAllCharacters())).append(UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "IMP_ATTACK_OFFER_THREESOME_COMPANION_SWALLOWS", getAllCharacters()));
                                Main.game.getTextStartStringBuilder().append(getImpLeader().applyPotion(companionPotion, getMainCompanion()));
                            } else {
                                Main.game.getTextStartStringBuilder().append(
                                        UtilText.parseFromXMLFile("encounters/submission/impAttack" + getImpEncounterId(), "COMBAT_DEFEAT_TF_ACCEPTED", getAllCharacters()));
