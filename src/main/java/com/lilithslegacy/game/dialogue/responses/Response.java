        ...
        if (!isAvailable() && !isAbleToBypass()) {
            ...
            if (getCorruptionNeeded() != null) {
                if (!isActionCorrupting()) {
                    SB.append("Your <span style='color:").append(Main.game.getPlayer().getCorruptionLevel().getColour().toWebHexString()).append(";'>").append(Util.capitaliseSentence(Main.game.getPlayer().getCorruptionLevel().getName())).append("</span>").append(" [style.colourCorruption(corruption)] has unlocked this action!");
                } else {
                    SB.append("You will gain <b>+").append(getCorruptionNeeded().getCorruptionBypass()).append("</b> [style.boldCorruption(corruption)], as you don't meet the [style.colourCorruption(corruption)] or [style.colourFetish(fetish)] requirements!");
                }
            } else {
...
//			}
    ...
    public String getTooltipBlockingList() {
        ...
        if (getPerksRequired() != null) {
            for (AbstractPerk p : getPerksRequired()) {
                if (p.isEquippableTrait()
                    ...
                    SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b>").append(" (<span style='color:").append(PresetColour.PERK.toWebHexString()).append(";'>Perk</span>): ").append(Util.capitaliseSentence(p.getName(Main.game.getPlayer())));
                } else {
                    SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b>").append(" (<span style='color:").append(PresetColour.PERK.toWebHexString()).append(";'>Perk</span>): ").append(Util.capitaliseSentence(p.getName(Main.game.getPlayer())));
                }
            }
        }
        ...
        if (getFemininityRequired() != null) {
            if (isFemininityInRange()) {
                SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b>").append(" (Femininity): ").append("<span style='color:").append(getFemininityRequired().getColour().toWebHexString()).append(";'>").append(Util.capitaliseSentence(getFemininityRequired().getName(false))).append("</span>");
            } else {
                SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b>").append(" (Femininity): ").append("<span style='color:").append(getFemininityRequired().getColour().toWebHexString()).append(";'>").append(Util.capitaliseSentence(getFemininityRequired().getName(false))).append("</span>");
            }
        }

        if (getSubspeciesRequired() != null) {
            if (isRequiredSubspecies()) {
                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b>");

            } else {
                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b>");
            }
        ...
        if (sexActionType == SexActionType.SPEECH) {
            if (!Main.sex.isOngoingActionsBlockingSpeech(Main.game.getPlayer())) {
                SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b>").append(" (Speech): [style.colourMinorGood(Unblocked mouth)]");
            } else {
                SB.append("<br/>" + "<b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b>").append(" (Speech): [style.colourMinorBad(Unblocked mouth)]");
            }
        }
        ...
        if (getAdditionalOngoingAvailableMap() != null) {
            for (Entry<String, Boolean> e : getAdditionalOngoingAvailableMap().entrySet()) {
                if (e.getValue()) {
                    SB.append("<br/>[style.colourGood(").append(Util.capitaliseSentence(UtilText.parse(Main.sex.getCharacterPerformingAction(), Main.sex.getTargetedPartner(Main.sex.getCharacterPerformingAction()), e.getKey()))).append(")]");
                } else {
                    SB.append("<br/>[style.colourBad(").append(Util.capitaliseSentence(UtilText.parse(Main.sex.getCharacterPerformingAction(), Main.sex.getTargetedPartner(Main.sex.getCharacterPerformingAction()), e.getKey()))).append(")]");
                }
            }
                    ...
                    if (sArea != null) {
                        ...
                        if (getSexActionType() == SexActionType.REQUIRES_NO_PENETRATION_AND_EXPOSED
                            ...
                            if (penetrationAccess && penetrationFree) {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append(" & ").append(freeText).append("): ").append(targetName).append(" ").append(penetrationName);
                            } else {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append(" & ").append(freeText).append("): ").append(targetName).append(" ").append(penetrationName);
                            }

                        } else if (getSexActionType() == SexActionType.REQUIRES_EXPOSED) {
                            if (penetrationAccess) {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append("): ").append(targetName).append(" ").append(penetrationName);
                            } else {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append("): ").append(targetName).append(" ").append(penetrationName);
                            }
                    ...
                    if (sArea != null) {
                        ...
                        if (getSexActionType() == SexActionType.REQUIRES_NO_PENETRATION_AND_EXPOSED
                            ...
                            if (orificeAccess && orificeFree) {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append(" & ").append(freeText).append("): ").append(targetName).append(" ").append(orificeName);
                            } else {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append(" & ").append(freeText).append("): ").append(targetName).append(" ").append(orificeName);
                            }

                        } else if (getSexActionType() == SexActionType.REQUIRES_EXPOSED) {
                            if (orificeAccess) {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append("): ").append(targetName).append(" ").append(orificeName);
                            } else {
                                SB.append("<br/><b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>Requirement</b> (").append(accessText).append("): ").append(targetName).append(" ").append(orificeName);
                            }
    ...
    public String getTooltipRequiredList() {
        ...
        if (getFetishesForUnlock() != null) {
            for (AbstractFetish f : getFetishesForUnlock()) {
                if (Main.game.getPlayer().hasFetish(f)) {
                    SB.append("<br/>" + "[style.colourFetish(Associated Fetish)]" + " (<span style='color:").append(PresetColour.GENERIC_MINOR_GOOD.toWebHexString()).append(";'>owned</span>): ").append(Util.capitaliseSentence(f.getName(Main.game.getPlayer())));

                } else {
                    SB.append("<br/>" + "[style.colourFetish(Associated Fetish)]" + " (<span style='color:").append(PresetColour.GENERIC_MINOR_BAD.toWebHexString()).append(";'>not owned</span>): ").append(Util.capitaliseSentence(f.getName(Main.game.getPlayer())));
                }
            }
        }
        ...
        if (getCorruptionNeeded() != null) {
            if (isCorruptionWithinRange()) {
                SB.append("<br/>" + "[style.colourCorruption(Associated Corruption)]").append(!isActionCorrupting()
                        ? " ([style.colourMinorGood(within range)]): "
                        : " ([style.colourMinorBad(just out of range)]): ").append(Util.capitaliseSentence(getCorruptionNeeded().getName()));
            } else {
                SB.append("<br/>" + "[style.colourCorruption(Associated Corruption)]").append(!Main.game.isBypassSexActionsEnabled()
                        ? " ([style.colourTerrible(out of range)]): "
                        : " ([style.colourMinorBad(out of range)]): ").append(Util.capitaliseSentence(getCorruptionNeeded().getName()));
            }
        }
    ...
    public boolean isPenetrationTypeAvailable() {
        ...
        if (getSexActionType() != null) {
            if (Objects.requireNonNull(getSexActionType()) == SexActionType.REQUIRES_NO_PENETRATION_AND_EXPOSED) {
                for (SexAreaInterface sArea : sexAreaAccessRequiredForPerformer) {
                    if (sArea != null && !sArea.isFree(characterPerformingSexAction)) {
                        return false;
                    }
