...
public class DialogueManager {
    ...
    private static final List<DialogueNode> allDialogues = new ArrayList<>();
    private static final Map<DialogueNode, String> dialogueToIdMap = new HashMap<>();
    private static final Map<String, DialogueNode> idToDialogueMap = new HashMap<>();
...
//						System.out.println("modded dialogue: "+node.getId());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded dialogue type failed at 'Dialogue'. File path: " + innerEntry.getValue());
...
//							System.out.println("res dialogue: "+node.getId());
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading dialogue type failed at 'Dialogue'. File path: " + innerEntry.getValue());
                        System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                        ex.printStackTrace(System.err);
                    }
                }
