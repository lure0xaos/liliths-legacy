...
import com.lilithslegacy.game.character.npc.dominion.DominionSuccubusAttacker;
import com.lilithslegacy.game.character.npc.dominion.HarpyNestsAttacker;
...
import com.lilithslegacy.game.character.npc.submission.BatCavernLurkerAttacker;
import com.lilithslegacy.game.character.npc.submission.BatCavernSlimeAttacker;
import com.lilithslegacy.game.character.npc.submission.ImpAttacker;
import com.lilithslegacy.game.character.npc.submission.RebelBaseInsaneSurvivor;
...
import com.lilithslegacy.game.dialogue.npcDialogue.dominion.DominionExpressCentaurDialogue;
import com.lilithslegacy.game.dialogue.npcDialogue.dominion.EnforcerAlleywayDialogue;
import com.lilithslegacy.game.dialogue.npcDialogue.dominion.SlaveEncountersDialogue;
import com.lilithslegacy.game.dialogue.npcDialogue.dominion.WesQuest;
...
public class Encounter {
    ...
    public static final AbstractEncounter LILAYAS_HOME_CORRIDOR = new AbstractEncounter() {
        @Override
            ...
            if (node == EncounterType.SLAVE_USES_YOU) {
                ...
                for (String id : Main.game.getPlayer().getSlavesOwned()) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Main.game.getNPCById(" + id + ") returning null in Encounter.LILAYAS_HOME_CORRIDOR");
                    }
                }
            ...
            if (node == EncounterType.SLAVE_USES_YOU) {
                ...
                for (String id : Main.game.getPlayer().getSlavesOwned()) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Main.game.getNPCById(" + id + ") returning null in Encounter.LILAYAS_DUNGEON_PASSAGEWAY");
                    }
                }
                slaves.removeIf((slave) -> slave.getWorldLocation() == WorldType.SLAVER_ALLEY);
                hornySlaves.removeIf((slave) -> slave.getWorldLocation() == WorldType.SLAVER_ALLEY);
    ...
    public static final AbstractEncounter DOMINION_STREET = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
    ...
    public static final AbstractEncounter DOMINION_BOULEVARD = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
...
//				}
    ...
    public static final AbstractEncounter DOMINION_ALLEY = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
...
//						}
    ...
    public static final AbstractEncounter DOMINION_DARK_ALLEY = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
    ...
    public static final AbstractEncounter DOMINION_CANAL = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            return Util.newHashMapOfValues(
    ...
    public static final AbstractEncounter DOMINION_EXPRESS = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
    ...
    public static final AbstractEncounter HARPY_NEST_WALKWAYS = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            return Util.newHashMapOfValues(
    ...
    public static final AbstractEncounter HARPY_NEST_LOOK_FOR_TROUBLE = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            return Util.newHashMapOfValues(
                    new Value<EncounterType, Float>(EncounterType.HARPY_NEST_ATTACK, 12f),
    ...
    public static final AbstractEncounter SUBMISSION_TUNNELS = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            Map<EncounterType, Float> map = new HashMap<>();
    ...
    public static final AbstractEncounter BAT_CAVERN = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            Map<EncounterType, Float> map = new HashMap<>();
...
//            }
    ...
    public static final AbstractEncounter REBEL_BASE = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            Map<EncounterType, Float> map = new HashMap<>();
    ...
    public static final AbstractEncounter VENGAR_CAPTIVE_HALL = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
    ...
    public static final AbstractEncounter VENGAR_CAPTIVE_BEDROOM = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            Map<EncounterType, Float> map = new HashMap<>();
    ...
    public static final AbstractEncounter DOMINION_PARK = new AbstractEncounter() {
        @Override
        public Map<EncounterType, Float> getDialogues() {
            Map<EncounterType, Float> map = new HashMap<>();
            ...
            if (!Main.game.getDialogueFlags().hasFlag(DialogueFlagValue.natalyaParkEncounter)
                    ...
                    && Main.game.getWorlds().get(WorldType.DOMINION).getCells(PlaceType.DOMINION_PARK).stream().filter(c -> c.isTravelledTo()).count() >= 2) {
    ...
    public static final List<AbstractEncounter> allEncounters;

    public static final Map<AbstractEncounter, String> encounterToIdMap = new HashMap<>();
    public static final Map<String, AbstractEncounter> idToEncounterMap = new HashMap<>();
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/encounters");
...
//					System.out.println("modded encounter: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded encounter failed at 'Encounter'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/encounters");
...
//					System.out.println("res encounter: "+id);
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading encounter failed at 'Encounter'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
