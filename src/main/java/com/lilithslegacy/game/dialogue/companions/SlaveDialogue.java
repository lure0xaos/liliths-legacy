...
import com.lilithslegacy.game.character.attributes.AffectionLevelBasic;
import com.lilithslegacy.game.character.attributes.ObedienceLevelBasic;
...
import com.lilithslegacy.game.character.npc.NPCFlagValue;
import com.lilithslegacy.game.character.npc.dominion.Helena;
...
import com.lilithslegacy.game.dialogue.responses.ResponseTag;
...
import com.lilithslegacy.game.sex.managers.dominion.SMMilkingStall;
import com.lilithslegacy.game.sex.managers.universal.SMGeneric;
            ...
            if (getSlave().isVisiblyPregnant()) {
                ...
                if (!getSlave().isCharacterReactedToPregnancy(Main.game.getPlayer())) {
                    ...
                    if (father != null && father.isPlayer()) {
                        ...
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append(" sighing," + " [npc.speech(Hi, [npc.pcName]. ").append(father == null ? "I ended up getting pregnant" : father.getName("A") + " got me pregnant").append(", so I'm going to take it easy for a while. Get one of the other slaves to cover for me, ok?)]");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append(" sighing," + " [npc.speech(Hi, [npc.pcName]. ").append(father == null ? "I ended up getting pregnant" : father.getName("A") + " got me pregnant").append(", so I'm going to need to take it easy for a while, ok?)]");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(" obediently informing you of what happened," + " [npc.speech(Hello, [npc.pcName]. ").append(father == null ? "I ended up getting pregnant" : father.getName("A") + " got me pregnant").append(", but I won't let it get in the way of my duties!)]");
                                break;
                        }
                        UtilText.nodeContentSB.append("</p>");
                        UtilText.nodeContentSB.append(
...
//							Main.game.getPlayer().addCompanion(getSlave());
    ...
    public static final DialogueNode SLAVE_PROGRESSION = new DialogueNode("", "", true) {
        ...
        public String getContent() {
            ...
            UtilText.nodeContentSB.append("</p>").append(getFooterText());
        ...
        public String getContent() {
            ...
            switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                case DISLIKE:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, your attempt at making small talk is doing more harm than good!</i>").append("</p>");
                    break;
                case NEUTRAL:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, your attempt at making small talk is helping to get [npc.herHim] to like you more!</i>").append("</p>");
                    break;
                case LIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, your attempt at making small talk is greatly helping to get [npc.herHim] to like you more!</i>").append("</p>");
                    break;
            }
            UtilText.nodeContentSB.append(getFooterText());
        ...
        public String getContent() {
            ...
            switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                case DISLIKE:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, showing your interest in [npc.her] work has only had a minor effect!</i>").append("</p>");
                    break;
                case NEUTRAL:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, showing your interest in [npc.her] work has had a noticeable effect!</i>").append("</p>");
                    break;
                case LIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, showing your interest in [npc.her] work has had a significant effect!</i>").append("</p>");
                    break;
            }
            UtilText.nodeContentSB.append(getFooterText());
        ...
        public String getContent() {
            ...
            switch (slaveAffection) {
                case DISLIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                            UtilText.nodeContentSB.append(" [npc.She] instantly tries to wriggle free from your grasp, shouting," + " [npc.speech(Let me go! Fuck off already!)]" + "</p>" + "<p>" + "You ignore your disobedient slave's protests, holding [npc.herHim] close to your body and breathing in [npc.her] [npc.scent]." + " [npc.She] carries on struggling against you, not at all impressed by your method of reassuring [npc.herHim]." + " After a short while, you finally release [npc.name], and [npc.she] staggers back, shouting," + " [npc.speech(I don't need your sympathy, you ").append(Main.game.getPlayer().isFeminine() ? "bitch" : "bastard").append("!)]");
                            break;
                        case NEUTRAL:
                            UtilText.nodeContentSB.append(
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, your attempt at forcing physical contact is doing more harm than good!</i>").append("</p>");
                    break;
                case NEUTRAL:
                    if (silly) {
                        UtilText.nodeContentSB.append(
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, giving [npc.herHim] a reassuring hug has had a positive affect on how [npc.she] sees you! However, being treated in such a familiar manner has had a slightly negative impact on [npc.her] obedience...</i>").append("</p>");
                    break;
                case LIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("</p>" + "<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, giving [npc.herHim] a reassuring hug has had a hugely positive affect on how [npc.she] sees you! However, being treated in such a familiar manner has had a slightly negative impact on [npc.her] obedience...</i>").append("</p>");
                    break;
            }
            UtilText.nodeContentSB.append(getFooterText());
        ...
        public String getContent() {
            ...
            switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                case DISLIKE:
                    ...
                    UtilText.nodeContentSB.append("<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, your attempt at forcing physical contact is doing more harm than good!</i>").append("</p>");
                    break;
                case NEUTRAL:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                    ...
                    UtilText.nodeContentSB.append("<p>" + "<i>Due to the fact that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, giving [npc.herHim] such intimate physical attention has made [npc.her] like you a lot more! However, being treated in such a familiar manner has had a slightly negative impact on [npc.her] obedience...</i>").append("</p>");
                    break;
                case LIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
        ...
        public String getContent() {
            ...
            switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                case DISLIKE:
                    ...
                    UtilText.nodeContentSB.append("<p>" + "<i>Despite the fact that [npc.she]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, [npc.name] is happy to have been given a gift!</i>").append("</p>");
                    break;
                case NEUTRAL:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
    ...
    public static final DialogueNode SLAVE_INSPECT = new DialogueNode("", "", true) {
        ...
        public String getContent() {
            ...
            UtilText.nodeContentSB.append("<p>").append(isSlaveNaked()
                    ...
                    : "Deciding that you'd like to inspect [npc.namePos] body, you order [npc.herHim] to strip naked, before taking a step back in order to get a better view of [npc.herHim].").append("</p>").append("<p>");
            ...
            if (getSlave().getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive() || getSlave().getFetishDesire(Fetish.FETISH_EXHIBITIONIST).isPositive()) {
                switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                    case DISLIKE:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out an angry scowl as [npc.she] hears your order, but, realising that [npc.she] really doesn't have any choice in the matter, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Shooting you a furious glare, [npc.she] snarls,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] snarls,").append(" [npc.speech(Fucking ").append(Main.game.getPlayer().isFeminine() ? "bitch" : "bastard").append("! Go on! Take a good look at your <i>property</i>, you sick fuck!)]").append("</p>").append("<p>").append("Despite [npc.her] angry words, you detect an undercurrent of arousal in [npc.namePos] voice,").append(" and [npc.she] puts up surprisingly little resistance as you command [npc.herHim] to parade around in front of you.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and even though this draws yet another angry remark from between your disobedient slave's [npc.lips],").append(" you can tell that [npc.she] secretly enjoyed presenting [npc.herself] to you.").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a frustrated sigh as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Glaring at you, [npc.she] snaps,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] snaps,").append(" [npc.speech(Very well, <i>[npc.pcName]</i>.)]").append("</p>").append("<p>").append("Despite [npc.her] slightly-rebellious tone, you detect an undercurrent of arousal in [npc.namePos] voice,").append(" and [npc.she] puts up surprisingly little resistance as you command [npc.herHim] to parade around in front of you.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and from [npc.her] disappointed sigh, you can tell that [npc.she] enjoyed presenting [npc.herself] to you.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                                        ...
                                        + " As [npc.she] takes the last of [npc.her] clothes off, [npc.she] asks,").append(" [npc.speech(Is this to your pleasure, [npc.pcName]?)]").append("</p>").append("<p>").append("You answer in the affirmative, before commanding [npc.name] to parade around in front of you; an order which [npc.she] again dutifully carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, without a word of complaint, [npc.she] once more does exactly as you say.").append(" From the way [npc.her] cheeks have flushed, you can tell that [npc.she] enjoyed presenting [npc.herself] to you.").append("</p>");
                                break;
                        }
                        break;
                    case NEUTRAL:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out a happy cry as [npc.she] hears your order, and quickly moves to obey.").append(isSlaveNaked()
                                        ? " Smiling seductively at you, [npc.she] [npc.moansVerb],"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] [npc.moansVerb],").append(" [npc.speech(~Mmm~ I hope you enjoy this as much as I do, [npc.pcName]...)]").append("</p>").append("<p>").append("Ignoring [npc.her] words, you command [npc.name] to parade around in front of you; an order which [npc.she] again eagerly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", which draws a disappointed sigh from between your disobedient slave's [npc.lips].").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a happy cry as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, quickly moves to obey.").append(isSlaveNaked()
                                        ? " Smiling seductively at you, [npc.she] [npc.moansVerb],"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] [npc.moansVerb],").append(" [npc.speech(I hope this is to your satisfaction, [npc.pcName].)]").append("</p>").append("<p>").append("After [npc.sheHas] stripped naked, you command [npc.name] to parade around in front of you; an order which [npc.she] again eagerly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, with a disappointed sigh, [npc.she] does as you command.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                    ...
                    case LIKE:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out a happy little cry as [npc.she] hears your order, and quickly moves to obey.").append(isSlaveNaked()
                                        ? " Smiling seductively at you, [npc.she] [npc.moansVerb],"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] [npc.moansVerb],").append(" [npc.speech(~Mmm~ It's so degrading being forced to do this... I love it...)]").append("</p>").append("<p>").append("Ignoring [npc.her] words, you command [npc.name] to parade around in front of you; an order which [npc.she] again happily carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", which draws a disappointed sigh from between your disobedient slave's [npc.lips].").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a happy little cry as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, quickly moves to obey.").append(isSlaveNaked()
                                        ? " Smiling seductively at you, [npc.she] [npc.moansVerb],"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] [npc.moansVerb],").append(" [npc.speech(I hope this pleases you, [npc.pcName]...)]").append("</p>").append("<p>").append("Ignoring the amorous tone of [npc.her] voice, you command [npc.name] to parade around in front of you; an order which [npc.she] again happily carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, with a disappointed sigh, [npc.she] does as you command.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                                        ? "[npc.She] immediately moves to obey your order, and you see the distinct look of arousal in [npc.her] [npc.eyes] as [npc.she] obediently steps back and asks,"
                ...
                switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                    case DISLIKE:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out an angry scowl as [npc.she] hears your order, but, realising that [npc.she] really doesn't have any choice in the matter, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Shooting you a furious glare, [npc.she] snarls,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] snarls,").append(" [npc.speech(Fucking ").append(Main.game.getPlayer().isFeminine() ? "bitch" : "bastard").append("! Go on! Take a good look at your <i>property</i>, you sick fuck!)]").append("</p>").append("<p>").append("Ignoring [npc.her] rebellious words, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", drawing yet another angry remark from between your disobedient slave's [npc.lips].").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a frustrated sigh as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Glaring at you, [npc.she] snaps,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] snaps,").append(" [npc.speech(Very well, <i>[npc.pcName]</i>.)]").append("</p>").append("<p>").append("Ignoring [npc.her] slightly-rebellious tone, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, with a relieved sigh, [npc.she] does as you command.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                                        ? "[npc.She] immediately moves to obey your order, but you see the distinct look of hatred in [npc.her] [npc.eyes] as [npc.she] obediently steps back and asks,"
                                        : "[npc.She] immediately moves to obey your order, but you see the distinct look of hatred in [npc.her] [npc.eyes] as [npc.she] obediently drops [npc.her] clothing to the floor."
                                        + " As [npc.she] takes the last of [npc.her] clothes off, [npc.she] asks,").append(" [npc.speech(Is this to your pleasure, [npc.pcName]?)]").append("</p>").append("<p>").append("You answer in the affirmative, before commanding [npc.name] to parade around in front of you; an order which [npc.she] again dutifully carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, without a word of complaint, [npc.she] once more does exactly as you say.").append("</p>");
                                break;
                        }
                        break;
                    case NEUTRAL:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out a flustered cry as [npc.she] hears your order, but, realising that [npc.she] really doesn't have any choice in the matter, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Putting on [npc.her] most pleading expression, [npc.she] whines,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] whines,").append(" [npc.speech(Do I really have to? It's kind of degrading being forced to do this...)]").append("</p>").append("<p>").append("Ignoring [npc.her] words, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", which draws a relieved sigh from between your disobedient slave's [npc.lips].").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a flustered cry as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Putting on [npc.her] most pleading expression, [npc.she] whines,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] whines,").append(" [npc.speech(Just give me a moment, [npc.pcName].)]").append("</p>").append("<p>").append("After [npc.sheIs] stripped naked, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, with a relieved sigh, [npc.she] does as you command.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                    ...
                    case LIKE:
                        switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                            case DISOBEDIENT:
                                UtilText.nodeContentSB.append("[npc.She] lets out a sad little cry as [npc.she] hears your order, but, realising that [npc.she] really doesn't have any choice in the matter, begrudgingly moves to obey.").append(isSlaveNaked()
                                        ? " Putting on [npc.her] most pleading expression, [npc.she] whines,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] whines,").append(" [npc.speech(You know, it's kind of degrading being forced to do this... I thought you liked me...)]").append("</p>").append("<p>").append("Ignoring [npc.her] words, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", which draws a relieved sigh from between your disobedient slave's [npc.lips].").append("</p>");
                                break;
                            case NEUTRAL:
                                UtilText.nodeContentSB.append("[npc.She] lets out a sad little cry as [npc.she] hears your order, but, trying to keep [npc.her] emotions under control, slowly moves to obey.").append(isSlaveNaked()
                                        ? " Putting on [npc.her] most pleading expression, [npc.she] whines,"
                                        : " As [npc.she] takes [npc.her] clothes off, [npc.she] whines,").append(" [npc.speech(I thought you liked me, [npc.pcName]... But if this is what you want...)]").append("</p>").append("<p>").append("Ignoring [npc.her] slightly-rebellious protest, you command [npc.name] to parade around in front of you; an order which [npc.she] again reluctantly carries out.").append(" After that, you get [npc.herHim] to ").append(legsSpreading).append(partInspection()).append(" Satisfied with [npc.her] appearance, you tell [npc.name] ").append(isSlaveNaked() ? "to step back up before you" : "to get dressed again").append(", and, with a relieved sigh, [npc.she] does as you command.").append("</p>");
                                break;
                            case OBEDIENT:
                                UtilText.nodeContentSB.append(isSlaveNaked()
                ...
                UtilText.nodeContentSB.append("<p>" + "<i>It makes no difference that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, as being forced to strip and present [npc.herself] to you like a piece of meat has a hugely negative impact on [npc.her] affection towards you, while simultaneously increasing [npc.her] obedience!</i>").append("</p>");
            }
        ...
        public String getContent() {
            ...
            switch (AffectionLevelBasic.getAffectionLevelFromValue(getSlave().getAffection(Main.game.getPlayer()))) {
                case DISLIKE:
                    switch (ObedienceLevelBasic.getObedienceLevelFromValue(getSlave().getObedienceValue())) {
                        case DISOBEDIENT:
                            UtilText.nodeContentSB.append("An angry growl escapes from [npc.her] mouth as [npc.she] hears what you're ordering [npc.herHim] to do, but," + " understanding that [npc.she] doesn't have any choice in the matter, reluctantly moves to obey." + " As [npc.she] slowly takes [npc.her] clothes off, [npc.she] snaps," + " [npc.speech(You fucking ").append(Main.game.getPlayer().isFeminine() ? "bitch" : "bastard").append("! I hate you so fucking much!)]").append("</p>").append("<p>").append("Ignoring [npc.her] insolent remarks, you once again command [npc.name] to bend [npc.herself] over your knee; an order which [npc.she] again carries out as slowly as [npc.she] possibly can.").append(" As [npc.she] lies down in your lap, presenting [npc.her] [npc.ass+], you let out a victorious laugh, before swiftly bringing your [pc.hand] down to smack [npc.her] exposed cheeks.").append(" A squeal accompanies the sharp sound of flesh being whacked, which drives you to deliver yet another blow to [npc.her] [npc.ass].").append("</p>").append("<p>").append("You continue this for a little while; your slave squirming and squealing in your lap as you rain down blow after blow upon [npc.her] vulnerable backside.").append(" Eventually, however, you feel as though [npc.sheIs] been taught [npc.her] lesson, and you order [npc.herHim] to stand up and put [npc.her] clothes on once more.").append("</p>");
                            break;
                        case NEUTRAL:
                            UtilText.nodeContentSB.append(
            ...
            if (getSlave().getFetishDesire(Fetish.FETISH_MASOCHIST).isPositive()) {
                ...
                UtilText.nodeContentSB.append("<p>" + "<i>It makes no difference that [npc.name]" + " <span style='").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getColour().toWebHexString()).append("'>").append(getSlave().getAffectionLevel(Main.game.getPlayer()).getDescriptor()).append("</span>").append(" you, as being forced to present [npc.herself] for a disciplinary spanking has a hugely negative impact on [npc.her] affection towards you, while simultaneously increasing [npc.her] obedience!</i>").append("</p>");
            }
            UtilText.nodeContentSB.append(getFooterText());
    ...
    public static final DialogueNode SLAVE_MOLEST = new DialogueNode("", "", true) {
        ...
        public String getContent() {
            ...
            if (getSlave().hasBreasts()) {
                UtilText.nodeContentSB.append(" Your [pc.hands] reach up to cup and squeeze [npc.her] [npc.breasts+], drawing ").append(firstCry).append(" from [npc.namePos] mouth as [npc.she] ").append(firstReaction).append(",").append(" [npc.speech(").append(firstSpeech).append(")]").append("</p>").append("<p>").append(firstPCReaction).append(", and, with one [pc.hand] still squeezing [npc.her] [npc.breasts+], you slip the other down #IF(npc.hasLegs())between [npc.her] [npc.legs]#ELSEto [npc.her] groin#ENDIF.");
            } else {
                UtilText.nodeContentSB.append(" Your [pc.hands] reach up to run over [npc.her] chest, drawing ").append(firstCry).append(" from [npc.namePos] mouth as [npc.she] ").append(firstReaction).append(",").append(" [npc.speech(").append(firstSpeech).append(")]").append("</p>").append("<p>").append(firstPCReaction).append(", and, with one [pc.hand] still pressed against [npc.her] chest, you slip the other down #IF(npc.hasLegs())between [npc.her] [npc.legs]#ELSEto [npc.her] groin#ENDIF.");
            }

            if (getSlave().hasVagina() && getSlave().hasPenis()) {
                UtilText.nodeContentSB.append(" ").append(secondReaction).append(" as you grope, stroke, and fondle [npc.her] [npc.penis+], and you can't help but [pc.moan] into your slave's [npc.ear] as").append(thirdReaction).append(" you feel [npc.her] [npc.cock+] growing hard under your touch.").append(" Dropping your [pc.hand] down yet further, you shift your attention to [npc.her] [npc.pussy+],").append(" grinning once again as you feel that your stimulation of [npc.her] [npc.clit+] and [npc.labia+] have already gotten [npc.her] wet.").append("</p>");

            } else if (getSlave().hasVagina()) {
                UtilText.nodeContentSB.append(" ").append(secondReaction).append(" as you grope, stroke, and probe at [npc.her] [npc.clit+] and [npc.labia+], and you can't help but [pc.moan] into your slave's [npc.ear] as").append(thirdReaction).append(" you feel [npc.her] [npc.pussy+]").append(" is already wet from your touch.").append("</p>");

            } else if (getSlave().hasPenis()) {
                UtilText.nodeContentSB.append(" ").append(secondReaction).append(" as you grope, stroke, and fondle [npc.her] [npc.penis+], and you can't help but [pc.moan] into your slave's [npc.ear] as").append(thirdReaction).append(" you feel [npc.her] [npc.cock+] growing hard under your touch.").append("</p>");

            } else {
                UtilText.nodeContentSB.append(" ").append(secondReaction).append(" as you grope, stroke, and probe at [npc.her] genderless mound, and you can't help but [pc.moan] into your slave's [npc.ear] as").append(thirdReaction).append(" you feel [npc.herHim] thrust [npc.her] [npc.hips] out against your touch.").append("</p>");

            }
            UtilText.nodeContentSB.append("<p>").append(secondSpeech).append("</p>").append("<p>").append(finalDescription).append("</p>");
            ...
            if (getSlave().isAttractedTo(Main.game.getPlayer())) {
                if (getSlave().hasFetish(Fetish.FETISH_SUBMISSIVE) || getSlave().hasFetish(Fetish.FETISH_NON_CON_SUB)) {
                    UtilText.nodeContentSB.append(" As [npc.sheIs] both attracted to you, as well as").append(getSlave().hasFetish(Fetish.FETISH_SUBMISSIVE)
                            ? (getSlave().hasFetish(Fetish.FETISH_NON_CON_SUB)
                            ? " being both a submissive and turned on by non-consensual encounters,"
                            : " being a submissive,")
                            : " being turned on by non-consensual encounters,").append(" your dominant, non-consensual use of [npc.namePos] body has resulted in [npc.herHim] liking you more!</i>").append("</p>");
                } else {
                    UtilText.nodeContentSB.append(
                ...
                if (getSlave().hasFetish(Fetish.FETISH_SUBMISSIVE) || getSlave().hasFetish(Fetish.FETISH_NON_CON_SUB)) {
                    UtilText.nodeContentSB.append(" Despite the fact that [npc.sheIs] not attracted to you,").append(getSlave().hasFetish(Fetish.FETISH_SUBMISSIVE)
                            ? (getSlave().hasFetish(Fetish.FETISH_NON_CON_SUB)
                            ? " by being both a submissive and turned on by non-consensual encounters,"
                            : " by being a submissive,")
                            : " by being turned on by non-consensual encounters,").append(" your dominant, non-consensual use of [npc.namePos] body has resulted in [npc.herHim] neither losing nor gaining affection towards you!</i>").append("</p>");
                } else {
                    UtilText.nodeContentSB.append(
