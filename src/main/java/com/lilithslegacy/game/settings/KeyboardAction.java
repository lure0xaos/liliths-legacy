...
public enum KeyboardAction {
    ...
    private final KeyCodeWithModifiers primaryDefault;
    private final KeyCodeWithModifiers secondaryDefault;

    KeyboardAction(String name, KeyCodeWithModifiers primaryDefault, KeyCodeWithModifiers secondaryDefault) {
        this.name = name;
