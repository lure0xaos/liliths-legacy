...
import com.lilithslegacy.game.occupantManagement.slave.TestSubjectTransformation;
import com.lilithslegacy.game.occupantManagement.slaveEvent.SlaveEvent;
import com.lilithslegacy.game.occupantManagement.slaveEvent.SlaveEventTag;
...
public class OccupancyUtil implements XMLSaving {
    ...
    public static OccupancyUtil loadFromXML(Element parentElement, Document doc) {
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Warning: SlaveryUtil failed to import!");
            return null;
        }
    }
        ...
        for (String id : Main.game.getPlayer().getSlavesOwned()) {
            ...
            if (charactersAtJob.get(currentJob).size() > 1 || (currentJob == SlaveJob.IDLE && slave.getLocationPlace().getPlaceType() != PlaceType.SLAVER_ALLEY_SLAVERY_ADMINISTRATION)) {
                if (Math.random() < 0.25f
                        ...
                        && slave.getLocationPlace().getPlaceUpgrades().stream().noneMatch(upgrade -> upgrade.getImmobilisationType() != null)) { // Do not generate sex events if the slave is in a place that applies immobilisation.
                        ...
                        if (settingsEnabled.isEmpty() || Math.random() > 0.8f) {
                            ...
                            switch (eventGenerated) {
                                case SEX_ANAL:
                                    ...
                                    effects.add("<span style='color:" + PresetColour.CUM.toWebHexString() + ";'>Anal Creampie:</span> " + effectDescriptions);
                                    effectDescriptions.setLength(0);
                                ...
                                case SEX_ORAL:
                                    ...
                                    effects.add("<span style='color:" + PresetColour.CUM.toWebHexString() + ";'>Swallowed Cum:</span> " + effectDescriptions);
                                    effectDescriptions.setLength(0);
                                ...
                                case SEX_NIPPLES:
                                    ...
                                    effects.add("<span style='color:" + PresetColour.CUM.toWebHexString() + ";'>Nipple Creampie:</span> " + effectDescriptions);
                                    effectDescriptions.setLength(0);
                                ...
                                case SEX_VAGINAL:
                                    ...
                                    if (slave.isVisiblyPregnant()) {
                                        ...
                                        effects.add("<span style='color:" + PresetColour.CUM.toWebHexString() + ";'>Pussy Creampie:</span> " + effectDescriptions);
                                        effectDescriptions.setLength(0);
                                        ...
                                        effects.add("<span style='color:" + PresetColour.GENERIC_ARCANE.toWebHexString() + ";'>Pregnancy Risk:</span> " + effectDescriptions);
                                        effectDescriptions.setLength(0);
