...
public class Properties {
    ...
    public static final String[] multiBreastsLabels = new String[]{"Never", "Off", "Furry-only", "On"};
    public static final String[] multiBreastsDescriptions = new String[]{
            ...
            "Randomly-generated NPCs will have multiple rows of breasts if their breast type is furry (starts at 'Minor morph' level)."
                    + "<br/><i>Characters can always gain additional breasts via transformations after they've spawned.</i>"};
    public static final String[] uddersLabels = new String[]{"Off", "Taur-only", "On"};
    public static final String[] uddersDescriptions = new String[]{
    ...
    public static final String[] autoSaveLabels = new String[]{"Always", "Daily", "Weekly"};
    public static final String[] autoSaveDescriptions = new String[]{
    ...
    public static final String[] bypassSexActionsLabels = new String[]{"None", "Limited", "Full"};
    public static final String[] getBypassSexActionsDescriptions = new String[]{
    ...
    public final Colour[] clothingFemininityColours = new Colour[]{PresetColour.GENERIC_BAD, PresetColour.MASCULINE, PresetColour.FEMININE, PresetColour.GENERIC_GOOD};
    public final String[] clothingFemininityTitles = new String[]{"None", "Masculine", "Feminine", "All"};
    public final String[] clothingFemininityDescriptions = new String[]{
    ...
    public final Set<PropertyValue> values;
    // Difficulty settings
    ...
    public final Map<KeyboardAction, KeyCodeWithModifiers> hotkeyMapPrimary;
    public final Map<KeyboardAction, KeyCodeWithModifiers> hotkeyMapSecondary;
    public final Map<GenderNames, String> genderNameFemale;
    public final Map<GenderNames, String> genderNameMale;
    public final Map<GenderNames, String> genderNameNeutral;
    public final Map<GenderPronoun, String> genderPronounFemale;
    public final Map<GenderPronoun, String> genderPronounMale;
    ...
    public Properties() {
        ...
        skinColourPreferencesMap.putAll(PresetColour.getHumanSkinColoursMap());
    ...
    public void savePropertiesAsXML() {
        try {
            ...
            String pathname = "data/properties.xml";
            FS.createFile(pathname);
            StreamResult result = new StreamResult(Files.newOutputStream(FS.newPath(pathname),
    ...
    public void loadPropertiesFromXML() {
        ...
        if (Files.exists(FS.newPath("data/properties.xml")))
            try {
                Path propertiesXML = FS.newPath("data/properties.xml");
                DocumentBuilder fsDocumentBuilder = Main.getDocBuilder();
                Document doc = fsDocumentBuilder.parse(Files.newInputStream(propertiesXML));
                ...
                if (element != null && element.getElementsByTagName("pronoun") != null) {
                    for (int i = 0; i < element.getElementsByTagName("pronoun").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: genderPronouns pronoun");
                        }
                    }
                }
                ...
                if (element != null && element.getElementsByTagName("preference") != null) {
                    for (int i = 0; i < element.getElementsByTagName("preference").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: genderPreferences preference");
                        }
                    }
                }
                ...
                if (element != null && element.getElementsByTagName("preference") != null) {
                    for (int i = 0; i < element.getElementsByTagName("preference").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: agePreferences preference");
                        }
                    }
                }
                ...
                if (element != null && element.getElementsByTagName("preference") != null) {
                    for (int i = 0; i < element.getElementsByTagName("preference").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: orientationPreferences preference");
                        }
                    }
                }
                ...
                if (element != null && element.getElementsByTagName("preference") != null) {
                    for (int i = 0; i < element.getElementsByTagName("preference").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: fetishPreferences preference");
                        }
                    }
                }
                ...
                if (element != null && element.getElementsByTagName("preference") != null) {
                    for (int i = 0; i < element.getElementsByTagName("preference").getLength(); i++) {
                        ...
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "loadPropertiesFromXML() error: skinColourPreferences preference");
                        }
                    }
                }
