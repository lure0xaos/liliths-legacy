...
//		@Override
//		public int getLength(GameCharacter owner, boolean penetrationLength) {
//			com.lilithslegacy.utils.log.Log.log("Warning: Toy length is being called!");
//			return 8;
//		}
//		@Override
//		public boolean isFree(GameCharacter owner) {
...
//			StringBuilder sb = new StringBuilder();
//			if(performer==target) {
//				com.lilithslegacy.utils.log.Log.log("SexAreaPenetration.TOY getSexDescription() error: Does not support self actions!");
//				return "";
//			}
//
//			if(targetArea.isPenetration()) {
