...
public enum SexAreaPenetration implements SexAreaInterface {
    ...
    PENIS(4, -2f, true) {
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            ...
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.PENIS getSexDescription() error: Does not support self actions!");
                return "";
            }
                    ...
                    case TAIL:
                        ...
                        if (pastTense) {
                            ...
                            switch (targetPace) {
                                ...
                                case SUB_EAGER:
                                case SUB_NORMAL:
                                    sb.append(" [npc2.SexPaceVerb] wrapping [npc2.her] ").append(multipleTails ? "[npc2.tails+]" : "[npc2.tail+]").append(" around [npc.namePos] [npc.cock],").append(" [npc2.name] took great pleasure in using ").append(multipleTails ? "them" : "it").append(" to jerk [npc.herHim] off.");
                                    break;
                                case DOM_ROUGH:
                                    sb.append(" [npc2.SexPaceVerb] wrapping [npc2.her] ").append(multipleTails ? "[npc2.tails+]" : "[npc2.tail+]").append(" around [npc.namePos] [npc.cock],").append(" [npc2.name] dominantly ordered [npc.herHim] to remain still while [npc2.she] used ").append(multipleTails ? "them" : "it").append(" to jerk [npc.herHim] off.");
                                    break;
                                case SUB_RESISTING:
                                    sb.append(" Letting out pitiful sobs, [npc2.name] tried to plead with [npc.name] to leave [npc2.herHim] alone," + " but [npc.she] simply ignored [npc2.herHim] and continued using [npc.her] ").append(multipleTails ? "[npc2.tails+]" : "[npc2.tail+]").append(" to jerk [npc.herHim] off.");
                                    break;
                            }
                    ...
                    case TENTACLE:
                        ...
                        if (pastTense) {
                            ...
                            switch (targetPace) {
                                ...
                                case SUB_EAGER:
                                case SUB_NORMAL:
                                    sb.append(" [npc2.SexPaceVerb] wrapping [npc2.her] ").append(multipleTentacles ? "[npc2.tentacles+]" : "[npc2.tentacle+]").append(" around [npc.namePos] [npc.cock],").append(" [npc2.name] took great pleasure in using ").append(multipleTentacles ? "them" : "it").append(" to jerk [npc.herHim] off.");
                                    break;
                                case DOM_ROUGH:
                                    sb.append(" [npc2.SexPaceVerb] wrapping [npc2.her] ").append(multipleTentacles ? "[npc2.tentacles+]" : "[npc2.tentacle+]").append(" around [npc.namePos] [npc.cock],").append(" [npc2.name] dominantly ordered [npc.herHim] to remain still while [npc2.she] used ").append(multipleTentacles ? "them" : "it").append(" to jerk [npc.herHim] off.");
                                    break;
                                case SUB_RESISTING:
                                    sb.append(" Letting out pitiful sobs, [npc2.name] tried to plead with [npc.name] to leave [npc2.herHim] alone," + " but [npc.she] simply ignored [npc2.herHim] and continued using [npc.her] ").append(multipleTentacles ? "[npc2.tentacles+]" : "[npc2.tentacle+]").append(" to jerk [npc.herHim] off.");
                                    break;
                            }
    ...
    CLIT(4, -2f, true) {
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.CLIT getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    TONGUE(2, 0, false) {
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.TONGUE getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    FINGER(1, 0, false) {
        ...
        @Override
        public int getLength(GameCharacter owner, boolean penetrationLength) {
            System.getLogger("").log(System.Logger.Level.ERROR, "Warning: Finger length is being called!");
            return 8;
        }
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.FINGER getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    FOOT(1, 0, false) {
        ...
        @Override
        public int getLength(GameCharacter owner, boolean penetrationLength) {
            System.getLogger("").log(System.Logger.Level.ERROR, "Warning: Foot length is being called!");
            return 8;
        }
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.FOOT getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    TAIL(2, -1f, true) {
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.TAIL getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    TENTACLE(3, -1.5f, true) {
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaPenetration.TENTACLE getSexDescription() error: Does not support self actions!");
                return "";
            }
...
//		@Override
//		public int getLength(GameCharacter owner, boolean penetrationLength) {
//			System.getLogger("").log(System.Logger.Level.ERROR,"Warning: Toy length is being called!");
//			return 8;
//		}
//		@Override
//		public boolean isFree(GameCharacter owner) {
...
//			StringBuilder sb = new StringBuilder();
//			if(performer==target) {
//				System.getLogger("").log(System.Logger.Level.ERROR,"SexAreaPenetration.TOY getSexDescription() error: Does not support self actions!");
//				return "";
//			}
//
//			if(targetArea.isPenetration()) {
