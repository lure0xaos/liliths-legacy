...
public class SexType implements XMLSaving {
    ...
    private final SexParticipantType asParticipant;
    private final SexAreaInterface performingSexArea;
    private final SexAreaInterface targetedSexArea;
    ...
    public boolean equals(Object o) {
        if (o instanceof SexType) {
            return ((SexType) o).getAsParticipant() == getAsParticipant()
    ...
    public String getPerformanceDescription(boolean pastTense, boolean extendedDescription, GameCharacter performer, GameCharacter target) {
        ...
        if (extendedDescription) {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "SexType.getPerformanceDescription() error: No description found for " + areaPerforming + " targeting " + areaTargeted + "!");
        }
