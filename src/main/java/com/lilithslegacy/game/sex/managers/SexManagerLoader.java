...
//                    System.out.println("modded sex manager: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded sexManager type failed at 'SexManager'. FSPath path: " + innerEntry.getValue());
...
//                        System.out.println("Added sex manager: "+id);
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading sexManager type failed at 'SexManager'. FSPath path: " + innerEntry.getValue());
                        System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                        ex.printStackTrace(System.err);
                    }
                }
