...
//                com.lilithslegacy.utils.log.Log.log("Error in sex position '"+position.getName()+"': Cannot check if partners are assigned to the same slot.");
            }
        }
...
//                        }
            ...
            if (!priorityOrgasms.isEmpty()) {
                ...
                if (availableActions.isEmpty()) {
                    String message = partner.getName(true) + " has no orgasm actions!!!";
