...
//				System.getLogger("").log(System.Logger.Level.ERROR,"Error in sex position '"+position.getName()+"': Cannot check if partners are assigned to the same slot.");
            }
        }
...
//						}
            ...
            if (!priorityOrgasms.isEmpty()) {
                ...
                if (availableActions.isEmpty()) {
                    System.getLogger("").log(System.Logger.Level.ERROR, partner.getName(true) + " has no orgasm actions!!!");
...
//					System.out.println("Not happy in slot");
        ...
        if (!availableActions.isEmpty()
            ...
            List<CoverableArea> partnerAreasToBeExposed = new ArrayList<>(Main.sex.getInitialSexManager().getAdditionalAreasToExposeDuringSex(partner, partner));
            List<CoverableArea> targetAreasToBeExposed = new ArrayList<>(Main.sex.getInitialSexManager().getAdditionalAreasToExposeDuringSex(partner, targetedCharacter));
