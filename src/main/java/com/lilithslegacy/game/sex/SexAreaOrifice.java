...
public enum SexAreaOrifice implements SexAreaInterface {
    ...
    MOUTH(2,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            ...
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.MOUTH getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    NIPPLE(2,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.NIPPLE getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    BREAST(1,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.BREAST getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    NIPPLE_CROTCH(2,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.NIPPLE_CROTCH getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    BREAST_CROTCH(1,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.BREAST_CROTCH getSexDescription() error: Does not support self actions!");
                return "";
            }
...
//			return owner.getAssName(false);
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.ASS getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    ANUS(2,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.ANUS getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    VAGINA(4,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.VAGINA getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    THIGHS(1,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.THIGHS getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    URETHRA_VAGINA(1,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.URETHRA_VAGINA getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    URETHRA_PENIS(1,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.URETHRA_PENIS getSexDescription() error: Does not support self actions!");
                return "";
            }
    ...
    SPINNERET(2,
        ...
        public String getSexDescription(boolean pastTense, GameCharacter performer, SexPace performerPace, GameCharacter target, SexPace targetPace, SexAreaInterface targetArea) {
            StringBuilder sb = new StringBuilder();
            if (performer == target) {
                System.getLogger("").log(System.Logger.Level.ERROR, "SexAreaOrifice.SPINNERET getSexDescription() error: Does not support self actions!");
                return "";
            }
