...
public abstract class AbstractSexPosition {
    ...
    public static final List<SexAreaOrifice> genericGroinForceCreampieAreas = Util.newArrayListOfValues(SexAreaOrifice.ANUS, SexAreaOrifice.VAGINA, SexAreaOrifice.URETHRA_VAGINA, SexAreaOrifice.URETHRA_PENIS, SexAreaOrifice.SPINNERET);
    public static final List<SexAreaOrifice> genericFaceForceCreampieAreas = Util.newArrayListOfValues(SexAreaOrifice.MOUTH);
    private final String name;
    private final int maximumSlots;
    private final boolean addStandardActions;
    private final List<Class<?>> positioningClasses;
    private final List<Class<?>> specialClasses;
...
//	}
    ...
    public Set<SexSlot> getAllAvailableSexPositions() {
        ...
        getSlotTargets().entrySet().forEach(e -> positions.addAll(e.getValue().keySet()));
