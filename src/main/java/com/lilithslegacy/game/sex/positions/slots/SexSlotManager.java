...
public class SexSlotManager {
    ...
    private static final List<SexSlot> allSexSlots = new ArrayList<>();
    private static final Map<SexSlot, String> sexSlotToIdMap = new HashMap<>();
    private static final Map<String, SexSlot> idToSexSlotMap = new HashMap<>();
