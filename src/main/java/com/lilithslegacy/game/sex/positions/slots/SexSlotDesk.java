...
public class SexSlotDesk {
    ...
    public static final SexSlot HUMPING = new SexSlot(
        ...
        public String getName(GameCharacter target) {
            ...
            if (partner == null) {
                partner = getCharacterInSlot(OVER_DESK_ON_BACK);
            }
            if (partner != null) {
    ...
    public static final SexSlot HUMPING_TWO = new SexSlot(
        ...
        public String getName(GameCharacter target) {
            ...
            if (partner == null) {
                partner = getCharacterInSlot(OVER_DESK_ON_BACK_TWO);
            }
            if (partner != null) {
                return "Humping " + UtilText.parse(partner, "[npc.name]");
            }
    ...
    public static final SexSlot HUMPING_THREE = new SexSlot(
        ...
        public String getName(GameCharacter target) {
            ...
            if (partner == null) {
                partner = getCharacterInSlot(OVER_DESK_ON_BACK_THREE);
            }
            if (partner != null) {
                return "Humping " + UtilText.parse(partner, "[npc.name]");
            }
    ...
    public static final SexSlot HUMPING_FOUR = new SexSlot(
        ...
        public String getName(GameCharacter target) {
            ...
            if (partner == null) {
                partner = getCharacterInSlot(OVER_DESK_ON_BACK_FOUR);
            }
            if (partner != null) {
                return "Humping " + UtilText.parse(partner, "[npc.name]");
            }
