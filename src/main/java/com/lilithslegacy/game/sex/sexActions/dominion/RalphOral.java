...
public class RalphOral {
    ...
    public static final SexAction PLAYER_BIG_DISCOUNT = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("As you've been sucking Ralph's cock, you've started to feel a desperate craving deep in your loins." + " You want to feel him inside of you. His fat, animalistic cock pumping away at your pussy, before filling you with his potent seed..." + " You can't hold back any longer, and, sliding his cock fully out of your mouth, you shuffle forwards to look up at him with big, innocent eyes." + "<br/>").append(UtilText.parseSpeechNoEffects("Perhaps there's a way I could earn even more of a discount?", Main.game.getPlayer())).append(" you ask in your most convincingly seductive tone.");
    ...
    public static final SexAction PLAYER_ANAL_BIG_DISCOUNT = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("As you've been sucking Ralph's cock, you've started to feel a desperate craving deep in your loins." + " You want to feel him inside of you. His fat, animalistic cock pumping away at your ass, before filling you with his potent seed..." + " You can't hold back any longer, and, sliding his cock fully out of your mouth, you shuffle forwards to look up at him with big, innocent eyes." + "<br/>").append(UtilText.parseSpeechNoEffects("Perhaps there's a way I could earn even more of a discount?", Main.game.getPlayer())).append(" you ask in your most convincingly seductive tone.");
    ...
    public static final SexAction PARTNER_DIRTY_TALK = new SexAction(
        ...
        public String getDescription() {
            ...
            if (SexFlags.customerAtCounter)
                UtilText.nodeContentSB.append("Ralph quickly finishes up with the customer, and as you hear them start to walk away, you realise that by staying quiet, they didn't find out that you were here!" + "<br/><br/>" + "<b>There are now</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>no customers</b> <b>near the counter.</b>").append("<br/><br/>");
    ...
    public static final SexAction PARTNER_DIRTY_TALK_VAGINAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("You feel Ralph's grip move down to grope and squeeze your ").append(Main.game.getPlayer().getAssSize().getDescriptor()).append(" ass as he groans down to you, ");
            switch (Util.random.nextInt(4)) {
                case 0:
    ...
    public static final SexAction PARTNER_COMMAND_START_ORAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("You hear Ralph let out an impatient grunt as he bends down towards you, ").append(UtilText.parseSpeech("What are you doing? You agreed to do this, so don't keep me waiting!", Main.game.getNpc(Ralph.class)));
    ...
    public static final SexAction PARTNER_PASSIVE_VAGINAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("The constant pounding between your legs starts to slow down, and you turn your head slightly as you look back to see what's wrong." + " As Ralph smiles back at you, you notice that his chest is heaving, and you realise that he's simply slowed down for a moment to catch his breath." + " Sinking his cock fully into your greedy little cunt, he squeezes and gropes your ").append(Main.game.getPlayer().getAssSize().getDescriptor()).append(" ass, and you rest your head back in your arms,").append(" moaning and sighing as you both take a moment to recover.").append("<br/><br/>").append("After less than a minute, you feel the wide, flared head of his horse-cock sliding back out of your pussy, and as you let out a pathetic little whine at the feeling of emptiness,").append(" Ralph tightens his grip on your hips before thrusting forwards, turning your whine into a high-pitched squeal of pleasure as he starts fucking you at full pace once more.");
    ...
    public static final SexAction PARTNER_START_ORAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("You hear Ralph let out a very annoyed grunt as he bends down towards you, ").append(UtilText.parseSpeech("I'll show you how to get started!", Main.game.getNpc(Ralph.class))).append("<br/>").append("Before you have any time to respond, he suddenly pushes his hips forwards.").append(" His hard shaft quickly pushes your head back against the counter behind you, and before you know what's happening, the flared head of his equine member is rubbing forcefully over your face.").append(" With a quick reposition and another determined thrust, you feel your lips parting as Ralph rams his eager horse-cock past your lips and into your mouth.").append(" As you realise that this is, in fact, happening, you finally start to do what you agreed to, and begin sucking Ralph's cock.");
    ...
    public static final SexAction PARTNER_PASSIVE_ANAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("The constant pounding of your rear entrance starts to slow down, and you turn your head slightly as you look back to see what's wrong." + " As Ralph smiles back at you, you notice that his chest is heaving, and you realise that he's simply slowed down for a moment to catch his breath." + " Sinking his cock fully into your greedy asshole, he squeezes and gropes your ").append(Main.game.getPlayer().getAssSize().getDescriptor()).append(" ass, and you rest your head back in your arms,").append(" groaning and sighing as you both take a moment to recover.").append("<br/><br/>").append("After less than a minute, you feel the wide, flared head of his horse-cock sliding out of your back door, and as you let out a pathetic little whine at the feeling of emptiness,").append(" Ralph tightens his grip on your hips before thrusting forwards, turning your whine into a desperate cry of pleasure as he starts fucking you at full pace once more.");
    ...
    public static final SexAction PARTNER_PENETRATES = new SexAction(
        ...
        public String getDescription() {
            ...
            if (SexFlags.alertedCustomer) {
                UtilText.nodeContentSB.append("Ralph bends down towards you, ").append(UtilText.parseSpeech("What did I tell you about this being a respectable establishment?! I made it quite clear what would happen if you made too much noise!"
                        + " I'm knocking five percent off our deal, no complaints!", Main.game.getNpc(Ralph.class))).append("<br/>").append("Despite his usual polite and friendly temperament, he sounds quite angry as he scolds you, and you feel a little bad for putting the reputation of his shop on the line.").append(" Then again, he was the one to suggest this, so it's not as though you're entirely the one at fault here...").append("<br/><br/>").append("<b>You will now earn a</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>").append(SexFlags.ralphDiscount > 0 ? SexFlags.ralphDiscount - 5 : 0).append("%</b> <b>discount.</b>").append("<br/><br/>");
            }

            UtilText.nodeContentSB.append("Ralph steps back, and, not even bothering to pull his trousers up, walks off to the front of the shop." + " As you hear him locking the front door and pulling down the shop's blinds, you realise that the last customer must have left some time ago." + " Wanting to see what's going on, you shuffle your way out from beneath the counter and try to stand up." + "<br/><br/>" + "Almost instantly, a huge jolt of cramp shoots up through your legs, and you let out a little cry as you bend over and grab the edge of the counter." + " Suddenly, you feel a strong pair of hands grab your hips, and before you can react, Ralph pushes you down, face first, onto the counter-top." + " You let out a little moan at his dominant treatment of you, and as he roughly gropes and squeezes your ").append(Main.game.getPlayer().getAssSize().getDescriptor()).append(" ass, he leans down and growls in your ear, ").append(UtilText.parseSpeech(
                    ...
                    ), Main.game.getNpc(Ralph.class))).append("<br/><br/>").append("By now, you don't really care about the discount, all you want is to feel that delicious cock sliding in between your legs.").append(" Even before Ralph's finished giving you his offer, you're moaning in agreement, and he lets out a little laugh as he reaches down to grope your ").append(Main.game.getPlayer().getVaginaType() == VaginaType.HORSE_MORPH ? "needy horse-pussy." : "hot little pussy.").append("<br/><br/>").append(Main.game.getPlayer().isVisiblyPregnant()
                    ...
                    : "Pushing your top-half down onto the counter top, Ralph wastes no time in lining his massive cock up to your waiting cunt, and as he starts to push forwards, you let out a desperate squeal.").append(" His wide, flared head slowly pushes its way into you, and you pant and squirm as your folds lewdly spread around his animalistic horse-cock.").append(" With a quick step forwards, Ralph suddenly rams his impatient member deep into your hungry snatch, and you gasp and moan as he starts fucking you on the shop's counter-top.").append("</p>").append("<p style='text-align:center;'>").append("<b>You will now earn a</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>").append(SexFlags.ralphDiscount + (Main.sex.getCharacterPerformingAction().isWearingCondom() || Main.game.getPlayer().isVisiblyPregnant() ? 20 : 25) - (SexFlags.alertedCustomer ? 5 : 0)).append("%</b> <b>discount.</b>");
    ...
    public static final SexAction PARTNER_PENETRATES_ANUS = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("Ralph steps back, and, not even bothering to pull his trousers up, walks off to the front of the shop." + " As you hear him locking the front door and pulling down the shop's blinds, you realise that the last customer must have left some time ago." + " Before you have time to get out from under the counter, however, the imposing figure of Ralph moves back into view, blocking your way." + "<br/><br/>").append(UtilText.parseSpeech("So you want a bigger discount, huh?! And how exactly do you intend to earn it?", Main.game.getNpc(Ralph.class))).append(" He asks, crossing his arms and frowning down at you.").append("<br/><br/>").append("You realise that although he was perfectly happy with having you suck his cock, he's going to need some convincing if you're to get him to use your other hole.").append(" Shifting aside your clothing, you awkwardly shuffle around on the spot, bending over to present your ").append(Main.game.getPlayer().getAssCapacity().getDescriptor()).append(" asshole.").append(" You hear Ralph struggling to suppress an eager groan, and as you shake your ").append(Main.game.getPlayer().getHipSize().getDescriptor()).append(" hips from side to side, he breaks his composure.").append("<br/><br/>").append("Suddenly, you feel a strong pair of hands grab your hips, and before you can react, Ralph pulls you back out from under the counter, and in one swift movement, pushes you down, face first, onto the counter-top.").append(" You let out a happy little cry at his dominant treatment of you, and as he roughly gropes and squeezes your ").append(Main.game.getPlayer().getAssSize().getDescriptor()).append(" ass, he leans down and growls in your ear, ").append(UtilText.parseSpeech(
                    "You know, I don't usually do this sort of thing... But damn, you've got a nice-looking ass! I'll give you another twenty percent if you let me take it for a spin.", Main.game.getNpc(Ralph.class))).append("<br/><br/>").append("By now, you don't really care about the discount, all you want is to feel that delicious cock ramming its way into your rear entrance.").append(" Even before Ralph's finished giving you his offer, you're crying out in agreement, and he wastes no time in lining his massive cock up to your waiting asshole.").append(" You feel the wide, flared head rubbing all over your slutty hole, and as he starts to slowly push his animalistic horse-cock into you, you begin to squirm and squeal.").append(" With a quick step forwards, Ralph suddenly rams his impatient member deep into your hungry back door, and you let out an ear-splitting cry as he starts fucking you on the shop's counter-top.").append("</p>").append("<p style='text-align:center;'>").append("<b>You will now earn a</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>").append(SexFlags.ralphDiscount + 20 - (SexFlags.alertedCustomer ? 5 : 0)).append("%</b> <b>discount.</b>");
    ...
    public static final SexAction PLAYER_ORGASM = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.game.getPlayer().hasPenisIgnoreDildo()) {
                ...
                // Describe cum amount:
                UtilText.nodeContentSB.append(" As your ").append(Main.game.getPlayer().getTesticleSize().getDescriptor()).append(" balls tense up");
        ...
        public String getDescription() {
            ...
            if (!Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.VAGINA).isEmpty()) {
                ...
                if (Main.sex.getCharacterPerformingAction().isWearingCondom()) {
                    ...
                    UtilText.nodeContentSB.append(" With a powerful rocking motion, his gigantic dick spurts out its potent load").append(Main.game.getPlayer().isVisiblyPregnant()
                            ? ", and as you feel the hot cum filling you up, you let out a satisfied moan."
                            : " directly into your womb, and as you feel the hot cum filling you up, you let out a satisfied moan.").append(" His cock continues to pump a few more times, the huge, black equine shaft making sure to deposit its seed deep into your hungry cunt.").append(Main.game.getPlayer().isVisiblyPregnant()
                            ...
                            : " Once your womb is completely saturated with sticky white horse-jizz, you feel Ralph's strong grip on your hips start to relax as he finishes his orgasm.").append("<br/><br/>").append("As Ralph's balls finish emptying themselves, he steps back, and with a wet sucking sound, slips his rapidly-softening member out of your well-used slit.").append(" You let out a little sigh as you're suddenly left feeling extremely empty, and you feel a little trickle of his warm, wet seed escaping from your entrance.").append(" Rolling over onto your back, you playfully wrap your legs around Ralph, pulling him forwards and rubbing your cum-filled pussy against his now-flaccid equine cock.").append(" It seems as though he's not up for round two, however, and you pout at him as he takes hold of your legs and disentangles himself, laughing as he sees your reaction,").append(" [ralph.speechNoEffects(Hey! I've got a shop to run here, remember? Anyway, I think you've more than earned that discount...)]");
                }
                ...
                if (SexFlags.customerAtCounter) {
                    if (SexFlags.alertedCustomer)
                        UtilText.nodeContentSB.append("Ralph quickly finishes up with the customer, who's still chuckling at the knowledge of what's going on under the counter." + " Ralph just seems to want to get rid of them as soon as possible, and forgets to knock off the portion of your discount he just gave away!" + " The reason for his oversight is soon made clear..." + "<br/><br/>" + "<b>There are now</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>no customers</b> <b>near the counter.</b>").append("<br/><br/>");
                    else
                        UtilText.nodeContentSB.append("Ralph quickly finishes up with the customer, and as you hear them start to walk away, you realise that by staying quiet, they didn't find out that you were here!" + "<br/><br/>" + "<b>There are now</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>no customers</b> <b>near the counter.</b>").append("<br/><br/>");
                }
            ...
            if (((Ralph) Main.game.getNpc(Ralph.class)).isDiscountActive() && (SexFlags.ralphDiscount < Main.game.getDialogueFlags().ralphDiscount)) {
                UtilText.nodeContentSB.append("<br/><br/>" + "<b style='color:").append(PresetColour.TEXT_GREY.toWebHexString()).append(";'>You have earned a ").append(SexFlags.ralphDiscount).append("% discount for the next three days!</b>").append("<br/><br/>").append("<b>Because Ralph was already giving you the bigger discount of </b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>").append(Main.game.getDialogueFlags().ralphDiscount).append("%</b><b>, he instead agrees to refresh that for the next three days!</b>");

            } else {
                UtilText.nodeContentSB.append("<br/><br/><b>You have earned a</b> <b style='color:").append(PresetColour.GENERIC_GOOD.toWebHexString()).append(";'>").append(SexFlags.ralphDiscount).append("%</b> <b>discount for the next three days!</b>");
            }
