...
//					&& (Main.sex.getCharacterPerformingAction().isPlayer() || !Main.sex.getCharacterPerformingAction().getFetishDesire(Fetish.FETISH_SADIST).isNegative());
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("As [npc.name] [npc.verb(feel)] [npc2.namePos] [npc2.asshole+] squeezing down around [npc.her] [npc.cock+], [npc.she] [npc.verb(decide)] to show [npc2.herHim] how").append(Main.sex.getCharacterPerformingAction().getRace() == Race.WOLF_MORPH || Main.sex.getCharacterPerformingAction().getRace() == Race.DOG_MORPH
                    ? " an alpha treats their submissive little beta."
                    : " a real dom treats their submissive bitch.").append(" Letting out [npc.a_moan+], [npc.name] [npc.verb(slam)] [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.ass+], grinning devilishly as [npc2.she] [npc2.verb(let)] out [npc2.a_moan+].").append("<br/><br/>").append("Reaching down, [npc.she] then [npc.verb(grab)] [npc2.namePos] shoulders, before pushing [npc.her] weight down onto [npc2.her] back as [npc.she] roughly [npc.verb(mount)] [npc2.herHim].").append(" With [npc.namePos] weight now on top of [npc2.herHim], [npc2.name] [npc2.verb(collapse)] to the floor with [npc2.a_moan+].").append(" Bending down, and with [npc.her] throbbing [npc.cock] still hilted in [npc2.namePos] [npc2.asshole+], [npc.name] [npc.verb(growl)] menacingly in [npc2.her] [npc2.ear], ").append("[npc.speech(You little bitch! All you're good for is being my slutty cock-sleeve!)]").append("<br/><br/>").append("Upon hearing those degrading words, [npc2.Name] [npc2.verb(let)] out another [npc2.moan+], which is enough to send [npc.name] over the edge.").append(" As [npc.she] [npc.verb(grind)] [npc2.namePos] [npc2.face+] into the floor, [npc.she] [npc.verb(reach)] [npc.her] climax, and as [npc.her] [npc.balls+] tense up");
            ...
            UtilText.nodeContentSB.append("<br/><br/>" + "Panting heavily, [npc.name] suddenly [npc.verb(remember)] what [npc.she] had planned, and [npc.verb(shuffle)] around to where [npc2.namePos] face is still collapsed down against the floor.").append(Main.sex.getCharacterTargetedForSexAction(this).hasHair()
                    ? " Reaching down, [npc.she] roughly [npc.verb(grab)] a fistful of [npc2.namePos] [npc2.hair+],"
                    : " Reaching down, [npc.she] roughly [npc.verb(grab)] [npc2.namePos] neck,").append(" and before [npc2.she] [npc2.has] a chance to react, [npc.she] [npc.verb(shove)] [npc2.her] [npc2.face+] down onto [npc.her] [npc.cock+].").append(" [npc2.Name] [npc2.moansVerb] and [npc2.verb(squirm)] as ").append(Main.sex.getCharacterPerformingAction().isPlayer() ? "you" : "[npc2.her] dominant partner").append(" [npc.verb(give)] [npc2.herHim] a taste of [npc2.her] own [npc2.ass],").append(" and, holding [npc2.herHim] tightly in position, [npc.she] [npc.moansVerb+] as [npc2.her] frantic [npc2.tongue] cleans [npc.herHim] off.").append("<br/><br/>").append("After a minute of using [npc2.name] in this manner, [npc.name] finally [npc.verb(release)] [npc2.herHim], and, with a deep gasp, [npc2.she] [npc2.verb(collapse)] to the floor, completely exhausted from the dominant treatment.");
...
//					&& (Main.sex.getCharacterPerformingAction().isPlayer() || !Main.sex.getCharacterPerformingAction().getFetishDesire(Fetish.FETISH_SADIST).isNegative());
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("As [npc.name] [npc.verb(feel)] [npc2.namePos] [npc2.pussy+] squeezing down around [npc.her] [npc.cock+], [npc.she] [npc.verb(decide)] to show [npc2.herHim] how").append(Main.sex.getCharacterPerformingAction().getRace() == Race.WOLF_MORPH || Main.sex.getCharacterPerformingAction().getRace() == Race.DOG_MORPH
                    ? " an alpha treats their submissive little beta."
                    : " a real dom treats their submissive bitch.").append(" Letting out [npc.a_moan+], [npc.name] [npc.verb(slam)] [npc.her] [npc.cock+] deep into [npc2.namePos] [npc2.pussy+], grinning devilishly as [npc2.she] [npc2.verb(let)] out [npc2.a_moan+].").append("<br/><br/>").append("Reaching down, [npc.she] then [npc.verb(grab)] [npc2.namePos] shoulders, before pushing [npc.her] weight down onto [npc2.her] back as [npc.she] roughly [npc.verb(mount)] [npc2.herHim].").append(" With [npc.namePos] weight now on top of [npc2.herHim], [npc2.name] [npc2.verb(collapse)] to the floor with [npc2.a_moan+].").append(" Bending down, and with [npc.her] throbbing [npc.cock] still hilted in [npc2.namePos] [npc2.pussy+], [npc.name] [npc.verb(growl)] menacingly in [npc2.her] [npc2.ear], ").append("[npc.speech(You little bitch! All you're good for is being my slutty cock-sleeve!)]").append("<br/><br/>").append("Upon hearing those degrading words, [npc2.Name] [npc2.verb(let)] out another [npc2.moan+], which is enough to send [npc.name] over the edge.").append(" As [npc.she] [npc.verb(grind)] [npc2.namePos] [npc2.face+] into the floor, [npc.she] [npc.verb(reach)] [npc.her] climax, and as [npc.her] [npc.balls+] tense up");
            ...
            UtilText.nodeContentSB.append("<br/><br/>" + "Panting heavily, [npc.name] suddenly [npc.verb(remember)] what [npc.she] had planned, and [npc.verb(shuffle)] around to where [npc2.namePos] face is still collapsed down against the floor.").append(Main.sex.getCharacterTargetedForSexAction(this).hasHair()
                    ? " Reaching down, [npc.she] roughly [npc.verb(grab)] a fistful of [npc2.namePos] [npc2.hair+],"
                    : " Reaching down, [npc.she] roughly [npc.verb(grab)] [npc2.namePos] neck,").append(" and before [npc2.she] [npc2.has] a chance to react, [npc.she] [npc.verb(shove)] [npc2.her] [npc2.face+] down onto [npc.her] [npc.cock+].").append(" [npc2.Name] [npc2.moansVerb] and [npc2.verb(squirm)] as ").append(Main.sex.getCharacterPerformingAction().isPlayer() ? "you" : "[npc2.her] dominant partner").append(" [npc.verb(give)] [npc2.herHim] a taste of [npc2.her] own [npc2.pussy],").append(" and, holding [npc2.herHim] tightly in position, [npc.she] [npc.moansVerb+] as [npc2.her] frantic [npc2.tongue] cleans [npc.herHim] off.").append("<br/><br/>").append("After a minute of using [npc2.name] in this manner, [npc.name] finally [npc.verb(release)] [npc2.herHim], and, with a deep gasp, [npc2.she] [npc2.verb(collapse)] to the floor, completely exhausted from the dominant treatment.");
