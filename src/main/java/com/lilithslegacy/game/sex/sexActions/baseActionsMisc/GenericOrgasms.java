...
import com.lilithslegacy.game.character.body.Torso;
import com.lilithslegacy.game.character.body.Wing;
...
import com.lilithslegacy.game.dialogue.places.dominion.lilayashome.LilayasRoom;
...
import com.lilithslegacy.game.sex.CondomFailure;
...
import com.lilithslegacy.game.sex.sexActions.baseActions.PenisAnus;
import com.lilithslegacy.game.sex.sexActions.baseActions.PenisMouth;
import com.lilithslegacy.game.sex.sexActions.baseActions.PenisVagina;
...
public class GenericOrgasms {
    ...
    public static final SexAction GENERIC_ORGASM_CREAMPIE = new SexAction(
        ...
        public boolean isBaseRequirementsMet() {
            ...
            return (Main.sex.getSexManager().getCharacterOrgasmBehaviour(Main.sex.getCharacterPerformingAction()) == OrgasmBehaviour.CREAMPIE
                    || Main.sex.getCharacterPerformingAction().isPlayer()
...
//			Main.sex.removeCharactersKnottedTogether(Main.sex.getCharacterPerformingAction()); // Remove as the generic orgasm description has already been parsed.
    ...
    public static final SexAction GENERIC_ORGASM_DOUBLE_CREAMPIE = new SexAction(
        ...
        public boolean isBaseRequirementsMet() {
                ...
                switch ((SexAreaOrifice) areaContacted) {
                    ...
                    case VAGINA:
                        if (!secondaryTarget.isOrificeTypeExposed((SexAreaOrifice) areaContacted)
                                || !areaContacted.isFree(secondaryTarget)) {
                            return false;
                        }
                        break;
                }
            ...
            // Cannot double creampie if someone is forcing creampie.
            return (Main.sex.getSexManager().getCharacterOrgasmBehaviour(Main.sex.getCharacterPerformingAction()) == OrgasmBehaviour.CREAMPIE
                    || Main.sex.getCharacterPerformingAction().isPlayer()
                    || Main.sex.getRequestedPulloutWeighting(Main.sex.getCharacterPerformingAction()) <= 0)
                    && Main.sex.getSexManager().getCharacterOrgasmBehaviour(Main.sex.getCharacterPerformingAction()) != OrgasmBehaviour.PULL_OUT
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                ...
                if (!isRealPenisFuckingCharacter(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this))) {
                    ...
                    boolean petName = !Main.sex.getCharacterPerformingAction().getPetName(Main.sex.getCharacterTargetedForSexAction(this)).equals(Main.sex.getCharacterTargetedForSexAction(this).getName(true));
                    ...
                    if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.VAGINA)) {
                        sb.append(" [npc.speech(Finish inside of me if you want").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");
                        ...
                        sb.append(" [npc.speech(Yes! Cum for me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");
                    }
                    ...
                    if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.VAGINA)) {
                        ...
                        sb.append(" [npc.speech(Fuck! Cum in me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I need your cum!)]");
                        ...
                        sb.append(" [npc.speech(Yes! Cum for me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Cover my tits with your cum!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaPenetration.FOOT)) {
                        sb.append(" [npc.speech(Fuck! Yes! Cum all over my [npc.feet]").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.MOUTH)) {
                        sb.append(" [npc.speech(Cum for me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to taste your cum!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.ARMPITS)) {
                        sb.append(" [npc.speech(Fuck! Yes! Cum all over my [npc.armpit]").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("!)]");

                    } else {
                        sb.append(" [npc.speech(Cum for me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Don't pull out!)]");
                    }
                }
            }
            ...
            if (!Main.sex.getCharacterTargetedForSexAction(this).isPlayer() && !Main.sex.isSpectator(Main.sex.getCharacterPerformingAction())) {
                if (Main.sex.getCharacterTargetedForSexAction(this).isSpeechMuffled()) {
                    ...
                    if (Main.sex.isCharacterObeyingTarget(Main.sex.getCharacterTargetedForSexAction(this), Main.sex.getCharacterPerformingAction())) {
                        sb.append("<br/><br/>").append(UtilText.returnStringAtRandom(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                ...
                if (Main.sex.getCharacterTargetedForSexAction(this).isWearingCondom()) {
                    ...
                    if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.VAGINA)) {
                        sb.append(" [npc.her] [npc.pussy+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside my pussy and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.ANUS)) {
                        sb.append(" [npc.her] [npc.asshole+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside my ass and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.NIPPLE)) {
                        sb.append(" [npc.her] [npc.nipple+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside my nipple and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.NIPPLE_CROTCH)) {
                        sb.append(" [npc.her] [npc.nippleCrotch+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.SPINNERET)) {
                        sb.append(" [npc.her] [npc.spinneret+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.URETHRA_PENIS)) {
                        sb.append(" [npc.her] [npc.urethraPenis+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me and fill up that condom!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.URETHRA_VAGINA)) {
                        sb.append(" [npc.her] [npc.urethraVagina+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me and fill up that condom!)]");

                    } else {
                        sb.append(" of [npc.herHim], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me and fill up that condom!)]");
                    }
                    ...
                    if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.VAGINA)) {
                        sb.append(" [npc.her] [npc.pussy+],").append(Main.sex.getCharacterPerformingAction().isVisiblyPregnant()
                        ...
                        sb.append(" [npc.her] [npc.asshole+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside my ass!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.NIPPLE)) {
                        sb.append(" [npc.her] [npc.nipple+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside my nipple!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.NIPPLE_CROTCH)) {
                        sb.append(" [npc.her] [npc.nippleCrotch+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.SPINNERET)) {
                        sb.append(" [npc.her] [npc.spinneret+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.URETHRA_PENIS)) {
                        sb.append(" [npc.her] [npc.urethraPenis+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me!)]");

                    } else if (isAreaFuckedByTarget(this, Main.sex.getCharacterPerformingAction(), SexAreaOrifice.URETHRA_VAGINA)) {
                        sb.append(" [npc.her] [npc.urethraVagina+], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me!)]");

                    } else {
                        sb.append(" of [npc.herHim], [npc.speech(Knot me").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside me!)]");
                    }
                }
            }
        ...
        public boolean isBaseRequirementsMet() {
            if (Main.sex.getCharacterPerformingAction().isPlayer()) {
                ...
                return isTakingCock(Main.sex.getCharacterPerformingAction(), Main.sex.getCharacterTargetedForSexAction(this))
                        ...
                        || ((!Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterPerformingAction(), SexAreaOrifice.MOUTH).contains(SexAreaPenetration.PENIS) || !Main.sex.getCharacterPerformingAction().getFetishDesire(Fetish.FETISH_CUM_ADDICT).isPositive())
                        && (!Main.sex.getAllOngoingSexAreas(Main.sex.getCharacterPerformingAction(), SexAreaOrifice.VAGINA).contains(SexAreaPenetration.PENIS) || !Main.sex.getCharacterPerformingAction().getFetishDesire(Fetish.FETISH_PREGNANCY).isPositive())));
            }
        }
...
//			}
        ...
        public String getDescription() {//TODO fetishes and player-specific descriptions
            ...
            if (Main.sex.getCharacterTargetedForSexAction(this).isSpeechMuffled()) {
                if (Objects.requireNonNull(Main.sex.getSexPace(Main.sex.getCharacterTargetedForSexAction(this))) == SexPace.SUB_RESISTING) {
    ...
    public static final SexAction GENERIC_PREPARATION_ENCOURAGE_CREAMPIE = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                ...
                if (!isRealPenisFuckingCharacter(getCharacterBeingFucked(), Main.sex.getCharacterTargetedForSexAction(this))) {
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.pussy+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHerHim).append("!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ANUS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.asshole+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" [npc3.ass]!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.nipple+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" [npc3.breasts]!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.spinneret+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" [npc3.spinneret]!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.breasts+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" tits!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.feet+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" [npc3.feet]!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.armpit+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHer).append(" pit!)]");

                    } else {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.name] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! That's right! Don't stop fucking ").append(targetHerHim).append("!)]");
                    }
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.pussy+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Finish inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ANUS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.asshole+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Finish inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.nipple+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Finish inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.spinneret+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Finish inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.breasts+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(That's it").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.feet+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(That's it").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.armpit+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(That's it").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");

                    } else {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.name] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(That's it").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Spurt it all out into that condom!)]");
                    }
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.pussy+] as [npc2.she] [npc2.verb(orgasm)],").append(getCharacterBeingFucked().isVisiblyPregnant()
                        ...
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.asshole+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Fuck! Cum in ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Fill ").append(targetHer).append(" ass with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.nipple+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Fuck! Cum in ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Fill ").append(targetHer).append(" nipple with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.spinneret+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Fuck! Cum in ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Fill ").append(targetHer).append(" spinneret with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.breasts+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! Cum for ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Cover ").append(targetHer).append(" tits with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.feet+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! Cum for ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Cover ").append(targetHer).append(" [npc3.feet] with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.armpit+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! Cum for ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Cover ").append(targetHer).append(" pit with your cum!)]");

                    } else {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.name] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Yes! Cum for ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Don't pull out!)]");
                    }
                }
            }
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                ...
                if (Main.sex.getCharacterTargetedForSexAction(this).isWearingCondom()) {
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.pussy+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ANUS).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.asshole+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.nipple+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE_CROTCH).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.nippleCrotch+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.spinneret+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.URETHRA_PENIS).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.urethraPenis+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.URETHRA_VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.urethraVagina+] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");

                    } else {
                        sb.append(" [npc3.name] and cum deep inside of [npc3.herHim], [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill up that condom!)]");
                    }
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.pussy+] and cum deep inside of [npc3.herHim],").append(getCharacterBeingFucked().isVisiblyPregnant()
                        ...
                        sb.append(" [npc3.namePos] [npc3.asshole+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and stuff ").append(targetHer).append(" ass with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.nipple+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and stuff ").append(targetHer).append(" nipple with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE_CROTCH).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.nippleCrotch+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and stuff ").append(targetHer).append(" nipple with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.spinneret+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and stuff ").append(targetHer).append(" spinneret with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.URETHRA_PENIS).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.urethraPenis+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill ").append(targetHer).append(" balls with your cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.URETHRA_VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append(" [npc3.namePos] [npc3.urethraVagina+] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and fill ").append(targetHer).append(" bladder with your cum!)]");

                    } else {
                        sb.append(" [npc3.name] and cum deep inside of [npc3.herHim]," + " [npc.speech(Knot ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Finish inside of ").append(targetHerHim).append(" and stuff ").append(targetHerHim).append(" with your cum!)]");
                    }
                }
            }
...
//		}
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                ...
                if (!isRealPenisFuckingCharacter(getCharacterBeingFucked(), Main.sex.getCharacterTargetedForSexAction(this))) {
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Pull out of ").append(targetHer).append(" pussy when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ANUS).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Pull out of ").append(targetHer).append(" ass when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Pull out of ").append(targetHer).append(" nipple when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Pull out of ").append(targetHer).append(" spinneret when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Get away from ").append(targetHer).append(" tits when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Get away from ").append(targetHer).append(" feet when you're going to cum!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Get away from ").append(targetHer).append(" pit when you're going to cum!)]");

                    } else {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(").append(targetSheHas).append(" had enough! Pull away from ").append(targetHerHim).append(" when you're going to cum!)]");
                    }
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to continue fucking [npc3.name] through [npc2.her] orgasm, [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(Pull out of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ANUS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.asshole+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull out of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.nipple+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull out of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.spinneret+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull out of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.breasts+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull back").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.feet+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull back").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.namePos] [npc3.armpit+] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull back").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");

                    } else {
                        sb.append("Knowing exactly what it is [npc.she] [npc.verb(want)], [npc.name] [npc.verb(cry)] out for [npc2.name] to keep pounding [npc3.name] as [npc2.she] [npc2.verb(orgasm)]," + " [npc.speech(Pull back").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! I want to see your condom inflating!)]");
                    }
                    ...
                    if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.VAGINA).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum inside of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop,").append(getCharacterBeingFucked().isVisiblyPregnant()
                        ...
                        sb.append("Not wanting [npc2.name] to cum inside of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull out of ").append(targetHer).append(" ass!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.NIPPLE).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum inside of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull out of ").append(targetHer).append(" nipple!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.SPINNERET).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum inside of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming inside of ").append(targetHerHim).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull out of ").append(targetHer).append(" spinneret!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.BREAST).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum all over of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming on ").append(targetHer).append(" tits").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull away from ").append(targetHerHim).append("!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaPenetration.FOOT).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum all over of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming on ").append(targetHer).append(" [npc3.feet]").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull away from ").append(targetHerHim).append("!)]");

                    } else if (Main.sex.getOngoingCharactersUsingAreas(Main.sex.getCharacterTargetedForSexAction(this), SexAreaPenetration.PENIS, SexAreaOrifice.ARMPITS).contains(getCharacterBeingFucked())) {
                        sb.append("Not wanting [npc2.name] to cum all over of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming on ").append(targetHer).append(" pit").append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull away from ").append(targetHerHim).append("!)]");

                    } else {
                        sb.append("Not wanting [npc2.name] to cum all over of [npc3.name], [npc.name] [npc.verb(cry)] out for [npc2.herHim] to stop," + " [npc.speech(I don't want you cumming on ").append(targetHer).append(petName ? ", [#npc.getPetName(npc2)]" : "").append("! Pull away from ").append(targetHerHim).append("!)]");
                    }
                }
            }
    ...
    public static final SexAction GENERIC_ORGASM_DENIED = new SexAction(
        ...
        public String getDescription() {//TODO improve and take into account fetishes
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                if (Objects.requireNonNull(Main.sex.getSexPace(Main.sex.getCharacterPerformingAction())) == SexPace.SUB_RESISTING) {
    ...
    private static final StringBuilder genericOrgasmSB = new StringBuilder();
    ...
    public static boolean isCumTargetRequirementsMet(OrgasmCumTarget cumTarget) {
        ...
        return Main.sex.getAvailableCumTargets(Main.sex.getCharacterPerformingAction()).contains(cumTarget)
                        ...
                        case SPINNERET:
                            ...
                            if (characterOrgasming.hasPenisModifier(PenetrationModifier.KNOTTED)) {
                                if (cumTarget == OrgasmCumTarget.INSIDE_SWITCH_DOUBLE) {
                                    if (!isSecondaryCreampieTarget) {
                                        ...
                                        if (!Main.game.isPenetrationLimitationsEnabled() || characterOrgasming.isFullPenetrationTooShort(SexAreaPenetration.PENIS, characterTargeted, (SexAreaOrifice) contactingArea)) {
                                            genericOrgasmSB.append(" Pushing forwards, [npc.name] [npc.verb(hilt)] [npc.her] [npc.cock+] fully inside of [npc2.namePos] ").append(orificeNamePlusDescriptor).append(".");
                                            if (Objects.equals(Main.sex.getCharacterKnotting(characterOrgasming), secondaryTarget)) {
                                                genericOrgasmSB.append(" Wanting to save [npc.her] rapidly-swelling knot for ").append(UtilText.parse(characterOrgasming, secondaryTarget, "[npc2.namePos] " + orificeNamePlusDescriptor)).append(",").append(" [npc.she] [npc.verb(hold)] back from pushing it inside of [npc2.name], and [npc.verb(make)] do with just grinding it against [npc2.her] ").append(orificeName).append(".");
                                            } else {
                                                genericOrgasmSB.append(" Not wanting to get locked inside of [npc2.herHim], [npc.she] [npc.verb(hold)] back from pushing [npc.her] rapidly-swelling knot inside of [npc2.namePos] ").append(orificeName).append(".");
                                            }

                                        } else if (characterOrgasming.isWantingToFullyPenetrate(characterTargeted)) {
                                            genericOrgasmSB.append(" Pushing forwards, [npc.name] [npc.verb(feel)] [npc.her] [npc.cock+] bottoming out in [npc2.namePos] ").append(orificeNamePlusDescriptor).append(".");
                                            if (Objects.equals(Main.sex.getCharacterKnotting(characterOrgasming), secondaryTarget)) {
                                                genericOrgasmSB.append(" Desperate to sink [npc.her] rapidly-swelling knot into something, [npc.name] [npc.verb(look)] over at ").append(UtilText.parse(characterOrgasming, secondaryTarget, "[npc2.namePos] " + orificeNamePlusDescriptor)).append(" and [npc.verb(let)] out an excited [npc.moan].");
                                            } else {
                                                genericOrgasmSB.append(" [npc.She] [npc.verb(let)] out a disappointed [npc.moan] as [npc.she] [npc.verb(realise)] that [npc.her] rapidly-swelling knot isn't going to fit inside of [npc2.namePos] ").append(orificeName).append(".");
                                            }

                                        } else {
                                            genericOrgasmSB.append(" Not wanting to cause [npc2.her] any discomfort, [npc.name] [npc.verb(hold)] back from fully hilting [npc.her] [npc.cock] in [npc2.namePos] ").append(orificeNamePlusDescriptor).append(".");
                                        }

                                    } else {
                                        if (Objects.equals(Main.sex.getCharacterKnotting(characterOrgasming), characterTargeted)) {
                                            genericOrgasmSB.append(" Pushing forwards, [npc.name] [npc.verb(ram)] the now-fully swollen knot at the base of [npc.her] [npc.cock+] against [npc2.namePos] ").append(orificeNamePlusDescriptor).append(".").append(" By now it's so engorged that it seems almost impossible to push it inside, but with a determined [npc.moan], [npc.name] violently [npc.verb(thrust)] forwards,").append(" and with an accompanying cry from [npc2.name], [npc.she] [npc.verb(manage)] to force [npc.her] fat knot into [npc2.her] ").append(orificeNamePlusDescriptor).append(".");
                                        } else {
                                            genericOrgasmSB.append(" Not wanting to get locked inside of [npc2.herHim], [npc.she] [npc.verb(hold)] back from pushing [npc.her] rapidly-swelling knot inside of [npc2.namePos] ").append(orificeName).append(".");
                                        }
                                    }
                                    ...
                                    if (Objects.equals(Main.sex.getCharacterKnotting(characterOrgasming), characterTargeted)) {
                                        genericOrgasmSB.append(" Pushing forwards, [npc.name] [npc.verb(ram)] the knot at the base of [npc.her] [npc.cock+] against [npc2.namePos] ").append(orificeNamePlusDescriptor).append(".").append(" It's already started to swell up so much that [npc.she] [npc.do]n't manage to get it inside on the first thrust,").append(" but after pulling back and slamming [npc.her] [npc.hips] forwards, [npc.she] [npc.verb(manage)] to push the thick knot into [npc2.her] ").append(orificeNamePlusDescriptor).append(".");
                                    } else {
                                        genericOrgasmSB.append(" Not wanting to get locked inside of [npc2.herHim], [npc.she] [npc.verb(hold)] back from pushing [npc.her] rapidly-swelling knot inside of [npc2.namePos] ").append(orificeName).append(".");
                                    }
                                }
                                ...
                                if (cumTarget == OrgasmCumTarget.INSIDE_SWITCH_DOUBLE && isSecondaryCreampieTarget) {
                                    genericOrgasmSB.append(" Thrusting [npc.her] [npc.cock+] into [npc2.namePos] ").append(orificeNamePlusDescriptor).append(",").append(" [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.she] [npc.verb(prepare)] to finish orgasming inside of [npc2.herHim].");
                                } else {
                                    genericOrgasmSB.append(" Ramming [npc.her] [npc.cock+] deep into [npc2.namePos] ").append(orificeNamePlusDescriptor).append(", [npc.name] [npc.verb(let)] out [npc.a_moan+] as it starts to twitch inside of [npc2.herHim].");
                                }
                            }
                            ...
                            if (characterOrgasming.hasPenisModifier(PenetrationModifier.KNOTTED)) {
                                if (cumTarget != OrgasmCumTarget.INSIDE_SWITCH_DOUBLE || isSecondaryCreampieTarget) {
                                    if (Objects.equals(Main.sex.getCharacterKnotting(characterOrgasming), characterTargeted)) {
                                        genericOrgasmSB.append(" Keeping [npc.her] [npc.hips] pushed tightly against [npc2.namePos] ").append(orificeName).append(", [npc.name] [npc.verb(let)] out [npc.a_moan+] as [npc.her] knot swells up to its full size.").append(" [npc.She] then [npc.verb(buck)] back a little, and [npc2.name] [npc2.verb(let)] out a startled cry as [npc2.sheIs] pulled along with [npc.herHim];").append(" evidence that [npc.her] [npc.cock] is now firmly locked inside [npc2.her] ").append(orificeNamePlusDescriptor).append(".");
                                    }
                                }
                            }
                            break;
...
//		}
        ...
        switch (targetArea) {
            case ARMPITS:
                ...
                if (!targetAreaClothingCummedOn.isEmpty()) {
                    ...
                    String sb = " all over [npc2.namePos] [npc2.armpit+]."
                    ...
                    return UtilText.parse(characterOrgasming, target, sb);
                }
            case ASS:
                target = Main.sex.getTargetedPartner(characterOrgasming);
                if (!targetAreaClothingCummedOn.isEmpty()) {
        ...
        if (!areasConteacted.isEmpty()) { // Do an empty check as when using a condom, ongoing actions are stopped (Sex.java#2721), then after that the sex action override is checked, which triggers this method again
            ...
            if (areaContacted.isOrifice()) {
                switch ((SexAreaOrifice) areaContacted) {
                    ...
                    case ANUS:
                        ...
                        switch (characterOrgasming.getPenisOrgasmCumQuantity()) {
                            case SIX_EXTREME:
                            case SEVEN_MONSTROUS:
                                cumTargetSB.append(" After a few seconds, [npc2.name] [npc2.verb(realise)] that [npc.nameIs] not even close to stopping, and as [npc.her]" + " [npc.cum+] backs up and starts drooling out of [npc2.her] [npc2.asshole], [npc2.she] [npc2.verb(let)] out [npc2.a_moan+].").append(targetArea != OrgasmCumTarget.INSIDE_SWITCH_DOUBLE || isSecondaryCreampieTarget
                    ...
                    case MOUTH:
                        if (target.isPlayer()) {
                            ...
                            if (target.hasFetish(Fetish.FETISH_CUM_ADDICT) || Main.sex.getCharactersRequestingCreampie().contains(target) || Main.sex.getCharactersRequestingKnot().contains(target)) {
                                cumTargetSB.append(" ").append(UtilText.returnStringAtRandom("greedily", "hungrily"));
                            } else {
                    ...
                    case VAGINA:
                        ...
                        switch (characterOrgasming.getPenisOrgasmCumQuantity()) {
                            case SIX_EXTREME:
                            case SEVEN_MONSTROUS:
                                cumTargetSB.append(" After a few seconds, [npc2.name] [npc2.verb(realise)] that [npc.nameIs] not even close to stopping, and as [npc.her]" + " [npc.cum+] backs up and starts drooling out of [npc2.her] [npc2.pussy], [npc2.she] [npc2.verb(let)] out [npc2.a_moan+].").append(targetArea != OrgasmCumTarget.INSIDE_SWITCH_DOUBLE || isSecondaryCreampieTarget
                ...
                switch (target.getBodyMaterial()) {
                    ...
                    case WATER:
                    case SLIME:
                        cumTargetSB.append("<br/>" + "As [npc2.namePos] body is made completely out of translucent ").append(target.getBodyMaterial().getName()).append(",").append(" you're able to see the cloud of [npc.namePos] [npc.cum+] shooting up and dispersing inside of [npc2.herHim].");
                        break;
                    case FIRE:
                    case FLESH:
                    case ICE:
    ...
    private static String getGenericVaginaOrgasmDescription(SexActionInterface sexAction, GameCharacter characterOrgasming, OrgasmCumTarget targetArea) {
        ...
        if (!Main.sex.getCharacterOngoingSexArea(characterOrgasming, SexAreaOrifice.VAGINA).isEmpty()) {
        ...
        if (characterPenetrating != null && penetration != null) {
            ...
            for (AbstractClothing c : characterOrgasming.getClothingCurrentlyEquipped()) {
                if (c.getItemTags().contains(ItemTag.PLUGS_VAGINA)) {
                    pluggedVagina = true;
                    genericOrgasmSB.append(" [npc.NamePos] [npc.pussy+] clenches down hard," + " causing [npc.herHim] to let out a series of high-pitched moans as [npc.her] vaginal muscles grip and squeeze around the ").append(c.getName()).append(" inserted into [npc.her] [npc.pussy].");
                    break;
                }
            }
            if (!pluggedVagina) {
        ...
        if (characterOrgasming.isVaginaSquirter()) {
            ...
            genericOrgasmSB.append("<br/>As [npc.namePos] [npc.pussy+] uncontrollably spasms and quivers with delight, it suddenly squirts out a huge amount of hot, ").append(Util.randomItemFrom(ejaculateDescriptors)).append(" female ejaculate");
            ...
            if (targetArea == OrgasmCumTarget.LILAYA_PANTIES) {
                ...
                if (vaginaClothing != null) {
                    if (!vaginaClothing.getItemTags().contains(ItemTag.PLUGS_VAGINA)
                        ...
                        genericOrgasmSB.append(" [npc.She] [npc.verb(let)] out a deep sigh as [npc.she] [npc.verb(feel)] [npc.her] ").append(vaginaClothing.getName()).append(" ").append(vaginaClothing.getClothingType().isPlural() ? "are" : "is").append(" quickly getting dirtied by [npc.her] fluids.");

                    } else {
                        genericOrgasmSB.append(" As [npc.her] ").append(vaginaClothing.getName()).append(" ").append(vaginaClothing.getClothingType().isPlural() ? "are" : "is").append(" sealing [npc.her] [npc.pussy], nothing gets dirtied by [npc.her] fluids.");
                    }
...
//		}
    ...
    public static String getGenericOrgasmDescription(SexActionInterface sexAction, GameCharacter characterOrgasming, OrgasmCumTarget target) {
        ...
        descriptionSB.append("<p>").append(getPositionPreparation(characterOrgasming, characterPenetrated != null ? characterPenetrated : Main.sex.getTargetedPartner(characterOrgasming))).append("</p>");
        ...
        if (characterOrgasming.hasPenisIgnoreDildo()) {
            descriptionSB.append("<p>").append(getGenericPenisOrgasmDescription(sexAction, characterOrgasming, characterPenetrated, target, sexAction.getCondomFailure(characterOrgasming, characterPenetrated), false)).append("</p>");
            ...
            if (target == OrgasmCumTarget.INSIDE_SWITCH_DOUBLE) {
                ...
                descriptionSB.append("<p>").append(getGenericPenisOrgasmDescription(sexAction, characterOrgasming, secondaryTarget, target, sexAction.getCondomFailure(characterOrgasming, characterPenetrated), true)).append("</p>");
            }
        }
...
//		}
        ...
        if (characterOrgasming.hasVagina()) {
            descriptionSB.append("<p>").append(getGenericVaginaOrgasmDescription(sexAction, characterOrgasming, target)).append("</p>");
        }

        if (!characterOrgasming.hasPenisIgnoreDildo() && !characterOrgasming.hasVagina()) {
            descriptionSB.append("<p>").append(getGenericMoundOrgasm(characterOrgasming)).append("</p>");
        }
...
//				System.out.println(entry.getKey().getName(true)+" free");
    ...
    private static boolean isSpecialCreampieLockConditionMet(SexAction sexAction, GameCharacter characterProvidingCreampie, GameCharacter characterReceivingCreampie, SexAreaInterface areaFucked) {
        ...
        if (areaFucked == SexAreaOrifice.VAGINA) {
            return characterReceivingCreampie.isPlayer() || !characterReceivingCreampie.getFetishDesire(Fetish.FETISH_PREGNANCY).isNegative();
        }
        return true;
    }
