    ...
    public static final SexAction PLAYER_OFFER_VAGINAL = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply making a suggestive move with [npc.her] [npc.hips] in order to entice [npc2.name] into using [npc.her] [npc.pussy+].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, use my pussy!)]",
                        "[npc.speech(Use my little pussy, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.VAGINA))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.VAGINA)));
    ...
    public static final SexAction PLAYER_REQUEST_VAGINAL = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply moving closer to [npc2.namePos] [npc2.pussy+] as [npc.she] [npc.verb(try)] to indicate that that's what [npc.she] [npc.verb(want)].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, I want to use your pussy!)]",
                        "[npc.speech(I want to use your pussy, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, SexAreaOrifice.VAGINA, null))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, SexAreaOrifice.VAGINA, null)));
    ...
    public static final SexAction PLAYER_OFFER_ANAL = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply making a suggestive backwards move with [npc.her] [npc.hips] in order to entice [npc2.name] into using [npc.her] [npc.ass+].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, use my ass!)]",
                        "[npc.speech(Use my ass, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.ANUS))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.ANUS)));
    ...
    public static final SexAction PLAYER_REQUEST_ANAL = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply moving closer to [npc2.namePos] [npc2.ass+] as [npc.she] [npc.verb(try)] to indicate that that's what [npc.she] [npc.verb(want)].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, I want to use your ass!)]",
                        "[npc.speech(I want to use your asshole, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, SexAreaOrifice.ANUS, null))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, SexAreaOrifice.ANUS, null)));
    ...
    public static final SexAction PLAYER_OFFER_ORAL = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                    ...
                    "[npc.speech(Use my mouth, please!)]")).append("<br/><br/>");
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.MOUTH))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply moving closer to [npc2.namePos] [npc2.face] as [npc.she] [npc.verb(try)] to indicate that [npc.sheIs] [npc.verb(want)] to use [npc2.her] mouth.")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, I want you to use your mouth!)]",
                        "[npc.speech(Use your mouth, please!)]")).append("<br/><br/>");
            }
    ...
    public static final SexAction PLAYER_OFFER_NIPPLE = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply making a suggestive move with [npc.her] [npc.chest] in order to entice [npc2.name] into using [npc.her] [npc.nipples+].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, fuck my nipples!)]",
                        "[npc.speech(Fuck my nipples, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.NIPPLE))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.NIPPLE)));
    ...
    public static final SexAction PLAYER_OFFER_PAIZURI = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply making a suggestive move with [npc.her] [npc.chest] in order to entice [npc2.name] into using [npc.her] [npc.breasts+].")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, fuck my tits!)]",
                        "[npc.speech(Fuck my breasts, please!)]")).append("<br/><br/>");
            }
        ...
        public void applyEffects() {
            if (!((NPC) Main.sex.getCharacterTargetedForSexAction(this)).getSexBehaviourDeniesRequests(Main.game.getPlayer(), new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.BREAST))) {
                Main.sex.getCharacterTargetedForSexAction(this).generateSexChoices(true, Main.game.getPlayer(), Util.newArrayListOfValues(new SexType(SexParticipantType.NORMAL, null, SexAreaOrifice.BREAST)));
        ...
        public String getDescription() {
            ...
            if (Main.sex.getCharacterPerformingAction().isSpeechMuffled()) {
                UtilText.nodeContentSB.append(UtilText.returnStringAtRandom(
                        ...
                        "With [npc.her] mouth being blocked, [npc.name] [npc.verb(fall)] back on simply making a suggestive move with [npc.her] [npc.chest] in order to entice [npc2.name] into using it.")).append("<br/><br/>");
            } else {
                UtilText.nodeContentSB.append("Putting on the most pleading expression you can muster, you cry out to [npc2.name], ").append(UtilText.returnStringAtRandom(
                        "[npc.speech(Please, grind your cock up against my chest!)]",
                        "[npc.speech(Grind on my chest, please!)]")).append("<br/><br/>");
            }
