...
public class SABraxSubCowgirl {
        ...
        public String getDescription() {
            if (Main.game.getPlayer().hasStatusEffect(StatusEffect.CREAMPIE_VAGINA)) {
                ...
                if (Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.ANUS).contains(SexAreaPenetration.TONGUE)) {
                    UtilText.nodeContentSB.append("Deciding that you've had enough of Brax's tongue in your [pc.asshole+], you lift yourself up and shuffle backwards until your ").append(Main.game.getPlayer().getVaginaName(true)).append(" is positioned over his face.");
                ...
                UtilText.nodeContentSB.append(" You feel a big dollop of slimy cum drip out of your ").append(Main.game.getPlayer().getVaginaName(true)).append(", and you let out a giggle as you squash the slimy creampie down onto Brax's wolf-like muzzle.").append(" You hold the squirming wolf-boy's head still as you press your cum-filled cunt down over his mouth, giving him no choice but to start cleaning you out.").append(" After a moment, Brax stops squirming as he realises that it's useless to resist, and you let out a contented sigh as he starts licking out the cum from your creampied ").append(Main.game.getPlayer().getVaginaName(false)).append(".");
        ...
        public String getDescription() {
            if (Main.game.getPlayer().hasStatusEffect(StatusEffect.CREAMPIE_ANUS)) {
                ...
                if (Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.VAGINA).contains(SexAreaPenetration.TONGUE)) {
                    UtilText.nodeContentSB.append("Deciding that you've had enough of Brax's tongue in your ").append(Main.game.getPlayer().getVaginaName(true)).append(", you lift yourself up and shuffle forwards until your [pc.asshole+] is positioned over his face.");
                ...
                UtilText.nodeContentSB.append(" You feel a big dollop of slimy cum drip out of your [pc.asshole+], and you let out a giggle as you squash the slimy creampie down onto Brax's wolf-like muzzle."
    ...
    public static final SexAction PLAYER_COWGIRL_PENETRATE_PUSSY = new SexAction(
        ...
        public String getDescription() {
            ...
            UtilText.nodeContentSB.append("Reaching down and taking hold of the [npc.penis+] beneath you, you shuffle around until it's lined up to your ").append(Main.game.getPlayer().getVaginaName(true)).append(".").append(" Not wasting another moment, you quickly sink down, feeling the tapered end of Brax's [npc.penis+] easily slide into you.").append(" With a desperate wail, you sink down, stuffing more and more of the readily widening shaft into your ").append(Main.game.getPlayer().getVaginaName(true)).append(", until at last, with a quiver of delight, you feel the swollen knot at the base bump against your pussy lips.");
    ...
    public static final SexAction PLAYER_COWGIRL_PENETRATE_ASS = new SexAction(
        ...
        public String getDescription() {
            ...
            if (!Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.VAGINA).isEmpty())
                UtilText.nodeContentSB.append("You lift yourself up, letting Brax's pointed dog-cock slip out of your ").append(Main.game.getPlayer().getVaginaName(true)).append(". ");
        ...
        public String getDescription() {
            ...
            if (Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.NIPPLES)) {
                ...
                return UtilText.returnStringAtRandom(
                        ...
                        "Guiding Brax's paw-like hands up to your chest, you let out a lewd moan as you feel his fingers trying to pinch down and squeeze at your " + Main.game.getPlayer().getNippleName(true) + " through your " + Main.game.getPlayer().getHighestZLayerCoverableArea(CoverableArea.NIPPLES).getName() + ".",
        ...
        public String getDescription() {
            ...
            if (Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.NIPPLES)) {
                ...
                return UtilText.returnStringAtRandom(
                        ...
                        "Brax suggestively reaches his paw-like hands up to your exposed chest, and, deciding not to stop him,"
                                + " you let out a lewd moan as you feel his fingers trying to pinch down and squeeze at your " + Main.game.getPlayer().getNippleName(true) + " through your " + Main.game.getPlayer().getHighestZLayerCoverableArea(CoverableArea.NIPPLES).getName() + ".",
        ...
        public String getDescription() {
            ...
            if (Main.game.getPlayer().hasPenis()) {
                ...
                if (Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)) {
                    UtilText.nodeContentSB.append(" Reaching down, you grab your ").append(Main.game.getPlayer().getPenisName(true)).append(", before starting to furiously masturbate as you rock gently back and forth on Brax's furry stomach.").append(" Letting out a desperate groan, you feel your cock twitching as your orgasm washes over you");

                } else {
                    UtilText.nodeContentSB.append(" Rocking gently back and forth on Brax's furry stomach, you reach down and start rubbing at your ").append(Main.game.getPlayer().getPenisName(true)).append(" through your ").append(Main.game.getPlayer().getHighestZLayerCoverableArea(CoverableArea.PENIS).getName()).append(".").append(" Letting out a desperate groan, you feel your cock twitching as your orgasm washes over you");
                }
                ...
                switch (Main.game.getPlayer().getPenisOrgasmCumQuantity()) {
                    case ZERO_NONE:
                        ...
                        break;
                    case ONE_TRICKLE:
                        UtilText.nodeContentSB.append(", and a small trickle of cum squirts").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                    ...
                    case TWO_SMALL_AMOUNT:
                        UtilText.nodeContentSB.append(", and a small amount of cum squirts").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                                ? " out onto Brax's muscular chest."
                                : " out shamefully into your " + Main.game.getPlayer().getLowestZLayerCoverableArea(CoverableArea.PENIS).getName() + ".");
                        break;
                    case THREE_AVERAGE:
                        UtilText.nodeContentSB.append(", and your cum shoots").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                                ? " out onto Brax's muscular chest."
                                : " out shamefully into your " + Main.game.getPlayer().getLowestZLayerCoverableArea(CoverableArea.PENIS).getName() + ".");
                        break;
                    case FOUR_LARGE:
                        ...
                        break;
                    case FIVE_HUGE:
                        UtilText.nodeContentSB.append(", and your large load of cum pours").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                                ? " out onto Brax's muscular chest."
                                : " out shamefully into your " + Main.game.getPlayer().getLowestZLayerCoverableArea(CoverableArea.PENIS).getName() + ".");
                        break;
                    case SIX_EXTREME:
                        UtilText.nodeContentSB.append(", and your huge load of cum pours").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                                ? " out onto Brax's muscular chest."
                                : " out shamefully into your " + Main.game.getPlayer().getLowestZLayerCoverableArea(CoverableArea.PENIS).getName() + ".");
                        break;
                    case SEVEN_MONSTROUS:
                        UtilText.nodeContentSB.append(", and your enormous load of cum pours").append(Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)
                                ? " out onto Brax's muscular chest."
                                : " out shamefully into your " + Main.game.getPlayer().getLowestZLayerCoverableArea(CoverableArea.PENIS).getName() + ".");
                        break;
                    default:
    ...
    public static final SexAction PLAYER_COWGIRL_ORGASM_FACESITTING = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.ANUS).contains(SexAreaPenetration.TONGUE))
                ...
                UtilText.nodeContentSB.append("As you feel Brax's tongue lapping away at your ").append(Main.game.getPlayer().getVaginaName(true)).append(", you realise that you're starting to climax, and with a desperate moan, you brace for your orgasm. ");

            // Penis:
            if (Main.game.getPlayer().hasPenis()) {

                if (Main.game.getPlayer().isCoverableAreaExposed(CoverableArea.PENIS)) {
                    UtilText.nodeContentSB.append(" Reaching down, you grab your ").append(Main.game.getPlayer().getPenisName(true)).append(", furiously masturbating as you grind down on Brax's wolf-like muzzle.").append(" Letting out a desperate groan, you feel your ").append(Main.game.getPlayer().getPenisName(true)).append(" twitching as your orgasm washes over you");

                } else {
                    UtilText.nodeContentSB.append(" Grinding down on Brax's wolf-like muzzle, you reach down and start rubbing at your ").append(Main.game.getPlayer().getPenisName(true)).append(" through your ").append(Main.game.getPlayer().getHighestZLayerCoverableArea(CoverableArea.PENIS).getName()).append(".").append(" Letting out a desperate groan, you feel your ").append(Main.game.getPlayer().getPenisName(true)).append(" twitching as your orgasm washes over you");
                }
    ...
    public static final SexAction PLAYER_COWGIRL_ORGASM_RIDING_COCK = new SexAction(
        ...
        public String getDescription() {
            ...
            if (Main.sex.getAllOngoingSexAreas(Main.game.getPlayer(), SexAreaOrifice.ANUS).contains(SexAreaPenetration.PENIS))
                ...
                UtilText.nodeContentSB.append("As you feel yourself reaching your climax, you increase the speed at which you're bouncing up and down on Brax's [npc.penis+]." + " Letting out a desperate moan, your mind is overwhelmed by the feeling in your ").append(Main.game.getPlayer().getVaginaName(true)).append(", and you brace for your orgasm. ");
