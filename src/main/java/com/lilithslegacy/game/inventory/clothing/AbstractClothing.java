    ...
    public boolean isSealed() {
        ...
        for (ItemEffect effect : this.getEffects()) {
            if (effect != null && effect.getSecondaryModifier() == TFModifier.CLOTHING_SEALING) {
                ...
                String message = "AbstractClothing.isSealed() for " + this.getName() + " is encountering a null ItemEffect!";
    ...
    public TFPotency getVibratorIntensity() {
        for (ItemEffect effect : this.getEffects()) {
            if (effect != null && effect.getSecondaryModifier() == TFModifier.CLOTHING_VIBRATION) {
                ...
                String message = "AbstractClothing.getVibratorIntensity() for " + this.getName() + " is encountering a null ItemEffect!";
                System.getLogger("").log(System.Logger.Level.ERROR, message);
            }
        }
        return null;
