...
//			tape asshole
    ...
    public static final AbstractClothingType TORSO_SLEEVELESS_TURTLENECK = new AbstractClothingType(350,
            "a",
            false,
    ...
    public static final AbstractClothingType TORSO_KEYHOLE_CROPTOP = new AbstractClothingType(120,
            "a",
            false,
            "keyhole crop top",
            "keyhole crop tops",
    ...
    public static final AbstractClothingType TORSO_SHORT_CROPTOP = new AbstractClothingType(100,
            "a",
            false,
            "short croptop",
            "short croptops",
    ...
    public static final AbstractClothingType TORSO_FISHNET_TOP = new AbstractClothingType(100,
            "a",
            false,
            "fishnet top",
            "fishnet tops",
    ...
    public static final AbstractClothingType TORSO_CAMITOP_STRAPS = new AbstractClothingType(200,
            "a",
            false,
            "cami top",
            "cami tops",
    ...
    public static final AbstractClothingType TORSO_SKATER_DRESS = new AbstractClothingType(250,
            "a",
            false,
            "skater dress",
            "skater dresses",
    ...
    public static final AbstractClothingType TORSO_CORSET_DRESS = new AbstractClothingType(1250,
            "a",
            false,
            "corset dress",
            "corset dresses",
    ...
    public static final AbstractClothingType TORSO_VIRGIN_KILLER_SWEATER = new AbstractClothingType(100,
            "a",
            false,
    ...
    public static final AbstractClothingType TORSO_SLIP_DRESS = new AbstractClothingType(800,
            "a",
            false,
            "slip dress",
            "slip dresses",
    ...
    public static final AbstractClothingType TORSO_PLUNGE_DRESS = new AbstractClothingType(600,
            "a",
            false,
            "plunge dress",
            "plunge dresses",
    ...
    public static final AbstractClothingType TORSO_LONG_SLEEVE_DRESS = new AbstractClothingType(400,
            "a",
            false,
            "long-sleeved dress",
    ...
    public static final AbstractClothingType TORSO_BODYCONZIP_DRESS = new AbstractClothingType(350,
            "a",
            false,
            "frontal-zip dress",
            "frontal-zip dresses",
    ...
    public static final AbstractClothingType WRIST_WOMENS_WATCH = new AbstractClothingType(1000,
            "a",
            false,
            "feminine watch",
            "feminine watches",
    ...
    public static final AbstractClothingType WRIST_MENS_WATCH = new AbstractClothingType(1200,
            "a",
            false,
            "masculine watch",
            "masculine watches",
    ...
    public static final AbstractClothingType WRIST_BANGLE = new AbstractClothingType(600,
            "a",
            false,
            "bangle",
            "bangles",
    ...
    public static final AbstractClothingType WRIST_SUIT_CUFFS = new AbstractClothingType(100,
            "a pair of",
            true,
            "suit cuff",
            "suit cuffs",
    ...
    public static final AbstractClothingType WRIST_WRISTBANDS = new AbstractClothingType(100,
            "a pair of",
            true,
            "wristband",
            "wristbands",
    ...
    public static final AbstractClothingType HIPS_CONDOMS = new AbstractClothingType(20,
            "a",
            false,
            "condom belt",
            "condom belts",
    ...
    public static final AbstractClothingType HIPS_SUSPENDER_BELT = new AbstractClothingType(150,
            "a",
            false,
            "suspender belt",
            "suspender belts",
...
//	};
    ...
    public static final AbstractClothingType ENFORCER_SHIRT = new AbstractClothingType(1500,
            "a",
            false,
    ...
    public static final AbstractClothingType ENFORCER_MINI_SKIRT = new AbstractClothingType(600,
            "a",
            false,
    ...
    public static final AbstractClothingType MEGA_MILK = new AbstractClothingType(400,
            "a",
            false,
            "Mega Milk T-shirt",
            "Mega Milk T-shirts",
    ...
    public static final AbstractClothingType JOLNIR_HAT = new AbstractClothingType(400,
            "a",
            false,
            "J&oacute;lnir's hat",
    ...
    public static final AbstractClothingType JOLNIR_COAT = new AbstractClothingType(750,
            "a",
            false,
    ...
    public static final AbstractClothingType JOLNIR_DRESS = new AbstractClothingType(900,
            "a",
            false,
    ...
    public static final AbstractClothingType JOLNIR_BOOTS = new AbstractClothingType(500,
            "a pair of",
            true,
    ...
    public static final AbstractClothingType JOLNIR_BOOTS_FEMININE = new AbstractClothingType(750,
            "a pair of",
            true,
    ...
    public static final AbstractClothingType FINGER_LYSSIETHS_RING = new AbstractClothingType(50000,
            "",
            false,
...
//		System.out.print("ID: "+id);
        ...
        if (slotHint != null && !slotHint.isEmpty()) {
            try {
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "Warning: getClothingTypeFromId() invalid slot hint: "
...
//		System.out.println("  set to: "+id);
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/items/clothing");
            ...
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    if (ct.getRarity() == Rarity.COMMON && !ct.getDefaultItemTags().contains(ItemTag.NO_RANDOM_SPAWN)) {
                        ...
                        XMLLoadException ex) { // we want to catch any errors here; we shouldn't want to load any mods that are invalid as that may cause severe bugs
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded clothing failed at 'ClothingType'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/clothing");
        for (Entry<String, Map<String, Path>> entry : filesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading clothing failed at 'ClothingType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
