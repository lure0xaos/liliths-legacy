...
public class BlockedParts implements XMLSaving {
    ...
    public final DisplacementType displacementType;
    ...
    public static BlockedParts loadFromXML(Element parentElement, Document doc, String contextForErrors) {
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "BlockedParts loading failed for " + errorCode + ". Code 1 (clothingAccessRequired -> clothingAccess); Context: " + contextForErrors);
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "BlockedParts loading failed for " + errorCode + ". Code 2 (blockedBodyParts -> bodyPart); Context: " + contextForErrors);
            System.getLogger("").log(System.Logger.Level.ERROR, ex);
            printHelpfulErrorForEnumValueMismatches(ex, getPossibleEnumValues());
        }
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "BlockedParts loading failed for " + errorCode + ". Code 3 (clothingAccessBlocked -> clothingAccess); Context: " + contextForErrors);
            System.getLogger("").log(System.Logger.Level.ERROR, ex);
            printHelpfulErrorForEnumValueMismatches(ex, getPossibleEnumValues());
        }
        ...
        if (!concealedSlotsElement.getAttribute("values").isEmpty()) {
            try {
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "BlockedParts loading failed for " + errorCode + ". Code 4a (concealedSlots.values); Context: " + contextForErrors);
                System.getLogger("").log(System.Logger.Level.ERROR, ex);
                printHelpfulErrorForEnumValueMismatches(ex, getPossibleEnumValues());
            }
        } else {
            try {
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "BlockedParts loading failed for " + errorCode + ". Code 4b (concealedSlots -> slot); Context: " + contextForErrors);
                System.getLogger("").log(System.Logger.Level.ERROR, ex);
                printHelpfulErrorForEnumValueMismatches(ex, getPossibleEnumValues());
            }
        }
