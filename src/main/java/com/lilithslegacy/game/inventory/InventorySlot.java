...
//	HIPS_UNDER(20, "hips-under", false, false), // suspender belts
    ...
    public static final InventorySlot[] mainWeaponSlots;
    public static final InventorySlot[] offhandWeaponSlots;
    public static final InventorySlot[] allWeaponSlots;
    private static final List<InventorySlot> humanoidSlots;
    private static final List<InventorySlot> clothingSlots;
    private static final List<InventorySlot> mainClothingSlots;
    private static final List<InventorySlot> extraClothingSlots;
    private static final List<InventorySlot> piercingSlots;
    private static final List<InventorySlot> commonTattooSlots;


    private final int zLayer;
    private final String name;
    private final boolean plural;
    private final String tattooSlotName;
    private final boolean jewellery;
    private final boolean coreClothing;

    InventorySlot(int zLayer, String name, boolean plural, boolean coreClothing, boolean jewellery, String tattooSlotName) {
        this.zLayer = zLayer;
        this.name = name;
        this.plural = plural;
