...
public enum ItemTag {
    ...
    private final List<String> clothingTooltipAdditions;
    private final boolean sexToy;
     ...
     */
    ItemTag(List<String> clothingTooltipAdditions, boolean sexToy) {
