...
public class ColourReplacement {
    ...
    private final boolean recolouringAllowed;
    private final List<String> colourReplacements;
    private final List<Colour> defaultColours;
    private final List<Colour> extraColours;
    private final List<Colour> allColours;
