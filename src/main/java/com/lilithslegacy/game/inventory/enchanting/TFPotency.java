...
public enum TFPotency {
    ...
    private static final List<TFPotency> allPotencies = new ArrayList<>();
    ...
    private final int clothingBonusValue;

    TFPotency(String name, Colour colour, int value, int clothingBonusValue) {
        this.name = name;
        this.colour = colour;
        this.value = value;
