...
import com.lilithslegacy.game.dialogue.utils.OffspringMapDialogue;
...
public class ItemEffectType {
    ...
    public static final AbstractItemEffectType DYE_BRUSH = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType REFORGE_HAMMER = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType USED_CONDOM_DRINK = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType FILLED_MOO_MILKER_DRINK = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType ORIENTATION_CHANGE = new AbstractItemEffectType(Util.newArrayListOfValues(
...
//	};
    ...
    public static final AbstractItemEffectType MOO_MILKER = new AbstractItemEffectType(Util.newArrayListOfValues(
            "Milks breasts."),
            PresetColour.GENERIC_SEX) {
    ...
    public static final AbstractItemEffectType PREGNANCY_TEST = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType MOTHERS_MILK = new AbstractItemEffectType(Util.newArrayListOfValues(
            ...
            for (Entry<SexAreaOrifice, List<AbstractStatusEffect>> entry : incubationEffectMap.entrySet()) {
                ...
                if (litter != null) {
                    ...
                    if (advanced) {
                        ...
                        sb.append("</br>");
                        if (eggs > 1) {
                            sb.append("The eggs being incubated in [npc.namePos] <b>").append(areaName).append("</b> rapidly mature and get noticeably heavier, letting [npc.herHim] know that they're ");
                        } else {
                            sb.append("The egg being incubated in [npc.namePos] <b>").append(areaName).append("</b> rapidly matures and gets noticeably heavier, letting [npc.herHim] know that it's ");
                        }
    ...
    public static final AbstractItemEffectType REJUVENATION_POTION = new AbstractItemEffectType(
            null,
    ...
    public static final AbstractItemEffectType CIGARETTE_PACK = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType CIGARETTE = new AbstractItemEffectType(null,
            PresetColour.BASE_PURPLE) {
        @Override
        ...
        @Override
        public List<String> getEffectsDescription(TFModifier primaryModifier, TFModifier secondaryModifier, TFPotency potency, int limit, GameCharacter user, GameCharacter target) {
            return super.getEffectsDescription(primaryModifier, secondaryModifier, potency, limit, user, target);
        }
    ...
    public static final AbstractItemEffectType MAKEUP_SET = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType DOLL_CONSOLE = new AbstractItemEffectType(Util.newArrayListOfValues(
...
//					MiscDialogue.getDollCustomisationDialogue()
    ...
    public static final AbstractItemEffectType MYSTERY_KINK = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType ADDICTION_REMOVAL = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType MUSHROOMS = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType EGGPLANT = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType EGGPLANT_POTION = new AbstractItemEffectType(null,
            PresetColour.BASE_PURPLE) {
    ...
    public static final AbstractItemEffectType ADDICTION_REMOVAL_REFINEMENT = new AbstractItemEffectType(null,
    ...
    public static final AbstractItemEffectType GIFT_CHOCOLATES = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType GIFT_PERFUME = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType PRESENT = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType BOTTLED_ESSENCE_ARCANE = new AbstractItemEffectType(Util.newArrayListOfValues(
...
//	};
    ...
    // Essences:
    public static final AbstractItemEffectType BIMBO_LOLLIPOP = new AbstractItemEffectType(Util.newArrayListOfValues(
        ...
        public String itemEffectOverride(TFModifier primaryModifier, TFModifier secondaryModifier, TFPotency potency, int limit, GameCharacter user, GameCharacter target, ItemEffectTimer timer) {
            ...
            sb.append("<p>").append(UtilText.parse(target, "As the lollipop's transformative effects start to make themselves known, [npc.name] [npc.verb(start)] to feel very light-headed...")).append("</p>");

            if (!target.hasFetish(Fetish.FETISH_BIMBO)) {
                target.addFetish(Fetish.FETISH_BIMBO);
                if (target.isPlayer()) {
                    sb.append("<br/>" + "<p>" + "A giggle escapes from between your [pc.lips], and you suddenly find yourself unable to think of anything other than how, like, super awesome bimbos are and stuff!" + "<br/><b style='color:").append(PresetColour.GENERIC_SEX.toWebHexString()).append(";'>You have gained the bimbo fetish!</b>").append("</p>");
                } else {
            ...
            if (target.getFemininityValue() < 95) {
                sb.append("<br/>").append(target.setFemininity(95));
            }
            if (target.getBreastSize().getMeasurement() < CupSize.DD.getMeasurement()) {
                sb.append("<br/>").append(target.setBreastSize(CupSize.DD.getMeasurement()));
            }
            if (target.getAssSize().getValue() < AssSize.FOUR_LARGE.getValue()) {
                sb.append("<br/>").append(target.setAssSize(AssSize.FOUR_LARGE.getValue()));
            }
            if (target.getHipSize().getValue() < HipSize.FOUR_WOMANLY.getValue()) {
                sb.append("<br/>").append(target.setHipSize(HipSize.FOUR_WOMANLY.getValue()));
            }
            ...
            if (!target.isAbleToHaveRaceTransformed()) {
                ...
                if (target.getHairType() != HairType.HARPY) {
                    sb.append("<br/>").append(target.setHairCovering(new Covering(BodyCoveringType.HAIR_HARPY, CoveringPattern.NONE, PresetColour.COVERING_BLEACH_BLONDE, false, PresetColour.COVERING_BLEACH_BLONDE, false), true));
                }
                if (target.getTorsoType() != TorsoType.HARPY) {
                    sb.append("<br/>").append(target.setSkinCovering(new Covering(BodyCoveringType.FEATHERS, CoveringPattern.NONE, PresetColour.COVERING_BLEACH_BLONDE, false, PresetColour.COVERING_BLEACH_BLONDE, false), true));
                }

                // Harpy TFs:
                if (target.getFaceType() != FaceType.HUMAN)
                    sb.append("<br/>").append(target.setFaceType(FaceType.HUMAN));
                if (target.getEarType() != EarType.HARPY)
                    sb.append("<br/>").append(target.setEarType(EarType.HARPY));
                if (target.getEyeType() != EyeType.HARPY)
                    sb.append("<br/>").append(target.setEyeType(EyeType.HARPY));
                if (target.getHairType() != HairType.HARPY)
                    sb.append("<br/>").append(target.setHairType(HairType.HARPY));
                if (target.getTorsoType() != TorsoType.HUMAN)
                    sb.append("<br/>").append(target.setTorsoType(TorsoType.HUMAN));

                if (target.getWingType() != WingType.NONE)
                    sb.append("<br/>").append(target.setWingType(WingType.NONE));
                if (target.getHornType() != HornType.NONE)
                    sb.append("<br/>").append(target.setHornType(HornType.NONE));

                if (target.getArmType() != ArmType.HARPY)
                    sb.append("<br/>").append(target.setArmType(ArmType.HARPY));
                if (target.getLegType() != LegType.HARPY)
                    sb.append("<br/>").append(target.setLegType(LegType.HARPY));
                if (target.getTailType() != TailType.HARPY)
                    sb.append("<br/>").append(target.setTailType(TailType.HARPY));

                if (target.getBreastType() != BreastType.HARPY)
                    sb.append("<br/>").append(target.setBreastType(BreastType.HARPY));
                if (target.getAssType() != AssType.HARPY)
                    sb.append("<br/>").append(target.setAssType(AssType.HARPY));

                if (target.hasPenisIgnoreDildo()) {
                    sb.append("<br/>").append(target.setPenisType(PenisType.HARPY));

                    if (target.getPenisRawCumStorageValue() < CumProduction.TWO_SMALL_AMOUNT.getMedianValue()) {
                        sb.append("<br/>").append(target.setPenisCumStorage(CumProduction.TWO_SMALL_AMOUNT.getMedianValue()));
                        target.fillCumToMaxStorage();
                    }
                }
                if (target.hasVagina()) {
                    sb.append("<br/>").append(target.setVaginaType(VaginaType.HARPY));
                }
            }
    ...
    // Specials:
    public static final AbstractItemEffectType NYMPHO_LOLLIPOP = new AbstractItemEffectType(Util.newArrayListOfValues(
        ...
        public String itemEffectOverride(TFModifier primaryModifier, TFModifier secondaryModifier, TFPotency potency, int limit, GameCharacter user, GameCharacter target, ItemEffectTimer timer) {
            ...
            if (!target.hasTrait(Perk.NYMPHOMANIAC, false)) {
                ...
                if (target.isPlayer()) {
                    sb.append("<br/>" + "<p>" + "A desperate moan escapes from between your [pc.lips], and you suddenly find yourself unable to think of anything other than sex, sex, and more sex!" + "<br/><b style='color:").append(PresetColour.GENERIC_SEX.toWebHexString()).append(";'>You have gained the nymphomaniac perk!</b>").append("</p>");
                } else {
                    sb.append(UtilText.parse(target, "<br/>"
                            + "<p>"
            ...
            if (target.getBreastSize().getMeasurement() < CupSize.C.getMeasurement()) {
                sb.append("<br/>").append(target.setBreastSize(CupSize.C.getMeasurement()));
            }
            if (target.getAssSize().getValue() < AssSize.THREE_NORMAL.getValue()) {
                sb.append("<br/>").append(target.setAssSize(AssSize.THREE_NORMAL.getValue()));
            }
            if (target.getHipSize().getValue() < HipSize.THREE_GIRLY.getValue()) {
                sb.append("<br/>").append(target.setHipSize(HipSize.THREE_GIRLY.getValue()));
            }
            ...
            if (!target.isAbleToHaveRaceTransformed()) {
                ...
                if (target.getHairType() != HairType.HARPY) {
                    sb.append("<br/>").append(target.setHairCovering(new Covering(BodyCoveringType.HAIR_HARPY, CoveringPattern.NONE, PresetColour.COVERING_PINK, false, PresetColour.COVERING_PINK, false), true));
                }
                if (target.getTorsoType() != TorsoType.HARPY) {
                    sb.append("<br/>").append(target.setHairCovering(new Covering(BodyCoveringType.FEATHERS, CoveringPattern.NONE, PresetColour.COVERING_PINK, false, PresetColour.COVERING_PINK, false), true));
                }
                ...
                if (target.getAssWetness().getValue() < Wetness.TWO_MOIST.getValue())
                    sb.append("<br/>").append(target.setAssWetness(Wetness.TWO_MOIST.getValue()));
                ...
                if (target.hasPenisIgnoreDildo()) {
                    ...
                    if (target.getPenisRawCumStorageValue() < CumProduction.THREE_AVERAGE.getMedianValue()) {
                        sb.append("<br/>").append(target.setPenisCumStorage(CumProduction.THREE_AVERAGE.getMedianValue()));
                        target.fillCumToMaxStorage();
                    }
                }
                if (target.hasVagina()) {
                    ...
                    if (target.getVaginaWetness().getValue() < Wetness.FOUR_SLIMY.getValue())
                        sb.append("<br/>").append(target.setVaginaWetness(Wetness.FOUR_SLIMY.getValue()));
                }
            }
    ...
    public static final AbstractItemEffectType DOMINANT_PERFUME = new AbstractItemEffectType(Util.newArrayListOfValues(
        ...
        public String itemEffectOverride(TFModifier primaryModifier, TFModifier secondaryModifier, TFPotency potency, int limit, GameCharacter user, GameCharacter target, ItemEffectTimer timer) {
            ...
            sb.append("<p>").append(UtilText.parse(target, "As the perfume's transformative effects start to make themselves known, [npc.name] [npc.verb(start)] to feel very light-headed...")).append("</p>");

            if (!target.hasFetish(Fetish.FETISH_DOMINANT)) {
                target.addFetish(Fetish.FETISH_DOMINANT);
                if (target.isPlayer()) {
                    sb.append("<br/>" + "<p>" + "A deep groan escapes from between your [pc.lips], and you suddenly find yourself thinking of how much you want to dominate the next person you come across!" + "<br/><b style='color:").append(PresetColour.GENERIC_SEX.toWebHexString()).append(";'>You have gained the dominant fetish!</b>").append("</p>");
                } else {
                    sb.append(UtilText.parse(target, "<br/>"
                            + "<p>"
            ...
            if (!target.isAbleToHaveRaceTransformed()) {
                ...
                if (target.getHairType() != HairType.HARPY) {
                    sb.append("<br/>").append(target.setHairCovering(new Covering(BodyCoveringType.HAIR_HARPY, CoveringPattern.NONE, PresetColour.COVERING_BLACK, false, PresetColour.COVERING_BLACK, false), true));
                }
                if (target.getTorsoType() != TorsoType.HARPY) {
                    sb.append("<br/>").append(target.setSkinCovering(new Covering(BodyCoveringType.FEATHERS, CoveringPattern.NONE, PresetColour.COVERING_RED, false, PresetColour.COVERING_RED, false), true));
                }
    ...
    public static final AbstractItemEffectType FETISH_ENHANCEMENT = new AbstractItemEffectType(null,
            PresetColour.FETISH) {
...
//			}
    ...
    // RACIAL:
    public static final AbstractItemEffectType CLOTHING = new AbstractItemEffectType(null,
    ...
    // CLOTHING:
    public static final AbstractItemEffectType TATTOO = new AbstractItemEffectType(null,
            PresetColour.RARITY_RARE) {
     ...
     */
    public static final AbstractItemEffectType RACE_SLIME_TF_UTIL_EFFECT = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final AbstractItemEffectType WEAPON = new AbstractItemEffectType(null,
            PresetColour.RARITY_RARE) {
    ...
    public static final AbstractItemEffectType OFFSPRING_MAP = new AbstractItemEffectType(Util.newArrayListOfValues(
    ...
    public static final Map<AbstractItemEffectType, String> itemEffectTypeToIdMap = new HashMap<>();
    public static final Map<String, AbstractItemEffectType> idToItemEffectTypeMap = new HashMap<>();
    public static final List<AbstractItemEffectType> allEffectTypes = new ArrayList<>();
    public static final Map<AbstractRace, AbstractItemEffectType> racialEffectTypes = new HashMap<>();
