...
//		}
        ...
        switch (primaryMod) {
            ...
            case "TF_PENIS":
                if (Main.isVersionOlderThan(Game.loadingVersion, "0.3.5.1")) {
                    if (secondaryMod.equals("TF_MOD_SIZE_SECONDARY")) {
        ...
        if (Main.isVersionOlderThan(Game.loadingVersion, "0.4.1") && itemEffectType.equals("TF_TAIL") && primaryMod.equals("TF_MOD_SIZE")) { // Girth TF was moved from TF_MOD_SIZE to TF_MOD_SIZE_SECONDARY in v0.4
        ...
        try { // Wrap this in a try, as the TFModifier.valueOf might fail, due to removing Broodmother/Seeder fetish modifiers in 0.2.7.5, and then critical chance in 0.3.3.5.
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "(Minor error, can ignore.) Unable to import ItemEffect (" + primaryMod + ", " + secondaryMod + ") from" + doc.getDocumentURI());
