...
public abstract class AbstractItem extends AbstractCoreItem implements XMLSaving {
    ...
    protected final AbstractItemType itemType;
    ...
    public static AbstractItem loadFromXML(Element parentElement, Document doc) {
        try {
            ...
            if (it == null) {
                System.getLogger("").log(System.Logger.Level.ERROR, "Warning: An instance of AbstractItem was unable to be imported, due to AbstractItemType not existing. (" + parentElement.getAttribute("id") + ")");
                return null;
            }
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Warning: An instance of AbstractItem was unable to be imported. (" + parentElement.getAttribute("id") + ")");
...
//			modifier += itemEffects.size()*0.01f;
    ...
    public String getExtraDescription(GameCharacter user, GameCharacter target) {
        ...
        sb.append("</p>" + "<p>").append(this.getItemType().isPlural() ? "They have" : "It has").append(" a value of ").append(UtilText.formatAsMoney(getValue())).append(".").append("</p>");
