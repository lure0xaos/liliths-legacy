...
import com.lilithslegacy.game.inventory.enchanting.ItemEffectTimer;
...
public class ItemType {
    ...
    public static final AbstractItemType FETISH_REFINED = new AbstractItemType(750,
            "a vial of",
            false,
            "Fetish Endowment",
            "Fetish Endowments",
    ...
    public static final AbstractItemType FETISH_UNREFINED = new AbstractItemType(500,
            "a vial of",
            false,
            "Mystery Kink",
            "Mystery Kinks",
    ...
    public static final AbstractItemType ADDICTION_REMOVAL_REFINED = new AbstractItemType(1500,
            "a delicate vial of",
            false,
            "Angel's Purity",
            "Angel's Purities",
    ...
    public static final AbstractItemType ADDICTION_REMOVAL = new AbstractItemType(750,
            "a bottle of",
            false,
            "Angel's Nectar",
            "Angel's Nectars",
    ...
    public static final AbstractItemType MUSHROOM = new AbstractItemType(500,
            "a cluster of",
            true,
            "Glowing Mushroom",
            "Glowing Mushrooms",
    ...
    public static final AbstractItemType HARPY_MATRIARCH_BIMBO_LOLLIPOP = new AbstractItemType(1250,
            null,
            false,
    ...
    public static final AbstractItemType HARPY_MATRIARCH_NYMPHO_LOLLIPOP = new AbstractItemType(1250,
            null,
            false,
    ...
    public static final AbstractItemType HARPY_MATRIARCH_DOMINANT_PERFUME = new AbstractItemType(1250,
            null,
            false,
    ...
    // Specials:
    public static final AbstractItemType POTION = new AbstractItemType(500,
            "",
            false,
            "potion",
            "potions",
    ...
    public static final AbstractItemType ELIXIR = new AbstractItemType(750,
            "",
            false,
            "elixir",
            "elixirs",
    ...
    public static final AbstractItemType DYE_BRUSH = new AbstractItemType(150,
            "a",
            false,
            "dye-brush",
            "dye-brushes",
    ...
    // Crafting outputs:
    public static final AbstractItemType REFORGE_HAMMER = new AbstractItemType(150,
            "a",
            false,
            "reforging hammer",
            "reforging hammers",
    ...
    public static final AbstractItemType CONDOM_USED_WEBBING = new AbstractItemType(1,
            "a",
            false,
            "used condom-webbing",
    ...
    // Non-TF:
    public static final AbstractItemType CONDOM_USED = new AbstractItemType(1,
            "a",
            false,
            "used condom",
            "used condoms",
    ...
    public static final AbstractItemType MOO_MILKER_EMPTY = new AbstractItemType(50,
            "a",
            false,
            "Moo Milker",
            "Moo Milkers",
    ...
    public static final AbstractItemType MOO_MILKER_FULL = new AbstractItemType(150,
            "a",
            false,
            "Filled Moo Milker",
            "Filled Moo Milkers",
    ...
    public static final AbstractItemType PREGNANCY_TEST = new AbstractItemType(100,
            "an",
            false,
    ...
    public static final AbstractItemType MOTHERS_MILK = new AbstractItemType(100,
            "a bottle of",
            false,
            "Mother's Milk",
            "Mother's Milks",
    ...
    public static final AbstractItemType ORIENTATION_HYPNO_WATCH = new AbstractItemType(50000,
            "a",
            false,
            "Hypno-Watch",
            "Hypno-Watches",
...
//	};
    ...
    public static final AbstractItemType CIGARETTE_PACK = new AbstractItemType(350,
            "a pack of",
            true,
            "Starr Cigarette",
            "Starr Cigarettes",
    ...
    public static final AbstractItemType CIGARETTE = new AbstractItemType(20,
            "a",
            false,
            "Starr Cigarette",
            "Starr Cigarettes",
    ...
    public static final AbstractItemType MAKEUP_SET = new AbstractItemType(5000,
            "an",
            false,
            "arcane makeup set",
            "arcane makeup set",
    ...
    public static final AbstractItemType PRESENT = new AbstractItemType(250,
            "a",
            false,
            "Yuletide Gift",
            "Yuletide Gift",
    ...
    public static final AbstractItemType GIFT_ROSE_BOUQUET = new AbstractItemType(
            500,
            null,
            false,
            "Rose Bouquet",
    ...
    public static final AbstractItemType GIFT_CHOCOLATES = new AbstractItemType(
            300,
            "a box of",
            true,
            "Chocolates",
    ...
    public static final AbstractItemType GIFT_PERFUME = new AbstractItemType(
            300,
            "a bottle of",
            false,
            "Rose Perfume",
    ...
    public static final AbstractItemType GIFT_TEDDY_BEAR = new AbstractItemType(
            600,
            null,
            false,
            "Teddy Bear",
    ...
    public static final AbstractItemType EGGPLANT_POTION = new AbstractItemType(
            250,
            null,
            false,
            "Eggplant Potion",
    ...
    // Why did I make this?
    public static final AbstractItemType EGGPLANT = new AbstractItemType(
            25,
            null,
            false,
            "Eggplant",
    ...
    public static final AbstractItemType ARTHURS_PACKAGE = new AbstractItemType(0,
            "",
            false,
            "Arthur's Package",
            "Arthur's Packages",
    ...
    public static final AbstractItemType IMP_FORTRESS_ARCANE_KEY = new AbstractItemType(0,
            "",
            false,
            "Fyrsia's Key",
            "Fyrsia's Keys",
    ...
    public static final AbstractItemType IMP_FORTRESS_ARCANE_KEY_2 = new AbstractItemType(0,
            "",
            false,
            "Jhortrax's Key",
            "Jhortrax's Keys",
    ...
    public static final AbstractItemType IMP_FORTRESS_ARCANE_KEY_3 = new AbstractItemType(0,
            "",
            false,
            "Hyorlyss's Key",
            "Hyorlyss's Keys",
    ...
    public static final AbstractItemType LYSSIETHS_RING = new AbstractItemType(0,
            "",
            false,
    ...
    public static final AbstractItemType OFFSPRING_MAP = new AbstractItemType(50_000,
            "an",
            false,
    ...
    public static final AbstractItemType CANDI_PERFUMES = new AbstractItemType(500,
            "",
            true,
            "Candi's Perfume",
            "Candi's Perfumes",
    ...
    public static final AbstractItemType CANDI_CONTRABAND = new AbstractItemType(1000,
            "",
            false,
    ...
    public static final AbstractItemType CANDI_HUNDRED_KISSES = new AbstractItemType(50000,
            "",
            false,
            "'A Hundred Kisses'",
            "'A Hundred Kisses'",
    ...
    public static final AbstractItemType RESONANCE_STONE = new AbstractItemType(0,
            "",
            false,
    ...
    public static final AbstractItemType ROLLED_UP_POSTERS = new AbstractItemType(0,
            "half a dozen",
            true,
    ...
    public static final AbstractItemType NATALYA_BUSINESS_CARD = new AbstractItemType(0,
            "",
            false,
    ...
    public static final AbstractItemType NATALYA_BUSINESS_CARD_STAMPED = new AbstractItemType(0,
            "",
            false,
    ...
    public static final AbstractItemType SLAVER_LICENSE = new AbstractItemType(5000,
            "",
            false,
            "Slaver license",
            "Slaver licenses",
    ...
    public static final AbstractItemType PAINT_CAN_PREMIUM = new AbstractItemType(1_500,
            "a can of",
            false,
    ...
    public static final AbstractItemType PAINT_CAN = new AbstractItemType(250,
            "a can of",
            false,
...
//
    ...
    public static final AbstractItemType BOTTLED_ESSENCE_ARCANE = new AbstractItemType(
            40,
            null,
            false,
    ...
    private static String getEssenceSvg(AbstractSubspecies subspecies) {
        ...
        try {
            InputStream is = FS.newResourceAsStream("/com/lilithslegacy/res/items/essenceBackground.svg");
            String s = Util.inputStreamToString(is);

            background = SvgUtil.colourReplacement(subspecies.getName(null), colour, s);
            is.close();

            is = FS.newResourceAsStream("/com/lilithslegacy/res/items/essenceBottle.svg");
...
//		subspeciesIcon = subspeciesIcon.replaceAll(colour.getShades()[4], colour.getShades()[3]);
    ...
    private static String getEssenceEffectSvg(AbstractSubspecies subspecies) {
        ...
        return "<div style='width:80%;height:80%;position:absolute;left:10%;top:10%;'>"
                + background
                + "</div>"
                + "<div style='width:70%;height:70%;position:absolute;left:15%;top:20%;'>"
                + subspeciesIcon
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/items/items");
        for (Entry<String, Map<String, Path>> entry : moddedFilesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded item failed at 'ItemType'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/items");
...
//					System.out.println("IT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading item failed at 'ItemType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
