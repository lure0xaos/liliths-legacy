...
public abstract class AbstractCoreItem implements XMLSaving {
    ...
    protected final Set<ItemTag> itemTags;
    ...
    public static AbstractCoreItem loadFromXML(Element parentElement, Document doc) {
        System.getLogger("").log(System.Logger.Level.ERROR, "Error: Tried to import an abstract item!");
        return null;
    }

    public Element saveAsXML(Element parentElement, Document doc) {
        System.getLogger("").log(System.Logger.Level.ERROR, "Error: Tried to export an abstract item!");
        return null;
    }
