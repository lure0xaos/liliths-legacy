...
public class WeaponType {
    ...
    public static final Map<AbstractWeaponType, String> weaponToIdMap = new HashMap<>();
    public static final Map<String, AbstractWeaponType> idToWeaponMap = new HashMap<>();
    private static final List<AbstractWeaponType> allWeapons = new ArrayList<>();
        ...
        for (Entry<String, Map<String, Path>> entry : moddedFilesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded weapon failed at 'WeaponType'. File path: " + innerEntry.getValue());
...
//					System.out.println("WT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading weapon failed at 'WeaponType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
