...
public class SetBonus {
    ...
    public static final List<AbstractSetBonus> allSetBonuses;

    public static final Map<AbstractSetBonus, String> setBonusToIdMap = new HashMap<>();
    public static final Map<String, AbstractSetBonus> idToSetBonusMap = new HashMap<>();
...
//					System.out.println("modded "+id);
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded set bonus failed at 'SetBonusType'. File path: " + innerEntry.getValue());
...
//					System.out.println("SBT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading set bonus failed at 'SetBonusType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
