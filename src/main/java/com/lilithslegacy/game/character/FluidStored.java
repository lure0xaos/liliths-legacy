...
import com.lilithslegacy.game.character.body.FluidGirlCum;
import com.lilithslegacy.game.character.body.FluidInterface;
...
public class FluidStored implements XMLSaving {
    ...
    private final AbstractSubspecies cumSubspecies; // used for calculating pregnancy.
    private final AbstractSubspecies cumHalfDemonSubspecies; // used for calculating pregnancy.
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof FluidStored) {
            return ((FluidStored) o).getFluid().equals(this.getFluid())
