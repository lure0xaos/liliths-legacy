...
import com.lilithslegacy.game.sex.sexActions.submission.SARoxySpecials;
...
public class Roxy extends NPC {
    ...
    private static final List<AbstractItemType> itemsForSale = Util.newArrayListOfValues(
