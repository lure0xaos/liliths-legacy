...
//			}
    ...
    public String getSpecialPlayerVirginityLoss(GameCharacter penetratingCharacter, SexAreaPenetration penetrating, GameCharacter receivingCharacter, SexAreaOrifice penetrated) {
        ...
        if (Main.game.getPlayer().hasHymen()) {
            sb.append("<p>" + "As the dominant [npc.race] drives [npc.her] [npc.cock+] deep into your [pc.pussy+], your vision explodes in stars, and a painful, high-pitched shriek escapes from between your lips." + " Due to the fact that you're still a virgin, the sudden, violent penetration is like nothing you've ever felt before," + " and your shriek turns into a shuddering cry as you find yourself overwhelmed by the agony of your first penetration." + "</p>").append(Main.game.getPlayer().hasFetish(Fetish.FETISH_MASOCHIST)
                    ? "<p>"
                    ...
                    + "</p>"
                    : "").append("<p>").append("Glancing down, you see a small trickle of blood flowing out of your now-broken-in pussy, and you realise that your hymen has been completely torn.").append(" As you let out a desperate sigh, you hear the [npc.race] giggling at your reaction.").append("</p>").append("<p>").append("Looking up at [npc.herHim], you see a wild, crazed look in [npc.her] eyes.").append(" Another jolt of pain shoots up between your legs as [npc.she] drives [npc.her] [npc.cock+] even deeper into your [pc.pussy+].").append(" Leaning into you, [npc.she] pulls you into a sloppy kiss, and with a final, violent thrust into your groin, you feel the base of [npc.her] cock grind up against your [pc.labia+].").append("</p>").append("<p>").append("Still keeping [npc.her] [npc.cock] fully hilted in your [pc.pussy], [npc.she] breaks off the kiss, raising [npc.her] hand to cover your mouth as [npc.she] muffles your painful cries.").append(" Playfully biting [npc.her] lip, [npc.she] starts taunting you, clearly getting incredibly excited about being the one to take your virginity.").append("</p>").append("<p>").append("[npc.speechNoEffects(~Mmm!~ Doesn't that feel good?! Aww, I wonder if you were saving yourself for someone?)]").append(" [npc.She] pauses for a moment to let out a mocking laugh, before continuing,").append(" [npc.speechNoEffects(Well, I guess you were saving yourself for me in the end! Which is a shame, really, because you're just another easy fuck to me.)]").append("</p>").append("<p>").append("You let out a protesting moan, but the [npc.race] just presses [npc.her] hand down even tighter over your mouth as [npc.she] continues, ").append("[npc.speechNoEffects(What's that? You want me to do it again?!)]").append("</p>").append("<p>").append("Letting out a manic laugh, the [npc.race] suddenly drops [npc.her] hips, allowing [npc.her] [npc.cock+] to slide fully out of your [pc.pussy+].").append(" Lining [npc.herself] up once more, [npc.she] wastes no time before violently thrusting up into you for a second time.").append(" Although still uncomfortable enough to cause you to cry out into the palm of [npc.her] hand, it's nothing like the agony you experienced on the first thrust,").append(" and as you feel [npc.her] throbbing length filling you up once more, you find yourself letting out a desperate little moan.").append("</p>").append("<p>").append("The [npc.race] looks delighted at your reaction, and leans in as [npc.she] continues teasing you,").append(" [npc.speechNoEffects(~Ooh!~ So, you're a slut for demon dick? Can you feel it, pushing <i>deep</i>, claiming your precious little virginity?!)]").append("</p>").append("<p>").append("Dropping [npc.her] hips a little, [npc.she] starts rapidly thrusting in and out of your [pc.pussy], taking [npc.her] hand away from your mouth as you find yourself letting out a series of lewd moans.").append(" Moving [npc.her] hands down to take hold of your waist, [npc.she] carries on taunting you, repeating that you'll always remember this moment as the time you discovered that you're just a slut for big, thick demon cock.").append(" As the pain between your legs fades away into a dull ache, you find yourself letting out moan after desperate moan, and you start to worry that the [npc.race] might be right...").append("</p>");
