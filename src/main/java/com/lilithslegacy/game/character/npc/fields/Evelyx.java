...
//		this.setBlusher(new Covering(BodyCoveringType.MAKEUP_BLUSHER, PresetColour.COVERING_PINK_LIGHT));
    ...
    private String getTransformationFormat(boolean available, Colour titleColour, String title, String text, StringBuilder transformationStringBuilder) {
        ...
        sb.append("<p>");
        if (available) {
            sb.append("[style.boldGood(Apply:)] <span style='color:").append(titleColour.toWebHexString()).append(";'>").append(title).append("</span>");
            sb.append("</br>");
            sb.append(text);
        } else {
            sb.append("[style.boldDisabled(Not Required:)] [style.colourDisabled(").append(title);
            sb.append("</br>");
            sb.append(text);
            sb.append(")]");
        }
        ...
        if (available) {
            transformationStringBuilder.append("<i><b style='color:").append(titleColour.toWebHexString()).append(";'>").append(title).append(":</b> ").append(text).append("</i>");
        } else {
            transformationStringBuilder.append("<i>[style.boldDisabled(Not Required:)] [style.colourDisabled(").append(title).append(": ").append(text).append(")]</i>");
        }
