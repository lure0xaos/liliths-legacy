...
public enum Gender {
    ...
    private final GenderNames name;
    private final Colour colour;
    private final PronounType type;
    private final ContentPreferenceValue genderPreferenceDefault;

    Gender(GenderNames name, PronounType type, Colour colour, ContentPreferenceValue genderPreferenceDefault) {
        this.name = name;
        this.type = type;
        this.colour = colour;
