...
public class EyeType {
    ...
    public static final AbstractEyeType HUMAN = new AbstractEyeType(BodyCoveringType.EYE_HUMAN,
            Race.HUMAN,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType ANGEL = new AbstractEyeType(BodyCoveringType.EYE_ANGEL,
            Race.ANGEL,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType DEMON_COMMON = new AbstractEyeType(BodyCoveringType.EYE_DEMON_COMMON,
            Race.DEMON,
            1,
            EyeShape.ROUND,
            EyeShape.VERTICAL,
    ...
    public static final AbstractEyeType CAT_MORPH = new AbstractEyeType(BodyCoveringType.EYE_FELINE,
            Race.CAT_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.VERTICAL,
    ...
    public static final AbstractEyeType COW_MORPH = new AbstractEyeType(BodyCoveringType.EYE_COW_MORPH,
            Race.COW_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.HORIZONTAL,
    ...
    public static final AbstractEyeType DOG_MORPH = new AbstractEyeType(BodyCoveringType.EYE_DOG_MORPH,
            Race.DOG_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType FOX_MORPH = new AbstractEyeType(BodyCoveringType.EYE_FOX_MORPH,
            Race.FOX_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.VERTICAL,
    ...
    public static final AbstractEyeType WOLF_MORPH = new AbstractEyeType(BodyCoveringType.EYE_LYCAN,
            Race.WOLF_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType SQUIRREL_MORPH = new AbstractEyeType(BodyCoveringType.EYE_SQUIRREL,
            Race.SQUIRREL_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType RAT_MORPH = new AbstractEyeType(BodyCoveringType.EYE_RAT,
            Race.RAT_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType RABBIT_MORPH = new AbstractEyeType(BodyCoveringType.EYE_RABBIT,
            Race.RABBIT_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType BAT_MORPH = new AbstractEyeType(BodyCoveringType.EYE_BAT,
            Race.BAT_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
    ...
    public static final AbstractEyeType ALLIGATOR_MORPH = new AbstractEyeType(BodyCoveringType.EYE_ALLIGATOR_MORPH,
    ...
    public static final AbstractEyeType HORSE_MORPH = new AbstractEyeType(BodyCoveringType.EYE_HORSE_MORPH,
            Race.HORSE_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.HORIZONTAL,
    ...
    public static final AbstractEyeType REINDEER_MORPH = new AbstractEyeType(BodyCoveringType.EYE_REINDEER_MORPH,
            Race.REINDEER_MORPH,
            1,
            EyeShape.ROUND,
            EyeShape.HORIZONTAL,
    ...
    public static final AbstractEyeType HARPY = new AbstractEyeType(BodyCoveringType.EYE_HARPY,
            Race.HARPY,
            1,
            EyeShape.ROUND,
            EyeShape.ROUND,
