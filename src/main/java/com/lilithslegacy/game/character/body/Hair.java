...
public class Hair implements BodyPartInterface {
    ...
    public String setStyle(GameCharacter owner, HairStyle style) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("<p>");
        sb.append("[npc.NamePos] [npc.hair(true)] ").append(type.isDefaultPlural(owner) ? "are" : "is").append(" now ");
        switch (style) { //TODO This should be handled in the style itself
            ...
            case LOOSE:
                ...
                break;
            case NONE:
                sb.append("unstyled, and will take on ").append(type.isDefaultPlural(owner) ? "their" : "its").append(" natural shape.");
                break;
            case PONYTAIL:
