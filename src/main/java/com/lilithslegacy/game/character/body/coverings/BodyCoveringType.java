...
public class BodyCoveringType {
    ...
    public static final AbstractBodyCoveringType HUMAN = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType FOX_FUR = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType ANGEL = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
    ...
    public static final AbstractBodyCoveringType ANGEL_FEATHER = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType DEMON_COMMON = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
            BodyCoveringTemplateFactory.createTopSkin(
                    Util.newHashMapOfValues(new Value<>(CoveringPattern.NONE, 1)),
    ...
    public static final AbstractBodyCoveringType DEMON_FEATHER = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FEATHER,
            "a layer of",
            true,
            "feathers",
...
//	};
    ...
    public static final AbstractBodyCoveringType BAT_SKIN = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
            BodyCoveringTemplateFactory.createBottomSkin(PresetColour.getHumanSkinColours())) {
    };

    public static final AbstractBodyCoveringType BAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
    ...
    public static final AbstractBodyCoveringType CANINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(
                    Util.newArrayListOfValues(
    ...
    public static final AbstractBodyCoveringType LYCAN_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(Util.newArrayListOfValues(CoveringModifier.SHAGGY), null)) {
    };

    public static final AbstractBodyCoveringType FELINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(
                    Util.newArrayListOfValues(
                            CoveringModifier.SMOOTH,
    ...
    public static final AbstractBodyCoveringType SQUIRREL_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(Util.newArrayListOfValues(CoveringModifier.SMOOTH), null)) {
    };

    public static final AbstractBodyCoveringType RAT_SKIN = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
            BodyCoveringTemplateFactory.createBottomSkin(PresetColour.ratSkinColours)) {
    };

    public static final AbstractBodyCoveringType RAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(Util.newArrayListOfValues(CoveringModifier.SMOOTH), null)) {
    };

    public static final AbstractBodyCoveringType RABBIT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(Util.newArrayListOfValues(CoveringModifier.SMOOTH, CoveringModifier.FLUFFY), null)) {
    };

    public static final AbstractBodyCoveringType HORSE_HAIR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_HAIR,
            "a layer of",
            false,
            "hair",
    ...
    public static final AbstractBodyCoveringType REINDEER_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(
                    Util.newArrayListOfValues(CoveringModifier.SMOOTH),
                    Util.newHashMapOfValues(new Value<>(CoveringPattern.NONE, 1)))) {
    ...
    public static final AbstractBodyCoveringType BOVINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FUR,
            BodyCoveringTemplateFactory.createFurSkin(
                    Util.newArrayListOfValues(
                            CoveringModifier.SHORT,
     ...
     */
    public static final AbstractBodyCoveringType HARPY_SKIN = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
    ...
    public static final AbstractBodyCoveringType DILDO = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType SNAKE_SCALES = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SCALES,
            "a layer of",
            true,
            "scales",
    ...
    public static final AbstractBodyCoveringType SPIDER_CHITIN = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType OCTOPUS_SKIN = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
            "a layer of",
            false,
            "skin",
    ...
    public static final AbstractBodyCoveringType FISH_SCALES = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SCALES,
            "a layer of",
            true,
            "scales",
    ...
    public static final AbstractBodyCoveringType ANTENNA = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType HORN = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType ANTLER = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType TONGUE = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType FEATHERS = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_FEATHER,
            "a layer of",
            true,
            "feathers",
    ...
    public static final AbstractBodyCoveringType WING_LEATHER = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_SKIN,
            "a layer of",
            false,
            "skin",
    ...
    public static final AbstractBodyCoveringType WING_CHITIN = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAIN_CHITIN,
            "a layer of",
            false,
            "chitin",
    ...
    public static final AbstractBodyCoveringType HAIR_HUMAN = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createHeadHair(CoveringModifier.SMOOTH)) {
    };

    public static final AbstractBodyCoveringType HAIR_ANGEL = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createHeadHair(CoveringModifier.SILKEN)) {
    };

    public static final AbstractBodyCoveringType HAIR_FOX_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            "a layer of",
            false,
            "hair",
    ...
    public static final AbstractBodyCoveringType HAIR_DEMON = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createHeadHair(CoveringModifier.SILKEN)) {
    };

    public static final AbstractBodyCoveringType HAIR_CANINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_LYCAN_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_FELINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_HORSE_HAIR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType HAIR_REINDEER_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType HAIR_BOVINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType HAIR_SQUIRREL_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_RAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_RABBIT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_BAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType HAIR_HARPY = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            "a plume of",
            true,
            "feathers",
    ...
    public static final AbstractBodyCoveringType HAIR_SCALES_ALLIGATOR = new AbstractBodyCoveringType(
            BodyCoveringCategory.HAIR,
            BodyCoveringTemplateFactory.createFurHeadHair(CoveringModifier.COARSE)) {
    };
    ...
    public static final AbstractBodyCoveringType BODY_HAIR_HUMAN = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_ANGEL = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.SILKEN)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_DEMON = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.SILKEN)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_CANINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_LYCAN_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_FOX_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_FELINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_HORSE_HAIR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_REINDEER_HAIR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_BOVINE_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.COARSE)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_SQUIRREL_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_RAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_RABBIT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_BAT_FUR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.FURRY)) {
    };

    public static final AbstractBodyCoveringType BODY_HAIR_HARPY = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            "a patch of",
            true,
            "feathers",
    ...
    public static final AbstractBodyCoveringType BODY_HAIR_SCALES_ALLIGATOR = new AbstractBodyCoveringType(
            BodyCoveringCategory.BODY_HAIR,
            BodyCoveringTemplateFactory.createBodyHair(CoveringModifier.COARSE)) {
    };
    ...
    public static final AbstractBodyCoveringType EYE_HUMAN = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesHeterochromiaNaturallyOccurring()) {
    };

    public static final AbstractBodyCoveringType EYE_ANGEL = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_DEMON_COMMON = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
    ...
    public static final AbstractBodyCoveringType EYE_DOG_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesHeterochromiaNaturallyOccurring()) {
    };

    public static final AbstractBodyCoveringType EYE_LYCAN = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesWithCustomColors(
                    PresetColour.naturalPredatorIrisColours, PresetColour.dyePredatorIrisColours, true)) {
    };

    public static final AbstractBodyCoveringType EYE_FOX_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            "a pair of",
            true,
            "eyes",
    ...
    public static final AbstractBodyCoveringType EYE_FELINE = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesWithCustomColors(
                    PresetColour.naturalPredatorIrisColours, PresetColour.dyePredatorIrisColours, true)) {
    };

    public static final AbstractBodyCoveringType EYE_SQUIRREL = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_RAT = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_RABBIT = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_BAT = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_ALLIGATOR_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_HORSE_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesHeterochromiaNaturallyOccurring()) {
    };

    public static final AbstractBodyCoveringType EYE_REINDEER_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_COW_MORPH = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrisesHeterochromiaNaturallyOccurring()) {
    };

    public static final AbstractBodyCoveringType EYE_HARPY = new AbstractBodyCoveringType(
            BodyCoveringCategory.EYE_IRIS,
            BodyCoveringTemplateFactory.createEyeIrises()) {
    };

    public static final AbstractBodyCoveringType EYE_PUPILS = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType EYE_SCLERA = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType CUM = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType GIRL_CUM = new AbstractBodyCoveringType(
            BodyCoveringCategory.FLUID,
            "",
            false,
            "girlcum",
    ...
    public static final AbstractBodyCoveringType MILK = new AbstractBodyCoveringType(
            BodyCoveringCategory.FLUID,
            "",
            false,
            "milk",
    ...
    public static final AbstractBodyCoveringType MAKEUP_BLUSHER = new AbstractBodyCoveringType(
    ...
    public static final AbstractBodyCoveringType MAKEUP_EYE_LINER = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAKEUP,
            "a layer of",
            false,
            "eye liner",
    ...
    public static final AbstractBodyCoveringType MAKEUP_EYE_SHADOW = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAKEUP,
            "a layer of",
            false,
            "eye shadow",
    ...
    public static final AbstractBodyCoveringType MAKEUP_LIPSTICK = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAKEUP,
            "a layer of",
            false,
            "lipstick",
    ...
    public static final AbstractBodyCoveringType MAKEUP_NAIL_POLISH_HANDS = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAKEUP,
            "a layer of",
            false,
            "nail polish",
    ...
    public static final AbstractBodyCoveringType MAKEUP_NAIL_POLISH_FEET = new AbstractBodyCoveringType(
            BodyCoveringCategory.MAKEUP,
            "a layer of",
            false,
            "nail polish",
    ...
    public static final List<AbstractBodyCoveringType> allBodyCoveringTypes;

    public static final Map<AbstractBodyCoveringType, String> bodyCoveringTypesToIdMap = new HashMap<>();
    public static final Map<String, AbstractBodyCoveringType> idToBodyCoveringTypesMap = new HashMap<>();

    public static final List<AbstractBodyCoveringType> allMakeupTypes;
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/race", "coveringTypes", null);
        for (Entry<String, Map<String, Path>> entry : moddedFilesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded bodyCoveringType failed at 'BodyCoveringType'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/race", "coveringTypes", null);
        for (Entry<String, Map<String, Path>> entry : filesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading bodyCoveringType failed at 'BodyCoveringType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
...
//								break;
                            ...
                            case PENIS:
                            case TONGUE:
                                bct = new AbstractBodyCoveringType(cat, BodyCoveringTemplateFactory.createSilicone(CoveringPattern.NONE, CoveringPattern.allSiliconeCoveringPatterns)) {
                                };
                                break;
                            case EYE_IRIS:
                                bct = new AbstractBodyCoveringType(cat,
                                        BodyCoveringTemplateFactory.createSilicone(CoveringPattern.EYE_IRISES, Util.newHashMapOfValues(new Value<>(CoveringPattern.EYE_IRISES_HETEROCHROMATIC, 1)))) {
                                };
                                break;
                            case EYE_PUPIL:
                                bct = new AbstractBodyCoveringType(cat,
                                        BodyCoveringTemplateFactory.createSilicone(CoveringPattern.EYE_PUPILS, Util.newHashMapOfValues(new Value<>(CoveringPattern.EYE_IRISES_HETEROCHROMATIC, 1)))) {
                                };
                                break;
                            case EYE_SCLERA:
                                bct = new AbstractBodyCoveringType(cat,
                            ...
                            case ANUS:
                                ...
                                break;
                            case MOUTH:
                                bct = new AbstractBodyCoveringType(cat, BodyCoveringTemplateFactory.createSilicone(CoveringPattern.ORIFICE_MOUTH, null)) {
                                };
                                break;
                            case NIPPLE:
                                bct = new AbstractBodyCoveringType(cat, BodyCoveringTemplateFactory.createSilicone(CoveringPattern.ORIFICE_NIPPLE, null)) {
                                };
                                break;
                            case NIPPLE_CROTCH:
                                bct = new AbstractBodyCoveringType(cat, BodyCoveringTemplateFactory.createSilicone(CoveringPattern.ORIFICE_NIPPLE_CROTCH, null)) {
                                };
                                break;
                            case VAGINA:
                                bct = new AbstractBodyCoveringType(cat, BodyCoveringTemplateFactory.createSilicone(CoveringPattern.ORIFICE_VAGINA, null)) {
                                };
                                break;
                            case SPINNERET:
