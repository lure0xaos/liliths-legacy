...
public class AssType {
    ...
    public static final AbstractAssType HUMAN = new AbstractAssType(BodyCoveringType.HUMAN,
            Race.HUMAN,
            AnusType.HUMAN,
            null,
            null,
    ...
    public static final AbstractAssType ANGEL = new AbstractAssType(BodyCoveringType.ANGEL,
            Race.ANGEL,
            AnusType.ANGEL,
            null,
            null,
    ...
    public static final AbstractAssType DEMON_COMMON = new AbstractAssType(BodyCoveringType.DEMON_COMMON,
            Race.DEMON,
    ...
    public static final AbstractAssType DOG_MORPH = new AbstractAssType(BodyCoveringType.CANINE_FUR,
            Race.DOG_MORPH,
            AnusType.DOG_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType COW_MORPH = new AbstractAssType(BodyCoveringType.BOVINE_FUR,
            Race.COW_MORPH,
            AnusType.COW_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType SQUIRREL_MORPH = new AbstractAssType(BodyCoveringType.SQUIRREL_FUR,
            Race.SQUIRREL_MORPH,
    ...
    public static final AbstractAssType RAT_MORPH = new AbstractAssType(BodyCoveringType.RAT_FUR,
            Race.RAT_MORPH,
            AnusType.RAT_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType RABBIT_MORPH = new AbstractAssType(BodyCoveringType.RABBIT_FUR,
            Race.RABBIT_MORPH,
    ...
    public static final AbstractAssType BAT_MORPH = new AbstractAssType(BodyCoveringType.BAT_FUR,
            Race.BAT_MORPH,
            AnusType.BAT_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType ALLIGATOR_MORPH = new AbstractAssType(BodyCoveringType.ALLIGATOR_SCALES,
    ...
    public static final AbstractAssType WOLF_MORPH = new AbstractAssType(BodyCoveringType.LYCAN_FUR,
            Race.WOLF_MORPH,
            AnusType.WOLF_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType FOX_MORPH = new AbstractAssType(BodyCoveringType.FOX_FUR,
            Race.FOX_MORPH,
            AnusType.FOX_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType CAT_MORPH = new AbstractAssType(BodyCoveringType.FELINE_FUR,
            Race.CAT_MORPH,
            AnusType.CAT_MORPH,
            null,
            null,
    ...
    public static final AbstractAssType HORSE_MORPH = new AbstractAssType(BodyCoveringType.HORSE_HAIR,
            Race.HORSE_MORPH,
    ...
    public static final AbstractAssType REINDEER_MORPH = new AbstractAssType(BodyCoveringType.REINDEER_FUR,
            Race.REINDEER_MORPH,
    ...
    public static final AbstractAssType HARPY = new AbstractAssType(BodyCoveringType.FEATHERS,
            Race.HARPY,
            AnusType.HARPY,
            null,
            null,
