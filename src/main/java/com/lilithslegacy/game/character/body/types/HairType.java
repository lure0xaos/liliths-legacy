...
public class HairType {
    ...
    public static final AbstractHairType HUMAN = new AbstractHairType(BodyCoveringType.HAIR_HUMAN,
            Race.HUMAN,
            "human",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType ANGEL = new AbstractHairType(BodyCoveringType.HAIR_ANGEL,
            Race.ANGEL,
            "angelic",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType DEMON = new AbstractHairType(BodyCoveringType.HAIR_DEMON,
            Race.DEMON,
            "demonic",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType DOG_MORPH = new AbstractHairType(BodyCoveringType.HAIR_CANINE_FUR,
            Race.DOG_MORPH,
            "dog",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType WOLF_MORPH = new AbstractHairType(BodyCoveringType.HAIR_LYCAN_FUR, //TODO rename
            Race.WOLF_MORPH,
            "wolf",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType FOX_MORPH = new AbstractHairType(BodyCoveringType.HAIR_FOX_FUR,
            Race.FOX_MORPH,
            "fox",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType CAT_MORPH = new AbstractHairType(BodyCoveringType.HAIR_FELINE_FUR, //TODO change to cat
            Race.CAT_MORPH,
            "cat",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType CAT_MORPH_SIDEFLUFF = new AbstractHairType(BodyCoveringType.HAIR_FELINE_FUR,
            Race.CAT_MORPH,
            "cat (sidefluff)",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType COW_MORPH = new AbstractHairType(BodyCoveringType.HAIR_BOVINE_FUR, //TODO change to cow
            Race.COW_MORPH,
            "cow",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType ALLIGATOR_MORPH = new AbstractHairType(BodyCoveringType.HAIR_SCALES_ALLIGATOR, //TODO change to hair
    ...
    public static final AbstractHairType SQUIRREL_MORPH = new AbstractHairType(BodyCoveringType.HAIR_SQUIRREL_FUR,
            Race.SQUIRREL_MORPH,
            "squirrel",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType RAT_MORPH = new AbstractHairType(BodyCoveringType.HAIR_RAT_FUR,
            Race.RAT_MORPH,
            "rat",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType RABBIT_MORPH = new AbstractHairType(BodyCoveringType.HAIR_RABBIT_FUR,
            Race.RABBIT_MORPH,
            "rabbit",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType BAT_MORPH = new AbstractHairType(BodyCoveringType.HAIR_BAT_FUR,
            Race.BAT_MORPH,
            "bat",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType HORSE_MORPH = new AbstractHairType(BodyCoveringType.HAIR_HORSE_HAIR,
            Race.HORSE_MORPH,
            "horse",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType REINDEER_MORPH = new AbstractHairType(BodyCoveringType.HAIR_REINDEER_FUR,
            Race.REINDEER_MORPH,
            "reindeer",
            "hair",
            "hairs",
    ...
    public static final AbstractHairType HARPY = new AbstractHairType(BodyCoveringType.HAIR_HARPY,
            Race.HARPY,
            "harpy",
            "head-feather",
            "head-feathers",
