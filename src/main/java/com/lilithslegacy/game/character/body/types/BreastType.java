...
public class BreastType {
    ...
    public static final AbstractBreastType NONE = new AbstractBreastType(BodyCoveringType.HUMAN,
            Race.NONE,
            NippleType.HUMAN,
    ...
    public static final AbstractBreastType HUMAN = new AbstractBreastType(BodyCoveringType.HUMAN,
            Race.HUMAN,
            NippleType.HUMAN,
            FluidType.MILK_HUMAN,
    ...
    public static final AbstractBreastType ANGEL = new AbstractBreastType(BodyCoveringType.ANGEL,
            Race.ANGEL,
            NippleType.ANGEL,
    ...
    public static final AbstractBreastType DEMON_COMMON = new AbstractBreastType(BodyCoveringType.DEMON_COMMON,
            Race.DEMON,
            NippleType.DEMON,
    ...
    public static final AbstractBreastType DOG_MORPH = new AbstractBreastType(BodyCoveringType.CANINE_FUR,
            Race.DOG_MORPH,
    ...
    public static final AbstractBreastType WOLF_MORPH = new AbstractBreastType(BodyCoveringType.LYCAN_FUR,
            Race.WOLF_MORPH,
    ...
    public static final AbstractBreastType FOX_MORPH = new AbstractBreastType(BodyCoveringType.FOX_FUR,
            Race.FOX_MORPH,
    ...
    public static final AbstractBreastType COW_MORPH = new AbstractBreastType(BodyCoveringType.BOVINE_FUR,
            Race.COW_MORPH,
    ...
    public static final AbstractBreastType CAT_MORPH = new AbstractBreastType(BodyCoveringType.FELINE_FUR,
            Race.CAT_MORPH,
    ...
    public static final AbstractBreastType SQUIRREL_MORPH = new AbstractBreastType(BodyCoveringType.SQUIRREL_FUR,
            Race.SQUIRREL_MORPH,
    ...
    public static final AbstractBreastType RAT_MORPH = new AbstractBreastType(BodyCoveringType.RAT_FUR,
            Race.RAT_MORPH,
    ...
    public static final AbstractBreastType RABBIT_MORPH = new AbstractBreastType(BodyCoveringType.RABBIT_FUR,
            Race.RABBIT_MORPH,
    ...
    public static final AbstractBreastType BAT_MORPH = new AbstractBreastType(BodyCoveringType.BAT_FUR,
            Race.BAT_MORPH,
    ...
    public static final AbstractBreastType ALLIGATOR_MORPH = new AbstractBreastType(BodyCoveringType.ALLIGATOR_SCALES,
    ...
    public static final AbstractBreastType HORSE_MORPH = new AbstractBreastType(BodyCoveringType.HORSE_HAIR,
            Race.HORSE_MORPH,
    ...
    public static final AbstractBreastType REINDEER_MORPH = new AbstractBreastType(BodyCoveringType.REINDEER_FUR,
            Race.REINDEER_MORPH,
    ...
    public static final AbstractBreastType HARPY = new AbstractBreastType(BodyCoveringType.FEATHERS,
            Race.HARPY,
            NippleType.HARPY,
