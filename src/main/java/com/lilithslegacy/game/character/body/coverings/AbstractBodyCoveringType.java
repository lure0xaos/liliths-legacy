...
public abstract class AbstractBodyCoveringType {
    ...
    public AbstractBodyCoveringType(BodyCoveringCategory category, BodyCoveringTemplate template) {
        ...
        this.allPatterns.putAll(this.naturalPatterns);
        if (dyePatterns != null) {
            this.allPatterns.putAll(this.dyePatterns);
        }
    ...
    public AbstractBodyCoveringType(Path XMLFile, String author, boolean mod) {
        if (Files.exists(XMLFile)) {
            try {
                ...
                if (this.naturalModifiers.isEmpty()) {
                    System.getLogger("").log(System.Logger.Level.ERROR, "WARNING: AbstractBodyCoveringType mod did not have any naturalModifiers defined! SMOOTH added for error-prevention.");
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "AbstractBodyCoveringType was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
    }
