...
public class EarType {
    ...
    public static final AbstractEarType HUMAN = new AbstractEarType(BodyCoveringType.HUMAN,
            Race.HUMAN,
            "human",
            "ear",
            "ears",
    ...
    public static final AbstractEarType ANGEL = new AbstractEarType(BodyCoveringType.ANGEL,
            Race.ANGEL,
            "angel",
            "ear",
            "ears",
    ...
    public static final AbstractEarType DEMON_COMMON = new AbstractEarType(BodyCoveringType.DEMON_COMMON,
            Race.DEMON,
            "demonic",
            "ear",
            "ears",
    ...
    public static final AbstractEarType DOG_MORPH = new AbstractEarType(BodyCoveringType.CANINE_FUR,
            Race.DOG_MORPH,
            "floppy dog",
            "ear",
            "ears",
    ...
    public static final AbstractEarType DOG_MORPH_POINTED = new AbstractEarType(BodyCoveringType.CANINE_FUR,
            Race.DOG_MORPH,
            "pointed dog",
            "ear",
            "ears",
    ...
    public static final AbstractEarType DOG_MORPH_FOLDED = new AbstractEarType(BodyCoveringType.CANINE_FUR,
            Race.DOG_MORPH,
            "folded dog",
            "ear",
            "ears",
    ...
    public static final AbstractEarType WOLF_MORPH = new AbstractEarType(BodyCoveringType.LYCAN_FUR,
            Race.WOLF_MORPH,
            "wolf",
            "ear",
            "ears",
    ...
    public static final AbstractEarType FOX_MORPH = new AbstractEarType(BodyCoveringType.FOX_FUR,
            Race.FOX_MORPH,
            "fox",
            "ear",
            "ears",
    ...
    public static final AbstractEarType FOX_MORPH_BIG = new AbstractEarType(BodyCoveringType.FOX_FUR,
            Race.FOX_MORPH,
            "fennec fox",
            "ear",
            "ears",
    ...
    public static final AbstractEarType COW_MORPH = new AbstractEarType(BodyCoveringType.BOVINE_FUR,
            Race.COW_MORPH,
            "cow",
            "ear",
            "ears",
    ...
    public static final AbstractEarType CAT_MORPH = new AbstractEarType(BodyCoveringType.FELINE_FUR,
            Race.CAT_MORPH,
            "cat",
            "ear",
            "ears",
    ...
    public static final AbstractEarType CAT_MORPH_TUFTED = new AbstractEarType(BodyCoveringType.FELINE_FUR,
            Race.CAT_MORPH,
            "tufted cat",
            "ear",
            "ears",
    ...
    public static final AbstractEarType SQUIRREL_MORPH = new AbstractEarType(BodyCoveringType.SQUIRREL_FUR,
            Race.SQUIRREL_MORPH,
            "squirrel",
            "ear",
            "ears",
    ...
    public static final AbstractEarType RAT_MORPH = new AbstractEarType(BodyCoveringType.RAT_FUR,
            Race.RAT_MORPH,
            "rat",
            "ear",
            "ears",
    ...
    public static final AbstractEarType RABBIT_MORPH = new AbstractEarType(BodyCoveringType.RABBIT_FUR,
            Race.RABBIT_MORPH,
            "upright rabbit",
            "ear",
            "ears",
    ...
    public static final AbstractEarType RABBIT_MORPH_FLOPPY = new AbstractEarType(BodyCoveringType.RABBIT_FUR,
            Race.RABBIT_MORPH,
            "floppy rabbit",
            "ear",
            "ears",
    ...
    public static final AbstractEarType BAT_MORPH = new AbstractEarType(BodyCoveringType.BAT_FUR,
            Race.BAT_MORPH,
            "bat",
            "ear",
            "ears",
    ...
    public static final AbstractEarType HORSE_MORPH = new AbstractEarType(BodyCoveringType.HORSE_HAIR,
            Race.HORSE_MORPH,
            "horse",
            "ear",
            "ears",
    ...
    public static final AbstractEarType HORSE_MORPH_UPRIGHT = new AbstractEarType(BodyCoveringType.HORSE_HAIR,
            Race.HORSE_MORPH,
            "tall horse",
            "ear",
            "ears",
    ...
    public static final AbstractEarType REINDEER_MORPH = new AbstractEarType(BodyCoveringType.REINDEER_FUR,
            Race.REINDEER_MORPH,
            "reindeer",
            "ear",
            "ears",
    ...
    public static final AbstractEarType ALLIGATOR_MORPH = new AbstractEarType(BodyCoveringType.ALLIGATOR_SCALES,
    ...
    public static final AbstractEarType HARPY = new AbstractEarType(BodyCoveringType.FEATHERS,
            Race.HARPY,
            "harpy",
            "ear",
            "ears",
