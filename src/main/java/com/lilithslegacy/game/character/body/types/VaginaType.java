...
public class VaginaType {
    ...
    public static final AbstractVaginaType ONAHOLE = new AbstractVaginaType(BodyCoveringType.DILDO,
    ...
    public static final AbstractVaginaType NONE = new AbstractVaginaType(BodyCoveringType.VAGINA,
            FluidType.GIRL_CUM_HUMAN,
            Race.NONE,
            false,
    ...
    public static final AbstractVaginaType HUMAN = new AbstractVaginaType(BodyCoveringType.VAGINA,
            FluidType.GIRL_CUM_HUMAN,
            Race.HUMAN,
            false,
            Util.newArrayListOfValues(""),
    ...
    public static final AbstractVaginaType ANGEL = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType DEMON_COMMON = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType DOG_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
...
//		}
//	};
    public static final AbstractVaginaType WOLF_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType FOX_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType CAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType SQUIRREL_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType RAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType RABBIT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType BAT_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType ALLIGATOR_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType COW_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType HORSE_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType REINDEER_MORPH = new AbstractVaginaType(BodyCoveringType.VAGINA,
    ...
    public static final AbstractVaginaType HARPY = new AbstractVaginaType(BodyCoveringType.VAGINA,
