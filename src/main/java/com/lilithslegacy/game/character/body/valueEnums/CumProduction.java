...
public enum CumProduction {
    ...
    private final int arousalNeededToStartPreCumming;
    private final Wetness associatedWetness;
    private final Colour colour;
    private final int additionalSlotsDirtiedUponOrgasm;

    CumProduction(String name, String descriptor, int minimumValue, int maximumValue, int arousalNeededToStartPreCumming, Wetness associatedWetness, Colour colour, int additionalSlotsDirtiedUponOrgasm) {
        this.name = name;
