...
import com.lilithslegacy.game.character.body.types.OrificeInterface;
...
public class OrificeNipples implements OrificeInterface {
    ...
    protected final Set<OrificeModifier> orificeModifiers;

    protected final boolean crotchNipples;
