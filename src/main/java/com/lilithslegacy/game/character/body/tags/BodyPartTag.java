package com.lilithslegacy.game.character.body.tags;
...
public enum BodyPartTag {
    ...
    public static final List<BodyPartTag> allBodyPartTags = new ArrayList<>();
    public static final Map<BodyPartTag, String> bodypartTagToIdMap = new HashMap<>();
    public static final Map<String, BodyPartTag> idToBodypartTagMap = new HashMap<>();
