...
public abstract class AbstractFaceType implements BodyPartTypeInterface {
    ...
    public AbstractFaceType(Path XMLFile, String author, boolean mod) {
        if (Files.exists(XMLFile)) {
            try {
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "AbstractFaceType was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
    }
