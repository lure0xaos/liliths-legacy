...
public enum OrificeElasticity {
    ...
    private final float stretchModifier;
    private final float sizeTolerancePercentage;
    private final boolean extendingUncomfortableDepth;
     ...
     */
    OrificeElasticity(String descriptor, int value, float stretchModifier, float sizeTolerancePercentage, boolean extendingUncomfortableDepth, Colour colour) {
