...
public enum BodyMaterial {
    ...
    private final String skinNoun;
    private final String skinAdj;
    private final String skinAltNoun;
    private final String skinAltAdj;
    private final String orificeNoun;
    private final String orificeAdj;
    private final String orificeAltNoun;
    private final String orificeAltAdj;
    private final String hairNoun;
    private final String hairAdj;
    private final String hairBodyNoun;
    private final String hairBodyAdj;
    private final String hairAltNoun;
    private final String hairAltAdj;
    private final String furNoun;
    private final String furAdj;
    private final String furAltNoun;
    private final String furAltAdj;
    private final String featherNoun;
    private final String featherAdj;
    private final String featherAltNoun;
    private final String featherAltAdj;
    private final String scaleNoun;
    private final String scaleAdj;
    private final String scaleAltNoun;
    private final String scaleAltAdj;
    private final String shellNoun;
    private final String shellAdj;
    private final String shellAltNoun;
    private final String shellAltAdj;
    private final String keratinNoun;
    private final String keratinAdj;
    private final String keratinAltNoun;
    private final String keratinAltAdj;
    private final List<String> partDescriptors;

    private final Colour colour;
    private final DamageType unarmedDamageType;

    private final boolean requiresPiercing;
    private final boolean orificesAlwaysMaximumWetness;
    private final boolean ableToWearMakeup;

    BodyMaterial(String name,
    ...
    BodyMaterial(String noun, String adjective, Colour colour, DamageType unarmedDamageType, boolean requiresPiercing, boolean orificesAlwaysMaximumWetness, boolean ableToWearMakeup) {
        this.name = noun;
        this.skinNoun = noun;
    ...
    BodyMaterial(String noun, Colour colour, DamageType unarmedDamageType, boolean requiresPiercing, boolean orificesAlwaysMaximumWetness, boolean ableToWearMakeup) {
        this.name = noun;
        this.skinNoun = noun;
        this.skinAdj = noun;
        this.skinAltNoun = noun;
