...
public enum BodyMaterial {
    ...
    private String name;
    private String skinNoun;
    private String skinAdj;
    private String skinAltNoun;
    private String skinAltAdj;
    private String orificeNoun;
    private String orificeAdj;
    private String orificeAltNoun;
    private String orificeAltAdj;
    private String hairNoun;
    private String hairAdj;
    private String hairBodyNoun;
    private String hairBodyAdj;
    private String hairAltNoun;
    private String hairAltAdj;
    private String furNoun;
    private String furAdj;
    private String furAltNoun;
    private String furAltAdj;
    private String featherNoun;
    private String featherAdj;
    private String featherAltNoun;
    private String featherAltAdj;
    private String scaleNoun;
    private String scaleAdj;
    private String scaleAltNoun;
    private String scaleAltAdj;
    private String shellNoun;
    private String shellAdj;
    private String shellAltNoun;
    private String shellAltAdj;
    private String keratinNoun;
    private String keratinAdj;
    private String keratinAltNoun;
    private String keratinAltAdj;
