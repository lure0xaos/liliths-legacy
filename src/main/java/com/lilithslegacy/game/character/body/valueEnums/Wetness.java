...
public enum Wetness {
    ...
    private final int arousalNeededToGetVaginaWet;
    private final int arousalNeededToGetAssWet;
    private final String descriptor;
    private final Colour colour;

    Wetness(String descriptor, int wetness, int arousalNeededToGetVaginaWet, int arousalNeededToGetAssWet, Colour colour) {
