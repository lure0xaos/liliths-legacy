...
public enum OrificePlasticity {
    ...
    private final float capacityIncreaseModifier;
    private final float recoveryModifier;
    private final Colour colour;

    OrificePlasticity(String descriptor, String description, String descriptionPlural, int value, float capacityIncreaseModifier, float recoveryModifier, Colour colour) {
