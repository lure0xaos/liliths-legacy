...
public class BodyCoveringSkinToneColorHelper {
    ...
    private static final Map<StartingSkinTone, Map<AbstractBodyCoveringType, FilteredColours>> filteredColours = new EnumMap<>(StartingSkinTone.class);
    ...
    private static FilteredColours getOrCreateFilteredColoursForCombination(StartingSkinTone tone, AbstractBodyCoveringType bct) {
        ...
        return filteredColours.computeIfAbsent(tone, ignored -> new ConcurrentHashMap<>()).computeIfAbsent(bct, ignored -> {
            ...
            Set<Colour> colourApplicationListPrimary = new HashSet<>(bct.getNaturalColoursPrimary());
            ...
            Set<Colour> colourApplicationListSecondary = new HashSet<>(bct.getNaturalColoursSecondary());
    ...
    private static class FilteredColours {
        private final List<Colour> primary;
        private final List<Colour> secondary;
