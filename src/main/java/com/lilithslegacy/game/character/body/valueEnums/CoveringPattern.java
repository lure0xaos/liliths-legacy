...
public enum CoveringPattern {
    ...
    public static final Map<CoveringPattern, Integer> allStandardCoveringPatterns = new HashMap<>();
    public static final Map<CoveringPattern, Integer> allHairCoveringPatterns = new HashMap<>();
    public static final Map<CoveringPattern, Integer> allScalesCoveringPatterns = new HashMap<>();
    public static final Map<CoveringPattern, Integer> allSlimeCoveringPatterns = new HashMap<>();
    public static final Map<CoveringPattern, Integer> allSiliconeCoveringPatterns = new HashMap<>();
    ...
    private final boolean naturalSecondColour;

    CoveringPattern(boolean naturalSecondColour, String name) {
