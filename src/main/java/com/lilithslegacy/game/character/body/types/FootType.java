...
public class FootType {
    ...
    public static final AbstractFootType NONE = new AbstractFootType("none",
            "none",
            "none",
    ...
    public static final AbstractFootType HUMANOID = new AbstractFootType("humanoid",
            "foot",
            "feet",
    ...
    public static final AbstractFootType PAWS = new AbstractFootType("paw-like",
            "paw",
            "paws",
    ...
    public static final AbstractFootType HOOFS = new AbstractFootType("hoof-like",
            "hoof",
            "hoofs",
    ...
    public static final AbstractFootType TALONS = new AbstractFootType("bird-like",
            "talon",
            "talons",
            Util.newArrayListOfValues("masculine", "clawed"),
            Util.newArrayListOfValues("feminine", "clawed", "slender"),
    ...
    public static final AbstractFootType ARACHNID = new AbstractFootType("arachnid",
            "foot",
            "feet",
    ...
    public static final AbstractFootType TENTACLE = new AbstractFootType("tentacle",
            "tentacle",
            "tentacles",
