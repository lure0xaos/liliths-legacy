...
//			null);
    ...
    private static final Map<AbstractTattooType, String> tattooToIdMap = new HashMap<>();
    private static final Map<String, AbstractTattooType> idToTattooMap = new HashMap<>();
        ...
        for (Entry<String, Map<String, Path>> entry : moddedFilesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded tattoo failed at 'TattooType'. File path: " + innerEntry.getValue());
...
//					System.out.println("TT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading tattoo failed at 'TattooType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
