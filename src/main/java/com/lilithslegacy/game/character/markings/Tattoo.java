...
public class Tattoo extends AbstractCoreItem implements XMLSaving {
    ...
    private static final Map<Colour, String> SVGGlowMap = new HashMap<>();
    protected List<ItemEffect> effects;
    protected final Map<AbstractAttribute, Integer> attributeModifiers;
    ...
    public static Tattoo loadFromXML(Element parentElement, Document doc) {
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Warning: An instance of Tattoo was unable to be imported!");
            return null;
        }
    }
    ...
    private String getSVGGlow() {
        ...
        if (stringFromMap != null) {
            ...
            try {
                ...
                is = FS.newResourceAsStream("/com/lilithslegacy/res/tattoos/glow.svg");
