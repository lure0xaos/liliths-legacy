...
public abstract class AbstractRace {
    ...
    public AbstractRace(String name,
        ...
        for (Affinity affinity : Affinity.getAllAffinities()) {
            if (!nameFeral.containsKey(new LegConfigurationAffinity(LegConfiguration.BIPEDAL, affinity))) {
                System.getLogger("").log(System.Logger.Level.ERROR, "Warning: AbstractRace '" + name + "' did not have a definition for nameFeral BIPEDAL and affinity = " + affinity + "!");
        ...
        for (Affinity affinity : Affinity.getAllAffinities()) {
            if (!nameFeralPlural.containsKey(new LegConfigurationAffinity(LegConfiguration.BIPEDAL, affinity))) {
                System.getLogger("").log(System.Logger.Level.ERROR, "Warning: AbstractRace '" + name + "' did not have a definition for nameFeralPlural BIPEDAL and affinity = " + affinity + "!");
    ...
    public AbstractRace(Path XMLFile, String author, boolean mod) {
            ...
            try {
                ...
                if (coreElement.getOptionalFirstOf("nameFeral").isPresent()) {
                    for (Element e : coreElement.getMandatoryFirstOf("nameFeral").getAllOf("name")) {
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "Error in AbstractRace loading: LegConfiguration '" + e.getAttribute("legConfiguration") + "' not recognised in nameFeral!");
                ...
                if (coreElement.getOptionalFirstOf("nameFeralPlural").isPresent()) {
                    for (Element e : coreElement.getMandatoryFirstOf("nameFeralPlural").getAllOf("name")) {
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "Error in AbstractRace loading: LegConfiguration '" + e.getAttribute("legConfiguration") + "' not recognised in nameFeralPlural!");
                            System.getLogger("").log(System.Logger.Level.ERROR, ex.getMessage(), ex);
                        }
                    }
                }
                ...
                if (coreElement.getOptionalFirstOf("combatBehaviour").isPresent()) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Error in AbstractRace loading: CombatBehaviour '" + coreElement.getMandatoryFirstOf("combatBehaviour").getTextContent() + "' not recognised!");
                    }
                }
                ...
                if (coreElement.getOptionalFirstOf("racialFetishModifiers").isPresent()) {
                    for (Element e : coreElement.getMandatoryFirstOf("racialFetishModifiers").getAllOf("fetish")) {
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "Error in AbstractRace loading: Fetish '" + e.getTextContent() + "' not recognised in racialFetishModifiers!");
                            System.getLogger("").log(System.Logger.Level.ERROR, ex.getMessage(), ex);
                        }
                    }
                }
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, ex.getMessage(), ex);
                System.getLogger("").log(System.Logger.Level.ERROR, "AbstractRace was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
    }
    ...
    public AbstractRacialBody getRacialBody() {
        ...
        System.getLogger("").log(System.Logger.Level.ERROR, "Warning: AbstractRacialBody is calling getRacialBody() where racialBodyId does not exist!");
        return null;
    }
