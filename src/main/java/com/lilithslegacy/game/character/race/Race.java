...
public class Race {
    ...
    public static final AbstractRace NONE = new AbstractRace("no race",
            "no race",
            "no race",
            "no race",
            "none",
    ...
    // HUMAN:
    public static final AbstractRace HUMAN = new AbstractRace("human",
            "humans",
            "human",
            "humans",
            "human",
    ...
    // ANGEL:
    public static final AbstractRace ANGEL = new AbstractRace("angel",
            "angels",
            "angel",
            "angels",
            "angelic",
    ...
    // BOVINES:
    public static final AbstractRace COW_MORPH = new AbstractRace("cattle-morph",
            "cattle-morphs",
            "cattle",
            "cattle",
            "cattle",
    ...
    // CANINES:
    public static final AbstractRace DOG_MORPH = new AbstractRace("dog-morph",
            "dog-morphs",
            "dog",
            "dogs",
            "dog",
    ...
    public static final AbstractRace WOLF_MORPH = new AbstractRace("wolf-morph",
            "wolf-morphs",
            "wolf",
            "wolves",
            "wolf",
    ...
    public static final AbstractRace DEMON = new AbstractRace("demon",
            "demons",
...
//		}
    ...
    public static final AbstractRace FOX_MORPH = new AbstractRace("fox-morph",
            "fox-morphs",
            "fox",
            "foxes",
            "fox",
    ...
    // FELINES:
    public static final AbstractRace CAT_MORPH = new AbstractRace("cat-morph",
            "cat-morphs",
            "cat",
            "cats",
            "cat",
    ...
    // EQUINE:
    public static final AbstractRace HORSE_MORPH = new AbstractRace("horse-morph",
            "horse-morphs",
            "horse",
            "horses",
            "horse",
    ...
    public static final AbstractRace REINDEER_MORPH = new AbstractRace("reindeer-morph",
            "reindeer-morphs",
            "reindeer",
            "reindeers",
            "reindeer",
    ...
    public static final AbstractRace SQUIRREL_MORPH = new AbstractRace("squirrel-morph",
            "squirrel-morphs",
            "squirrel",
            "squirrels",
            "squirrel",
...
//			FurryPreference.NORMAL,
//			true),
    public static final AbstractRace RAT_MORPH = new AbstractRace("rat-morph",
            "rat-morphs",
            "rat",
            "rats",
            "rat",
    ...
    public static final AbstractRace RABBIT_MORPH = new AbstractRace("rabbit-morph",
            "rabbit-morphs",
            "rabbit",
            "rabbits",
            "rabbit",
    ...
    public static final AbstractRace BAT_MORPH = new AbstractRace("bat-morph",
            "bat-morphs",
            "bat",
            "bats",
            "bat",
    ...
    public static final AbstractRace ALLIGATOR_MORPH = new AbstractRace("alligator-morph",
            "alligator-morphs",
            "alligator",
            "alligators",
            "alligator",
    ...
    // AVIAN:
    public static final AbstractRace HARPY = new AbstractRace("harpy",
            "harpies",
            "bird",
            "birds",
            "harpy",
    ...
    // SLIME:
    public static final AbstractRace SLIME = new AbstractRace("slime",
            "slimes",
            "slime",
            "slimes",
            "slime",
    ...
    // DOLLS:
    public static final AbstractRace DOLL = new AbstractRace("doll",
            "dolls",
            "doll",
            "dolls",
            "doll",
    ...
    // ELEMENTALS:
    public static final AbstractRace ELEMENTAL = new AbstractRace("elemental",
            "elementals",
            "elemental",
            "elementals",
            "elemental",
    ...
    // ********** SPECIAL RACES ********** //
    public static final List<AbstractRace> allRaces;
    public static final Map<AbstractRace, String> raceToIdMap = new HashMap<>();
    public static final Map<String, AbstractRace> idToRaceMap = new HashMap<>();
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/race", null, "race");
...
//						System.out.println("race: "+id);
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded race failed at 'Race'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/race", null, "race");
            ...
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                if (Util.getXmlRootElementName(innerEntry.getValue()).equals("race")) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading race failed at 'Race'. File path: " + innerEntry.getValue());
                        System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                        ex.printStackTrace(System.err);
                    }
                }
