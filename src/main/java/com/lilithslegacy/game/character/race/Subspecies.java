...
//	};
    ...
    // HUMAN:
    public static final AbstractSubspecies HUMAN = new AbstractSubspecies(true,
            4000,
    ...
    public static final AbstractSubspecies IMP = new AbstractSubspecies(false,
            1000,
    ...
    public static final AbstractSubspecies IMP_ALPHA = new AbstractSubspecies(false,
            1000,
            "innoxia_race_imp_impish_brew",
            null,
    ...
    public static final AbstractSubspecies ELDER_LILIN = new AbstractSubspecies(false,
            1000000000,
    ...
    // BOVINES:
    public static final AbstractSubspecies COW_MORPH = new AbstractSubspecies(true,
            15000,
    ...
    public static final AbstractSubspecies LILIN = new AbstractSubspecies(false,
            500000000,
            "innoxia_race_demon_liliths_gift",
            null,
    ...
    public static final AbstractSubspecies FOX_MORPH = new AbstractSubspecies(true,
            16000,
    ...
    public static final AbstractSubspecies DEMON = new AbstractSubspecies(true,
            120000,
            "innoxia_race_demon_liliths_gift",
            null,
    ...
    public static final AbstractSubspecies HALF_DEMON = new AbstractSubspecies(false,
            50000,
            "innoxia_race_demon_liliths_gift",
            null,
            "statusEffects/race/raceDemon",
    ...
    // FELINES:
    public static final AbstractSubspecies CAT_MORPH = new AbstractSubspecies(true,
            12000,
    ...
    public static final AbstractSubspecies CAT_MORPH_CHEETAH = new AbstractSubspecies(false,
            16000,
            "innoxia_race_cat_felines_fancy",
            "innoxia_race_cat_kittys_reward",
            "statusEffects/race/raceCatMorph",
    ...
    public static final AbstractSubspecies CENTAUR = new AbstractSubspecies(false,
            25000,
    ...
    public static final AbstractSubspecies PEGATAUR = new AbstractSubspecies(false,
            35000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies UNITAUR = new AbstractSubspecies(false,
            50000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies ALITAUR = new AbstractSubspecies(false,
            100000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies REINDEER_MORPH = new AbstractSubspecies(true,
            18000,
    ...
    // REPTILE:
    public static final AbstractSubspecies ALLIGATOR_MORPH = new AbstractSubspecies(true,
            10000,
    ...
    // RODENTS:
    public static final AbstractSubspecies SQUIRREL_MORPH = new AbstractSubspecies(true,
            6000,
    ...
    public static final AbstractSubspecies FOX_ASCENDANT = new AbstractSubspecies(false,
            15000,
            "innoxia_race_fox_vulpines_vineyard",
            "innoxia_race_fox_chicken_pot_pie",
            "statusEffects/race/raceFoxMorph",
...
//						new Value<>(Attribute.MAJOR_CORRUPTION, 0f),
    ...
    public static final AbstractSubspecies RAT_MORPH = new AbstractSubspecies(true,
            6000,
    ...
    public static final AbstractSubspecies FOX_ASCENDANT_ARCTIC = new AbstractSubspecies(false,
            15000,
            "innoxia_race_fox_vulpines_vineyard",
            "innoxia_race_fox_chicken_pot_pie",
            "statusEffects/race/raceFoxMorph",
...
//						new Value<>(Attribute.MAJOR_CORRUPTION, 0f),
    ...
    public static final AbstractSubspecies BAT_MORPH = new AbstractSubspecies(true,
            10000,
    ...
    public static final AbstractSubspecies FOX_ASCENDANT_FENNEC = new AbstractSubspecies(false,
            15000,
            "innoxia_race_fox_vulpines_vineyard",
            "innoxia_race_fox_chicken_pot_pie",
            "statusEffects/race/raceFoxMorph",
...
//						new Value<>(Attribute.MAJOR_CORRUPTION, 0f),
    ...
    public static final List<AbstractSubspecies> allSubspecies;
    public static final Map<AbstractSubspecies, String> subspeciesToIdMap = new HashMap<>();
    public static final Map<String, AbstractSubspecies> idToSubspeciesMap = new HashMap<>();
    protected static final Map<AbstractSubspecies, SubspeciesSpawnRarity> dominionStormImmuneSpecies;
...
//		}
//	};
    protected static final Map<AbstractRace, List<AbstractSubspecies>> subspeciesFromRace;
    // ANGEL:
    public static final AbstractSubspecies ANGEL = new AbstractSubspecies(true,
            80000,
    ...
    // CANIDS:
    public static final AbstractSubspecies DOG_MORPH = new AbstractSubspecies(true,
            12000,
    ...
    public static final AbstractSubspecies DOG_MORPH_BORDER_COLLIE = new AbstractSubspecies(false,
            24000,
            "innoxia_race_dog_canine_crush",
            "innoxia_race_dog_canine_crunch",
            "statusEffects/race/raceDogMorph",
    ...
    public static final AbstractSubspecies DOG_MORPH_DOBERMANN = new AbstractSubspecies(false,
            18000,
            "innoxia_race_dog_canine_crush",
            "innoxia_race_dog_canine_crunch",
    ...
    public static final AbstractSubspecies DOG_MORPH_GERMAN_SHEPHERD = new AbstractSubspecies(false,
            18000,
            "innoxia_race_dog_canine_crush",
            "innoxia_race_dog_canine_crunch",
            "statusEffects/race/raceDogMorph",
    ...
    public static final AbstractSubspecies WOLF_MORPH = new AbstractSubspecies(true,
            10000,
    ...
    // EQUINES:
    public static final AbstractSubspecies HORSE_MORPH = new AbstractSubspecies(true,
            18000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies HORSE_MORPH_UNICORN = new AbstractSubspecies(false,
            30000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies HORSE_MORPH_ALICORN = new AbstractSubspecies(false,
            60000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
    ...
    public static final AbstractSubspecies HORSE_MORPH_ZEBRA = new AbstractSubspecies(false,
            18000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
...
//						return 125;
    ...
    public static final AbstractSubspecies HORSE_MORPH_DONKEY = new AbstractSubspecies(false,
            12000,
            "innoxia_race_horse_equine_cider",
            "innoxia_race_horse_sugar_carrot_cube",
            "statusEffects/race/raceHorseMorph",
...
//					return 110; // Less than zebra
    ...
    public static final AbstractSubspecies RABBIT_MORPH = new AbstractSubspecies(true,
            12000,
    ...
    public static final AbstractSubspecies RABBIT_MORPH_LOP = new AbstractSubspecies(false,
            12000,
            "innoxia_race_rabbit_bunny_juice",
            "innoxia_race_rabbit_bunny_carrot_cake",
    ...
    // AVIAN:
    public static final AbstractSubspecies HARPY = new AbstractSubspecies(true,
            12000,
    ...
    public static final AbstractSubspecies HARPY_SWAN = new AbstractSubspecies(false,
            22000,
            "innoxia_race_harpy_harpy_perfume",
            "innoxia_race_harpy_bubblegum_lollipop",
            "statusEffects/race/raceHarpy",
    ...
    // DOLLS:
    public static final AbstractSubspecies DOLL = new AbstractSubspecies(true,
            10000,
...
//		}
//	};
    private static final Map<WorldRegion, Map<AbstractSubspecies, SubspeciesSpawnRarity>> regionSpecies;

    // ********** SPECIAL SUBSPECIES ********** //
    private static final Map<AbstractWorldType, Map<AbstractSubspecies, SubspeciesSpawnRarity>> worldSpecies;    // SLIMES:
    public static final AbstractSubspecies SLIME = new AbstractSubspecies(true,
            10000,
    ...
    private static final Map<AbstractPlaceType, Map<AbstractSubspecies, SubspeciesSpawnRarity>> placeSpecies;

    // ELEMENTALS:

    public static final AbstractSubspecies ELEMENTAL_FIRE = new AbstractSubspecies(false,
            100000,
            "innoxia_race_demon_liliths_gift",
            null,
        ...
        @Override
        public String getSVGString(GameCharacter character) {
            if ((character instanceof Elemental) && ((Elemental) character).getSummoner() != null && !((Elemental) character).getSummoner().isElementalActive()) {
                if (((Elemental) character).getPassiveForm() == null) {
                    return SvgUtil.colourReplacement(Subspecies.getIdFromSubspecies(ELEMENTAL_FIRE),
    ...
    public static final AbstractSubspecies ELEMENTAL_EARTH = new AbstractSubspecies(false,
            100000,
            "innoxia_race_demon_liliths_gift",
            null,
            "statusEffects/race/raceElemental",
        ...
        public String getSVGString(GameCharacter character) {
            if ((character instanceof Elemental) && ((Elemental) character).getSummoner() != null && !((Elemental) character).getSummoner().isElementalActive()) {
                if (((Elemental) character).getPassiveForm() == null) {
                    return SvgUtil.colourReplacement(Subspecies.getIdFromSubspecies(ELEMENTAL_EARTH),
                            this.getColour(character),
                            this.getColour(character),
                            this.getColour(character),
                            "<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>" + SVGImages.SVG_IMAGE_PROVIDER.getRaceWisp() + "</div>");
    ...
    public static final AbstractSubspecies ELEMENTAL_WATER = new AbstractSubspecies(false,
            100000,
            "innoxia_race_demon_liliths_gift",
            null,
            "statusEffects/race/raceElemental",
        ...
        public String getSVGString(GameCharacter character) {
            if ((character instanceof Elemental) && ((Elemental) character).getSummoner() != null && !((Elemental) character).getSummoner().isElementalActive()) {
                if (((Elemental) character).getPassiveForm() == null) {
                    return SvgUtil.colourReplacement(Subspecies.getIdFromSubspecies(ELEMENTAL_WATER),
                            this.getColour(character),
                            this.getColour(character),
                            this.getColour(character),
                            "<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>" + SVGImages.SVG_IMAGE_PROVIDER.getRaceWisp() + "</div>");
    ...
    public static final AbstractSubspecies ELEMENTAL_AIR = new AbstractSubspecies(false,
            100000,
            "innoxia_race_demon_liliths_gift",
            null,
            "statusEffects/race/raceElemental",
        ...
        public String getSVGString(GameCharacter character) {
            if ((character instanceof Elemental) && ((Elemental) character).getSummoner() != null && !((Elemental) character).getSummoner().isElementalActive()) {
                if (((Elemental) character).getPassiveForm() == null) {
                    return SvgUtil.colourReplacement(Subspecies.getIdFromSubspecies(ELEMENTAL_AIR),
                            this.getColour(character),
                            this.getColour(character),
                            this.getColour(character),
                            "<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>" + SVGImages.SVG_IMAGE_PROVIDER.getRaceWisp() + "</div>");
    ...
    public static final AbstractSubspecies ELEMENTAL_ARCANE = new AbstractSubspecies(true,
            100000,
            "innoxia_race_demon_liliths_gift",
            null,
            "statusEffects/race/raceElemental",
        ...
        public String getSVGString(GameCharacter character) {
            if ((character instanceof Elemental) && ((Elemental) character).getSummoner() != null && !((Elemental) character).getSummoner().isElementalActive()) {
                if (((Elemental) character).getPassiveForm() == null) {
                    return SvgUtil.colourReplacement(Subspecies.getIdFromSubspecies(ELEMENTAL_ARCANE),
                            this.getColour(character),
                            this.getColour(character),
                            this.getColour(character),
                            "<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>" + SVGImages.SVG_IMAGE_PROVIDER.getRaceWisp() + "</div>");
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/race", "subspecies", null);
...
//						System.out.println("subspecies: "+id);
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded subspecies failed at 'Subspecies'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/race", "subspecies", null);
            ...
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                if (Util.getXmlRootElementName(innerEntry.getValue()).equals("subspecies")) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "Loading subspecies failed at 'Subspecies'. File path: " + innerEntry.getValue());
                        System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                        ex.printStackTrace(System.err);
                    }
                }
