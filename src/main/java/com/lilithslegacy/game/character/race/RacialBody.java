...
public class RacialBody {
    ...
    public static final AbstractRacialBody HUMAN = new AbstractRacialBody(
    ...
    public static final AbstractRacialBody ANGEL = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.ANGEL, 1,
    ...
    public static final AbstractRacialBody DEMON = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody COW_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.COW_MORPH, 1,
    ...
    public static final AbstractRacialBody DOG_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.DOG_MORPH, 1,
    ...
    public static final AbstractRacialBody FOX_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.FOX_MORPH, 1,
    ...
    public static final AbstractRacialBody WOLF_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody CAT_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.CAT_MORPH, 1,
    ...
    public static final AbstractRacialBody HORSE_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody REINDEER_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody ALLIGATOR_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody SQUIRREL_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody RAT_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.RAT_MORPH, 1,
    ...
    public static final AbstractRacialBody RABBIT_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
    ...
    public static final AbstractRacialBody BAT_MORPH = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.BAT_MORPH, 1,
    ...
    public static final AbstractRacialBody HARPY = new AbstractRacialBody(
            Util.newArrayListOfValues(AntennaType.NONE),
            ArmType.HARPY, 1,
    ...
    public static final List<AbstractRacialBody> allRacialBodies;
    public static final Map<AbstractRacialBody, String> RacialBodyToIdMap = new HashMap<>();
    public static final Map<String, AbstractRacialBody> idToRacialBodyMap = new HashMap<>();
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/race", null, "racialBody");
        for (Entry<String, Map<String, Path>> entry : moddedFilesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded racialBody failed at 'RacialBody'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/race", null, "racialBody");
        for (Entry<String, Map<String, Path>> entry : filesMap.entrySet()) {
            for (Entry<String, Path> innerEntry : entry.getValue().entrySet()) {
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading racialBody failed at 'RacialBody'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
