...
public class FeralAttributes {
    ...
    private final String feralName;
    private final String feralNamePlural;
    private final String feralSingularMaleName;
    private final String feralSingularFemaleName;
    private final String feralPluralMaleName;
    private final String feralPluralFemaleName;

    private final LegConfiguration legConfiguration;
    private final boolean sizeHeight;
    private final int size;
    private final float serpentTailLength;

    private final boolean armsOrWingsPresent;
    private final boolean fingerActionsAvailable;
    private final boolean hairPresent;

    private final int breastRowCount;
    private final int nipplesPerBreastCount;
    private final int crotchBreastRowCount;
    private final int nipplesPerCrotchBreastCount;
