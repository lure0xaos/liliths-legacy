...
public abstract class AbstractRacialBody {
    ...
    public AbstractRacialBody(Path XMLFile, String author, boolean mod) {
                ...
                if (coreElement.getOptionalFirstOf("personalityChances").isPresent()) {
                    for (Element e : coreElement.getMandatoryFirstOf("personalityChances").getAllOf("entry")) {
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "AbstractRacialBody error: PersonalityTrait '" + e.getTextContent() + "' failed to load!");
                        }
                    }
                }
