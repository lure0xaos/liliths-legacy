...
public class Attribute {
    ...
    public static final AbstractAttribute HEALTH_MAXIMUM = new AbstractAttribute(false,
            0,
            1,
            1000,
            "health",
    ...
    public static final AbstractAttribute MANA_MAXIMUM = new AbstractAttribute(false,
            0,
            1,
            1000,
            "aura",
    ...
    public static final AbstractAttribute EXPERIENCE = new AbstractAttribute(false,
            0,
            0,
            1000000,
            "experience",
    ...
    public static final AbstractAttribute ACTION_POINTS = new AbstractAttribute(false,
            0,
            0,
            10,
            "action points",
    ...
    public static final AbstractAttribute AROUSAL = new AbstractAttribute(false,
            0,
            0,
            100,
            "arousal",
    ...
    public static final AbstractAttribute LUST = new AbstractAttribute(false,
            0,
            0,
            100,
            "lust",
    ...
    public static final AbstractAttribute RESTING_LUST = new AbstractAttribute(false,
            0,
            0,
            80,
            "resting lust",
    ...
    public static final AbstractAttribute MAJOR_PHYSIQUE = new AbstractAttribute(false,
            0,
            0,
            100,
            "physique",
    ...
    public static final AbstractAttribute MAJOR_ARCANE = new AbstractAttribute(false,
            0,
            0,
            100,
            "arcane",
    ...
    public static final AbstractAttribute MAJOR_CORRUPTION = new AbstractAttribute(false,
            0,
            0,
            100,
            "corruption",
    ...
    public static final AbstractAttribute ENCHANTMENT_LIMIT = new AbstractAttribute(false,
            0,
            0,
            1000,
    ...
    public static final AbstractAttribute FERTILITY = new AbstractAttribute(true, 10, -100, 100, "fertility", "Fertility", "shieldIcon", PresetColour.GENERIC_SEX, "fertility", "infertility", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute VIRILITY = new AbstractAttribute(true, 10, -100, 100, "virility", "Virility", "shieldIcon", PresetColour.GENERIC_SEX, "virility", "sterility", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute SPELL_COST_MODIFIER = new AbstractAttribute(true, 0, 0, 80, "spell efficiency", "Spell efficiency", "shieldIcon", PresetColour.ATTRIBUTE_MANA, "proficiency", "incompetence", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute CRITICAL_DAMAGE = new AbstractAttribute(true, 150, 100, 500, "critical power", "Critical power", "shieldIcon", PresetColour.ATTRIBUTE_HEALTH, "impact", "failure", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute ENERGY_SHIELDING = new AbstractAttribute(false, 0, -100, 500, "health shielding", "Health shielding", "shieldIcon", PresetColour.ATTRIBUTE_HEALTH, "endurance", "vulnerability", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute RESISTANCE_PHYSICAL = new AbstractAttribute(false, 0, -100, 500, "physical shielding", "Physical shielding", "shieldIcon", PresetColour.DAMAGE_TYPE_PHYSICAL, "toughness", "softness", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute RESISTANCE_LUST = new AbstractAttribute(false, 0, -100, 500, "lust shielding", "Lust shielding", "shieldIcon", PresetColour.GENERIC_SEX, "chastity", "temptation", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute RESISTANCE_FIRE = new AbstractAttribute(false, 0, -100, 500, "fire shielding", "Fire shielding", "shieldIcon", PresetColour.DAMAGE_TYPE_FIRE, "extinguishing", "flammability", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute RESISTANCE_ICE = new AbstractAttribute(false, 0, -100, 500, "cold shielding", "Cold shielding", "shieldIcon", PresetColour.DAMAGE_TYPE_COLD, "warmth", "frostbite", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute RESISTANCE_POISON = new AbstractAttribute(false, 0, -100, 500, "poison shielding", "Poison shielding", "shieldIcon", PresetColour.DAMAGE_TYPE_POISON, "anti-venom", "sickness", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_UNARMED = new AbstractAttribute(true, 0, -80, 100, "unarmed damage", "Unarmed damage", "swordIcon", PresetColour.DAMAGE_TYPE_UNARMED, "martial arts", "martial incompetence", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_MELEE_WEAPON = new AbstractAttribute(true, 0, -80, 100, "melee weapon damage", "Melee Weapon damage", "swordIcon", PresetColour.DAMAGE_TYPE_MELEE, "melee mastery", "melee incompetence", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_RANGED_WEAPON = new AbstractAttribute(true, 0, -80, 100, "ranged weapon damage", "Ranged weapon damage", "swordIcon", PresetColour.DAMAGE_TYPE_RANGED, "ranged mastery", "ranged incompetence", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_SPELLS = new AbstractAttribute(true, 0, -80, 100, "spell damage", "Spell damage", "swordIcon", PresetColour.ATTRIBUTE_MANA, "arcane power", "arcane dulling", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_PHYSICAL = new AbstractAttribute(true, 0, -80, 100, "physical damage", "Physical damage", "swordIcon", PresetColour.DAMAGE_TYPE_PHYSICAL, "force", "softness", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_LUST = new AbstractAttribute(true, 0, -80, 100, "lust damage", "Lust damage", "swordIcon", PresetColour.GENERIC_SEX, "seduction", "repulsion", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_FIRE = new AbstractAttribute(true, 0, -80, 100, "fire damage", "Fire damage", "swordIcon", PresetColour.DAMAGE_TYPE_FIRE, "inferno", "dying embers", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_ICE = new AbstractAttribute(true, 0, -80, 100, "cold damage", "Cold damage", "swordIcon", PresetColour.DAMAGE_TYPE_COLD, "blizzard", "slush", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_POISON = new AbstractAttribute(true, 0, -80, 100, "poison damage", "Poison damage", "swordIcon", PresetColour.DAMAGE_TYPE_POISON, "venom", "dilution", null) {
        @Override
        public String getDescription(GameCharacter owner) {
...
//		}
//	};
    public static final AbstractAttribute DAMAGE_IMP = new AbstractAttribute(true, 0, -100, 100, "imp damage", "Imp damage", "swordIcon", PresetColour.RACE_IMP, "impish-obliteration", "impish-mercy", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_LILIN = new AbstractAttribute(true, 0, -100, 100, "lilin damage", "Lilin damage", "swordIcon", PresetColour.RACE_LILIN, "lilin-obliteration", "lilin-mercy", null) {
        @Override
        public String getDescription(GameCharacter owner) {
    ...
    public static final AbstractAttribute DAMAGE_ELDER_LILIN = new AbstractAttribute(true, 0, -100, 100, "elder lilin damage", "Elder lilin damage", "swordIcon", PresetColour.RACE_LILIN, "elder-lilin-obliteration", "elder-lilin-mercy", null) {
        @Override
        public String getDescription(GameCharacter owner) {
...
//	};
    ...
    public static final Map<AbstractAttribute, String> attributeToIdMap = new HashMap<>();
    public static final Map<String, AbstractAttribute> idToAttributeMap = new HashMap<>();
    public static final List<AbstractAttribute> allAttributes;

    public static final Map<AbstractRace, AbstractAttribute> racialAttributes = new HashMap<>();
