...
public abstract class AbstractStatusEffect {
    ...
    public AbstractStatusEffect(Path XMLFile, String author, boolean mod) {
            ...
            try {
                ...
                if (coreElement.getOptionalFirstOf("category").isPresent()) {
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "StatusEffect loading error in '" + XMLFile.getFileName().toString() + "': category not recognised! (Set to DEFAULT)");
                    }
                }
                ...
                if (coreElement.getOptionalFirstOf("tags").isPresent()) {
                    for (Element e : coreElement.getMandatoryFirstOf("tags").getAllOf("tag")) {
                        try {
                            ...
                            System.getLogger("").log(System.Logger.Level.ERROR, "StatusEffect loading error in '" + XMLFile.getFileName().toString() + "': ItemTag '" + e.getTextContent() + "' not recognised! (Not added)");
                        }
                    }
                }
                ...
                this.pathName = path.resolve(coreElement.getMandatoryFirstOf("imageName").getTextContent().trim()).toString();
                SVGString = null;
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "StatusEffect was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
    }
    ...
    public static String getExposedStatus(GameCharacter owner, String baseSVG) {
        ...
        SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;top:0;'>").append(baseSVG).append("</div>");
        ...
        if (breastsExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreasts()).append("</div>");
            marginTop += size;
        } else if (nipplesExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreastsFlat()).append("</div>");
            marginTop += size;
        }
        if (crotchBoobsExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreastsCrotch()).append("</div>");
            marginTop += size;
        }
        if (anusExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaAnus()).append("</div>");
            marginTop += size;
        }
        if (moundExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaMound()).append("</div>");
            marginTop += size;
        }
        if (penisExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypePenis()).append("</div>");
            marginTop += size;
        }
        if (vaginaExposed) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaVagina()).append("</div>");
            marginTop += size;
        }
    ...
    public static String getRecoveringOrificeStatus(GameCharacter owner, String baseSVG) {
        ...
        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;top:25%;'>").append(baseSVG).append("</div>");
        ...
        if (throatRecovering) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaMouth()).append("</div>");
            marginTop += size;
        }
        if (nipplesRecovering) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaNipple()).append("</div>");
            marginTop += size;
        }
        if (nipplesCrotchRecovering) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaNippleCrotch()).append("</div>");
            marginTop += size;
        }
        if (penileUrethraRecovering) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaUrethraPenis()).append("</div>");
            marginTop += size;
        }
        if (vaginalUrethraRecovering) {
            SVGImageSB.append("<div style='width:").append(size).append("%;height:").append(size).append("%;position:absolute;left:").append(marginLeft).append("%;top:").append(marginTop).append("%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaUrethraVagina()).append("</div>");
            marginTop += size;
        }
    ...
    public static String getStretchingOrificeStatus(GameCharacter owner, boolean stretch, boolean stretchRecoveryPrevented, boolean tooDeep, Set<SexAreaOrifice> orifices) {
        ...
        int topMargin = 0;
        if (stretch) {
            SVGImageSB.append("<div style='width:").append(iconSize).append("%;height:").append(iconSize).append("%;position:absolute;right:").append(iconRight).append(";top:").append(tooDeep || stretchRecoveryPrevented ? "0" : "25%").append(";'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationStretching()).append("</div>");
            topMargin += iconSize;
        }
        if (stretchRecoveryPrevented) {
            SVGImageSB.append("<div style='width:").append(iconSize).append("%;height:").append(iconSize).append("%;position:absolute;right:").append(iconRight).append(";top:").append(stretch || tooDeep ? topMargin + "%" : "25%").append(";'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationStretchRecoveryPrevented()).append("</div>");
            topMargin += iconSize;
        }
        if (tooDeep) {
            SVGImageSB.append("<div style='width:").append(iconSize).append("%;height:").append(iconSize).append("%;position:absolute;right:").append(iconRight).append(";top:").append(stretch || stretchRecoveryPrevented ? topMargin + "%" : "25%").append(";'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationDepthMaximum()).append("</div>");
        }
        ...
        if (this.isFromExternalFile() && target != null && Main.game.isStarted()) {
            if (!shortConditionalCheck) {
                ...
                try {
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Conditional parsing (from status effect) error: " + applicationCondition);
            ...
            if (pathName != null && !pathName.isEmpty()) {
                try {
                    if (isFromExternalFile()) {
                        ...
                        String path = "/com/lilithslegacy/res/statusEffects/" + pathName + ".svg";
                        if (pathName.startsWith("/res/")) {
                            path = "/com/lilithslegacy/" + pathName + ".svg";
                        }
                        InputStream is = FS.newResourceAsStream(path);
                        if (is == null) {
                            System.getLogger("").log(System.Logger.Level.ERROR, "Error! StatusEffect icon file does not exist (Trying to read from '" + pathName + "')!");
                        }
    ...
    public void appendPenetrationAdditionGenericDescriptions(GameCharacter owner, SexAreaPenetration penetration, String penetrationName, StringBuilder stringBuilderToAppendTo) {
        if (!Main.sex.hasLubricationTypeFromAnyone(owner, penetration)) {
            stringBuilderToAppendTo.append("<br/>").append(penetrationName).append(" ").append(penetration.isPlural() ? "are" : "is").append(" [style.boldBad(dry)]!");

        } else {
            stringBuilderToAppendTo.append("<br/>").append(penetrationName).append(" ").append(penetration.isPlural() ? "have" : "has").append(" been [style.boldSex(lubricated)] by:<br/>");
            int i = 0;
            ...
            stringBuilderToAppendTo.append(Util.stringsToStringList(lubricants, false)).append(".");
        }
    ...
    public void appendOrificeAdditionGenericDescriptions(GameCharacter owner, SexAreaOrifice orificeType, String orificeName, StringBuilder stringBuilderToAppendTo) {
        ...
        if (Main.sex.getAreasCurrentlyStretching(owner).contains(orificeType)) {
            if (Main.sex.getFirstOngoingSexAreaPenetration(owner, orificeType) == null) {
                stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "have" : "has").append(" been <b style='color:").append(PresetColour.BASE_PINK_DEEP.toWebHexString()).append(";'>stretched</b>!");

            } else {
                stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" being <b style='color:").append(PresetColour.BASE_PINK_DEEP.toWebHexString()).append(";'>stretched</b>!");
            }

        } else if (Main.sex.getAreasTooLoose(owner).contains(orificeType)) {
            stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" <b style='color:").append(PresetColour.BASE_RED.toWebHexString()).append(";'>too loose</b>!");

        } else if (Main.sex.getAreasStretched(owner).contains(orificeType)) {
            stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "have" : "has").append(" been <b style='color:").append(PresetColour.BASE_PINK_DEEP.toWebHexString()).append(";'>stretched</b>!");

        } else {
            stringBuilderToAppendTo.append("<br/><b style='color:").append(PresetColour.TEXT_GREY.toWebHexString()).append(";'>No stretch effect.</b>");
        }
        ...
        if (Main.game.isPenetrationLimitationsEnabled() && orificeType.isInternalOrifice()) {
            if (!Main.sex.getCharactersPenetratingTooDeep(owner, orificeType).isEmpty()) {
                if (owner.hasFetish(Fetish.FETISH_MASOCHIST) || owner.hasFetish(Fetish.FETISH_SIZE_QUEEN)) {
                    stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" being penetrated [style.boldSex(too deeply)]!");
                } else {
                    stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" being penetrated [style.boldTerrible(too deeply)]!");
                }

            } else if (!Main.sex.getCharactersPenetratingFarTooShallow(owner, orificeType).isEmpty()) {
                stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" being penetrated [style.boldPinkLight(too shallowly)]!");//[style.boldPinkLight(not being penetrated deep enough)]!");
            }
        }

        if (!Main.sex.hasLubricationTypeFromAnyone(owner, orificeType)) {
            stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "are" : "is").append(" [style.boldBad(dry)]!");

        } else {
            stringBuilderToAppendTo.append("<br/>").append(orificeName).append(" ").append(orificePlural ? "have" : "has").append(" been [style.boldSex(lubricated)] by:<br/>");
            int i = 0;
            List<String> lubricants = new ArrayList<>();
            for (GameCharacter lubricantProvider : Main.sex.getAllParticipants()) {
    ...
    public String getPenetrationSVGString(GameCharacter owner, SexAreaInterface penetration, String baseSVG) {
        ...
        if (!Main.sex.getOngoingSexAreas(owner, penetration).isEmpty()) {
            SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getActiveSexBackground()).append("</div>");
        }

        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(baseSVG).append("</div>");
        ...
        if (!Main.sex.getOngoingSexAreas(owner, penetration).isEmpty()) {
            ...
            if (firstPenetration != null) {
                switch (firstPenetration) {
                    case FINGER:
                        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeFinger()).append("</div>");
                        break;
                    case PENIS:
                        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypePenis()).append("</div>");
                        break;
                    case TAIL:
                        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTail(owner.getLegConfiguration() == LegConfiguration.TAIL_LONG)).append("</div>");
                        break;
                    case TONGUE:
                        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTongue()).append("</div>");
                        break;
                    case TENTACLE:
                        SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTentacle()).append("</div>");
                        break;
                    default:
                        break;
                }
        ...
        if (!Main.sex.hasLubricationTypeFromAnyone(owner, penetration)) {
            SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationDry()).append("</div>");
        } else {
            SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationWet()).append("</div>");
        }
        ...
        if (!Main.sex.getOngoingSexAreas(owner, orifice).isEmpty()) {
                    ...
                    if (sArea.isPenetration()) {
                        ...
                        if (limitInteractionsTo == null || limitInteractionsTo.contains(sArea)) {
                            switch ((SexAreaPenetration) sArea) {
                                case FINGER:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeFinger()).append("</div>");
                                    break;
                                case PENIS:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypePenis()).append("</div>");
                                    break;
                                case TAIL:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTail(penetrationOwner.getLegConfiguration() == LegConfiguration.TAIL_LONG)).append("</div>");
                                    break;
                                case TONGUE:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTongue()).append("</div>");
                                    break;
                                case CLIT:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeClit()).append("</div>");
                                    break;
                                case FOOT:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeFoot()).append("</div>");
                                    break;
                                case TENTACLE:
                                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:").append(rightOffset).append("%;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getPenetrationTypeTentacle()).append("</div>");
                                    break;
                            }
                            rightOffset += 8;
                        }
            ...
            if (Main.game.isPenetrationLimitationsEnabled() && orifice.isOrifice() && ((SexAreaOrifice) orifice).isInternalOrifice()) {
                if (!Main.sex.getCharactersPenetratingTooDeep(owner, (SexAreaOrifice) orifice).isEmpty()) {
                    SVGImageSB.append("<div style='width:45%;height:45%;position:absolute;left:2.5%;bottom:2.5%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationDepthMaximum()).append("</div>");

                } else if (!Main.sex.getCharactersPenetratingFarTooShallow(owner, (SexAreaOrifice) orifice).isEmpty()) {
                    SVGImageSB.append("<div style='width:45%;height:45%;position:absolute;left:2.5%;bottom:2.5%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationDepthMinimum()).append("</div>");
                }
            }
        }

        if (Main.sex.getAreasCurrentlyStretching(owner).contains(orifice)) {
            SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationStretching()).append("</div>");
        }

        if (Main.sex.getAreasTooLoose(owner).contains(orifice)) {
            SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;right:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationTooLoose()).append("</div>");
        }

        if (Main.game.isPenetrationLimitationsEnabled()) {
            if (Main.sex.hasLubricationTypeFromAnyone(owner, orifice)) {
                SVGImageSB.append("<div style='width:20%;height:20%;position:absolute;left:2%;top:2%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationWet()).append("</div>");
            }

        } else {
            if (!Main.sex.hasLubricationTypeFromAnyone(owner, orifice)) {
                SVGImageSB.append("<div style='width:45%;height:45%;position:absolute;left:2.5%;bottom:2.5%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationDry()).append("</div>");
            } else {
                SVGImageSB.append("<div style='width:45%;height:45%;position:absolute;left:2.5%;bottom:2.5%;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCombinationWet()).append("</div>");
            }
        }
    ...
    public String getCreampieSVGString(GameCharacter owner, SexAreaOrifice orifice) {
        ...
        if (isCumEffectPositive(owner)) {
            SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>").append(justCum
                    ? SVGImages.SVG_IMAGE_PROVIDER.getCreampieMasochist()
                    : SVGImages.SVG_IMAGE_PROVIDER.getFluidIngestedMasochist()).append("</div>");
        } else {
        ...
        switch (orifice) {
            case ANUS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaAnus()).append("</div>");
                break;
            case ASS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaAnus()).append("</div>");
                break;
            case ARMPITS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaArmpits()).append("</div>");
                break;
            case BREAST:
                if (owner.hasBreasts()) {
                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreasts()).append("</div>");
                } else {
                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreastsFlat()).append("</div>");
                }
                break;
            case NIPPLE:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaNipple()).append("</div>");
                break;
            case BREAST_CROTCH:
                if (owner.getBreastCrotchShape() == BreastShape.UDDERS) {
                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaUdders()).append("</div>");
                } else {
                    SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaBreastsCrotch()).append("</div>");
                }
                break;
            case NIPPLE_CROTCH:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaNippleCrotch()).append("</div>");
                break;
            case MOUTH:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaMouth()).append("</div>");
                break;
            case THIGHS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaThighs()).append("</div>");
                break;
            case URETHRA_PENIS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaUrethraPenis()).append("</div>");
                break;
            case URETHRA_VAGINA:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaUrethraVagina()).append("</div>");
                break;
            case VAGINA:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaVagina()).append("</div>");
                break;
            case SPINNERET:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaSpinneret()).append("</div>");
                break;
        }
    ...
    public String getIncubationSVGString(GameCharacter owner, SexAreaOrifice orifice, int stage) {
        ...
        SVGImageSB.append("<div style='width:100%;height:100%;position:absolute;left:0;bottom:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getEggIncubation(stage)).append("</div>");

        switch (orifice) {
            case ANUS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaAss()).append("</div>");
                break;
            case ASS:
                SVGImageSB.append("<div style='width:50%;height:50%;position:absolute;left:0;top:0;'>").append(SVGImages.SVG_IMAGE_PROVIDER.getCoverableAreaAss()).append("</div>");
                break;
