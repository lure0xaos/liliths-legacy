...
public enum Occupation {
    ...
    protected static final boolean[] noWorkHours = new boolean[24];
    protected static final boolean[] daylightWorkHours = new boolean[24];
    protected static final boolean[] eveningWorkHours = new boolean[24];
    protected static final boolean[] nightWorkHours = new boolean[24];
    ...
    Occupation(AbstractPerk associatedPerk,
        ...
        this.occupationTags.addAll(Arrays.asList(occupationTags));
    }
