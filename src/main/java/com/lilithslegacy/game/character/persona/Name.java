...
public class Name {
    ...
    public static final List<NameTriplet> petNames = Util.newArrayListOfValues(
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/race", null, "names");
...
//						System.out.println("Added modded names of race: "+raceID);
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded names failed. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/race", null, "names");
...
//						System.out.println("Added res names of race: "+raceID);
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading names failed. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
    ...
    private static Map<String, List<NameTriplet>> importNames(Path XMLFile, String author, boolean mod, String raceID) {
...
//							System.out.println("Added ("+subspeciesId+"): "+masName+", "+andName+", "+femName);
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "AbstractRacialBody was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
        return null;
    }
