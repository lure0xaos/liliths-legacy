...
public class QuestTree {
    ...
    public static final TreeNode<Quest> mainQuestTree = new TreeNode<Quest>(Quest.MAIN_PROLOGUE);

    // Side quests:
    public static final TreeNode<Quest> enchantmentTree = new TreeNode<Quest>(Quest.SIDE_ENCHANTMENTS_LILAYA_HELP);
    public static final TreeNode<Quest> pregnancyTree = new TreeNode<Quest>(Quest.SIDE_PREGNANCY_CONSULT_LILAYA);
    public static final TreeNode<Quest> incubationTree = new TreeNode<Quest>(Quest.SIDE_INCUBATION_WAITING);
    public static final TreeNode<Quest> slaveryTree = new TreeNode<Quest>(Quest.SIDE_SLAVER_NEED_RECOMMENDATION);
    public static final TreeNode<Quest> accommodationTree = new TreeNode<Quest>(Quest.SIDE_ACCOMMODATION_NEED_LILAYAS_PERMISSION);
    public static final TreeNode<Quest> hypnoWatchTree = new TreeNode<Quest>(Quest.SIDE_HYPNO_WATCH_VICKY);
    public static final TreeNode<Quest> arcaneLightningTree = new TreeNode<Quest>(Quest.LIGHTNING_SPELL_1_PAYMENT);
    public static final TreeNode<Quest> angryHarpyTree = new TreeNode<Quest>(Quest.HARPY_PACIFICATION_ONE);
    public static final TreeNode<Quest> slimeQueenTree = new TreeNode<Quest>(Quest.SLIME_QUEEN_ONE);
    public static final TreeNode<Quest> teleportingTree = new TreeNode<Quest>(Quest.TELEPORTING_START);
    public static final TreeNode<Quest> daddyTree = new TreeNode<Quest>(Quest.DADDY_START);
    public static final TreeNode<Quest> buyingBraxTree = new TreeNode<Quest>(Quest.BUYING_BRAX_START);
    public static final TreeNode<Quest> vengarTree = new TreeNode<Quest>(Quest.VENGAR_START);
    public static final TreeNode<Quest> wesTree = new TreeNode<Quest>(Quest.WES_START);
    public static final TreeNode<Quest> beerBarrelTree = new TreeNode<Quest>(Quest.OGLIX_BEER_BARRELS_1);
    public static final TreeNode<Quest> lunexisEscapeTree = new TreeNode<Quest>(Quest.LUNEXIS_ESCAPE);
    public static final TreeNode<Quest> dollFactoryTree = new TreeNode<Quest>(Quest.DOLL_FACTORY_1);

    // Relationship/romance quests:
    public static final TreeNode<Quest> nyanTree = new TreeNode<Quest>(Quest.RELATIONSHIP_NYAN_1_STOCK_ISSUES);
    public static final TreeNode<Quest> helenaTree = new TreeNode<Quest>(Quest.ROMANCE_HELENA_1_OFFER_HELP);
    public static final TreeNode<Quest> natalyaTree = new TreeNode<Quest>(Quest.ROMANCE_NATALYA_1_INTERVIEW_START);
    public static final TreeNode<Quest> monicaTree = new TreeNode<Quest>(Quest.ROMANCE_MONICA_1_TO_THE_FARM);

    // DSG's quests:
    public static final TreeNode<Quest> eisekStallTree = new TreeNode<Quest>(Quest.EISEK_STALL_QUEST_STAGE_ONE);
    public static final TreeNode<Quest> eisekMobTree = new TreeNode<Quest>(Quest.EISEK_MOB_QUEST_STAGE_ONE);
    public static final TreeNode<Quest> eisekSillyModeTree = new TreeNode<Quest>(Quest.EISEK_SILLYMODE_QUEST_STAGE_ONE);

    public static final TreeNode<Quest> rebelBaseTree = new TreeNode<Quest>(Quest.REBEL_BASE_EXPLORATION);
    public static final TreeNode<Quest> rebelBaseFirebombTree = new TreeNode<Quest>(Quest.REBEL_BASE_FIREBOMBS_START);
