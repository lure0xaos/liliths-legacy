...
public enum Quest {
    ...
    MAIN_2_D_MEETING_A_LILIN(QuestType.MAIN, 1, 100) {
        ...
        @Override
        public String getDescription() {
            return "Travel to Lyssieth's legacy room and try to finally get some answers about why you're here and how you can return to your old world.";
        }
...
//					+ " You could either offer yourself, or, if you own any slaves, offer one of those to Arthur instead.";
    ...
    VENGAR_ONE(QuestType.SIDE, 1, 5) {
        ...
        @Override
        public String getCompletedDescription() {
            return "You found Vengar sitting on a legacy in the main hall, and after approaching him, you were given the choice to either join his gang, or be set upon by his rat-girl bodyguards.";
        }
    },
