...
public class Colour {
    ...
    public Colour(Path XMLFile, String author, boolean mod) {
            ...
            try {
                ...
                if (coreElement.getOptionalFirstOf("coveringIconColour").isPresent()
                    ...
                    try {
                        ...
                        System.getLogger("").log(System.Logger.Level.ERROR, "coveringIconColour failure in '" + this.name + "':\n" + ex.getMessage());
                    }
                }
                ...
                System.getLogger("").log(System.Logger.Level.ERROR, "Colour was unable to be loaded from file! (" + XMLFile.getFileName().toString() + ")\n" + ex);
            }
        }
    }
    ...
    public String getRainbowDiv(int rainbowPixels) {
        ...
        for (String s : getRainbowColours()) {
            sb.append(" ").append(s).append(" ").append(i * rainbowPixels).append("px, ").append(s).append(" ").append((i + 1) * rainbowPixels).append("px,");
            i++;
        }
    ...
    public String toString() {
        System.getLogger("").log(System.Logger.Level.ERROR, "Warning! Colour.toString() was called instead of getId()");
        return getId();
    }
