...
public class ColourListPresets {
    ...
    public static final ArrayList<Colour> humanSkinColours = new ArrayList<>(PresetColour.getHumanSkinColours());
    ...
    public static final ArrayList<Colour> allSkinColours = new ArrayList<>(PresetColour.allSkinColours);
    ...
    public static final ArrayList<Colour> JUST_WHITE = Util.newArrayListOfValues(
            PresetColour.CLOTHING_WHITE);

    public static final ArrayList<Colour> JUST_BLACK = Util.newArrayListOfValues(
            PresetColour.CLOTHING_BLACK);

    public static final ArrayList<Colour> JUST_RED_DARK = Util.newArrayListOfValues(
            PresetColour.CLOTHING_RED_DARK);

    public static final ArrayList<Colour> JUST_RED = Util.newArrayListOfValues(
    ...
    public static final ArrayList<Colour> JUST_ROSE_GOLD = Util.newArrayListOfValues(
            PresetColour.CLOTHING_ROSE_GOLD);

    public static final ArrayList<Colour> JUST_STEEL = Util.newArrayListOfValues(
...
//			PresetColour.CLOTHING_WHITE
    ...
    public static final ArrayList<Colour> MILK_MAID = Util.newArrayListOfValues(
            PresetColour.CLOTHING_PINK_LIGHT,
            PresetColour.CLOTHING_BLUE_LIGHT,
            PresetColour.CLOTHING_PURPLE_LIGHT,
    ...
    public static final ArrayList<Colour> LINGERIE = Util.newArrayListOfValues(
            PresetColour.CLOTHING_WHITE,
            PresetColour.CLOTHING_GREY_LIGHT,
            PresetColour.CLOTHING_GREY,
            PresetColour.CLOTHING_GREY_DARK,
    ...
    public static final ArrayList<Colour> ALL_METAL = Util.newArrayListOfValues(
    ...
    public static final ArrayList<Colour> ALL = Util.newArrayListOfValues(
            PresetColour.CLOTHING_WHITE,
            PresetColour.CLOTHING_GREY_LIGHT,
            PresetColour.CLOTHING_GREY,
            PresetColour.CLOTHING_GREY_DARK,
    ...
    public static final ArrayList<Colour> ALL_WITH_METALS = Util.newArrayListOfValues(
            PresetColour.CLOTHING_BLACK_STEEL,
            PresetColour.CLOTHING_GUNMETAL,
            PresetColour.CLOTHING_STEEL,
            PresetColour.CLOTHING_IRON,
    ...
    public static final ArrayList<Colour> NOT_WHITE = new ArrayList<>(ALL);

    public static final ArrayList<Colour> NOT_BLACK = new ArrayList<>(ALL);
    ...
    public static final ArrayList<Colour> HUMAN_SKIN_COLOURS;
    public static final ArrayList<Colour> ALL_SKIN_COLOURS;
    public static final ArrayList<Colour> ALL_WITH_SKIN_COLOURS;

    //Speshul debug color list with added damage and BaseColours
    //Modders don't use this in your items rrrrreeeeee
    public static final ArrayList<Colour> DEBUG_ALL = Util.newArrayListOfValues(
    ...
    private static final Map<String, ArrayList<Colour>> idToColourListMap = new HashMap<>();
