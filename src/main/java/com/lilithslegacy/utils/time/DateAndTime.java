...
//		  Year = C-4715 (if Month is January or February) or C-4716 (otherwise)
        ...
        int day = (int) (B - D - F + ((julianDate) - Z));
        ...
        try {
            ...
            if (DEBUG) {
                System.getLogger("").log(System.Logger.Level.ERROR, "Error in julianDayToDate(): " + julianDate + ": " + hours + ":" + minutes + ":" + seconds + " | " + day + ", " + month + ", " + year);
            }
            return null;
        }
    }
