...
public class SvgUtil {
    ...
    public static String getSVGWithHandledPattern(String errorId, String s, String pattern, List<Colour> patternColours, List<ColourReplacement> patternColourReplacements) {
        ...
        StringBuilder newClipMask = new StringBuilder("<clipPath id=\"internalPatternClip\">");
        ...
        while (continueSetUp) {
            ...
            if (currentShapeEndIndex > patternLayerEndIndex || currentShapeEndIndex == -1 || currentShapeStartIndex == -1) {
                ...
                newClipMask.append(s.substring(currentShapeStartIndex, currentShapeEndIndex)).append(" />");
                lastShapeEndIndex = currentShapeEndIndex;
            }
        }

        newClipMask.append("</clipPath>");
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Error in pattern loading method getSVGWithHandledPattern(): " + errorId);
            return s;
        }
        ...
        while (continuePatternSetUp) {
            ...
            if (currentShapeEndIndex == -1 || currentShapeStartIndex == -1) {
                ...
                newPattern.append(loadedPattern.substring(currentShapeStartIndex, currentShapeEndIndex)).append("clip-path=\"url(#internalPatternClip)\"").append("/>");
