...
public enum SVGImages {
    ...
    private final Map<Integer, String> youkoTailsMap = new HashMap<>();
    private final Map<Integer, String> youkoTailsDesaturatedMap = new HashMap<>();
    private final Map<Integer, String> youkoTailsDemonMap = new HashMap<>();


    private final Map<Colour, String> refinedBackgroundMap = new HashMap<>();
    private final Map<Colour, String> refinedSwirlsMap = new HashMap<>();

    SVGImages() {

        try {
            InputStream is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/flag_us.svg");
            flagUs = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/fist.svg");
            fist = Util.inputStreamToString(is);
            fist = setColour(fist, PresetColour.BASE_BLACK);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/displacedWarningIcon.svg");
            displacedIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/concealed.svg");
            concealedIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/dirtyIcon.svg");
            dirtyIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/lipstickIcon.svg");
            lipstickIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/feminineWarningIcon.svg");
            feminineWarningIcon = Util.inputStreamToString(is);
            feminineWarningIcon = setColour(feminineWarningIcon, PresetColour.FEMININE);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/masculineWarningIcon.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/jinxed.svg");
            jinxedIcon = Util.inputStreamToString(is);
            jinxedIcon = setColour(jinxedIcon, PresetColour.ATTRIBUTE_CORRUPTION);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/tattooSwitchTattoo.svg");
            tattooSwitchTattoo = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/tattooSwitchClothing.svg");
            tattooSwitchClothing = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/InventoryIcons/scar.svg");
            scarIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/menu.svg");
            menuIcon = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/inventory.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/questInventory.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/crafting/essenceArcane.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/itemsOnFloor.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/cornerGlow.svg");
            cornerGlowNight = Util.inputStreamToString(is);
            cornerGlowNight = setColour(cornerGlowNight, PresetColour.BASE_PITCH_BLACK);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/cornerGlowLight.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/cornerGlowAlwaysLight.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/diskLoad.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/diskDelete.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/map/playerIcon.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceBackground.svg");
            raceBackground = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceBackgroundHalf.svg");
            raceBackgroundHalf = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceBackgroundSlime.svg");
            raceBackgroundSlime = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceBackgroundDoll.svg");
            raceBackgroundDoll = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceBackgroundDemon.svg");
            raceBackgroundDemon = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceUnknown.svg");
            raceUnknown = Util.inputStreamToString(is);
            raceUnknown = setColour(raceUnknown, PresetColour.RACE_UNKNOWN);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceDogMorphDobermann.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceWisp.svg");
            raceWisp = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/perkTreeArrow.svg");
            perkTreeArrow = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/combat/spell/spell_overlay.svg");
            spellOverlay = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/clothing/wrist_womens_watch_hourhand.svg");
            womensWatchHourHand = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/clothing/wrist_womens_watch_minutehand.svg");
            womensWatchMinuteHand = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/clothing/wrist_mens_watch_hourhand.svg");
            mensWatchHourHand = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/clothing/wrist_mens_watch_minutehand.svg");
            mensWatchMinuteHand = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayClear.svg");
            weatherDayClear = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayCloudy.svg");
            weatherDayCloud = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayRain.svg");
            weatherDayRain = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDaySnow.svg");
            weatherDaySnow = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayStormIncoming.svg");
            weatherDayStormIncoming = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayStorm.svg");
            weatherDayStorm = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherDayStormProtected.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightClear.svg");
            weatherNightClear = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightCloudy.svg");
            weatherNightCloud = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightRain.svg");
            weatherNightRain = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightSnow.svg");
            weatherNightSnow = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightStormIncoming.svg");
            weatherNightStormIncoming = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightStorm.svg");
            weatherNightStorm = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/weatherNightStormProtected.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/protection.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/tattoo.svg");
            tattoo = Util.inputStreamToString(is);
            tattoo = setColour(tattoo, PresetColour.CLOTHING_BLACK);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseCombat.svg");
            responseCombat = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSex.svg");
            responseSex = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseLocked.svg");
            responseLocked = Util.inputStreamToString(is);
            responseLocked = setColour(responseLocked, PresetColour.GENERIC_BAD);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseUnlocked.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseOption.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseCorruptionBypass.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSubResist.svg");
            responseSubResist = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSubNormal.svg");
            responseSubNormal = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSubEager.svg");
            responseSubEager = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseDomGentle.svg");
            responseDomGentle = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseDomNormal.svg");
            responseDomNormal = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseDomRough.svg");
            responseDomRough = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSexSwitch.svg");
            responseSexSwitch = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseSexAdditional.svg");
            responseSexAdditional = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/responseNPC.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/scale_zero.svg");
            scaleZero = Util.inputStreamToString(is);
            scaleZero = setColour(scaleZero, PresetColour.BASE_MAGENTA);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/scale_one.svg");
            scaleOne = Util.inputStreamToString(is);
            scaleOne = setColour(scaleOne, PresetColour.BASE_GREEN);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/scale_two.svg");
            scaleTwo = Util.inputStreamToString(is);
            scaleTwo = setColour(scaleTwo, PresetColour.BASE_GREEN);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/scale_three.svg");
            scaleThree = Util.inputStreamToString(is);
            scaleThree = setColour(scaleThree, PresetColour.BASE_GREEN);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/scale_four.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/slaveJob.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/slavePermissions.svg");
            slavePermissions = Util.inputStreamToString(is);
            slavePermissions = setColour(slavePermissions, PresetColour.BASE_GREY);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/slavePermissionsDisabled.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/slaveTransfer.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/slaveCosmetics.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/transactionBuy.svg");
            transactionBuy = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/transactionBuyDisabled.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/transactionBid.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/transactionSell.svg");
            transactionSell = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/UIElements/transactionSellDisabled.svg");
            ...
            for (int i = 1; i <= 9; i++) {
                is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/race/raceFoxTail" + i + ".svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/creampie.svg");
            creampie = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/creampieMasochist.svg");
            creampieMasochist = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/fluidIngested.svg");
            fluidIngested = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/fluidIngestedMasochist.svg");
            fluidIngestedMasochist = Util.inputStreamToString(is);


            // Items:

            is = FS.newResourceAsStream("/com/lilithslegacy/res/items/hypnoClockBase.svg");
            hypnoWatchBase = Util.inputStreamToString(is);
            hypnoWatchBase = setColour(hypnoWatchBase, PresetColour.BASE_GREY);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/items/hypnoClockEnchanted.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaAnus.svg");
            coverableAreaAnus = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaAss.svg");
            coverableAreaAss = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaMouth.svg");
            coverableAreaMouth = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaBreasts.svg");
            coverableAreaBreasts = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaBreastsFlat.svg");
            coverableAreaBreastsFlat = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaNipple.svg");
            coverableAreaNipple = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaVagina.svg");
            coverableAreaVagina = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaMound.svg");
            coverableAreaMound = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaSpinneret.svg");
            coverableAreaSpinneret = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaBreastsCrotch.svg");
            coverableAreaBreastsCrotch = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaUdders.svg");
            coverableAreaUdders = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaNippleCrotch.svg");
            coverableAreaNippleCrotch = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaUrethraVagina.svg");
            coverableAreaUrethraVagina = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaUrethraPenis.svg");
            coverableAreaUrethraPenis = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaThighs.svg");
            coverableAreaThighs = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/coverableAreaArmpits.svg");
            coverableAreaArmpits = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeFinger.svg");
            penetrationTypeFinger = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypePenis.svg");
            penetrationTypePenis = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeTail.svg");
            penetrationTypeTail = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeTailSerpent.svg");
            penetrationTypeTailSerpent = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeTentacle.svg");
            penetrationTypeTentacle = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeTongue.svg");
            penetrationTypeTongue = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeFoot.svg");
            penetrationTypeFoot = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/penetrationTypeClit.svg");
            penetrationTypeClit = Util.inputStreamToString(is);


            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/incubation1.svg");
            eggIncubation1 = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/incubation2.svg");
            eggIncubation2 = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/incubation3.svg");
            eggIncubation3 = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationStretching.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationStretchRecoveryPrevented.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationTooLoose.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationWet.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationDry.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationDepthMinimum.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/combinationDepthMaximum.svg");
            ...
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/stretching.svg");
            stretching = Util.inputStreamToString(is);
            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/holeTooBig.svg");
            holeTooBig = Util.inputStreamToString(is);

            is = FS.newResourceAsStream("/com/lilithslegacy/res/statusEffects/sexEffects/active_background.svg");
            activeSexBackground = Util.inputStreamToString(is);


            String tempString = "";
            for (AbstractItemEffectType effect : ItemEffectType.getAllEffectTypes()) {
                is = FS.newResourceAsStream("/com/lilithslegacy/res/items/refined_background.svg");
            ...
            for (TFModifier secondaryModifier : TFModifier.values()) {
                is = FS.newResourceAsStream("/com/lilithslegacy/res/items/refined_swirls.svg");
                tempString = Util.inputStreamToString(is);
