...
public enum ImageCache {
    ...
    protected final Map<Path, CachedImage> cache = Collections.synchronizedMap(new LinkedHashMap<Path, CachedImage>(16, 0.75f, true) {
        @Serial
    ...
    protected final LinkedBlockingQueue<Path> queue = new LinkedBlockingQueue<>();
    protected final Thread loaderThread = new Thread(() -> {
