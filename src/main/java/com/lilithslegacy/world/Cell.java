...
import com.lilithslegacy.world.places.Aquatic;
import com.lilithslegacy.world.places.Darkness;
...
public class Cell implements XMLSaving {
    ...
    public static Cell loadFromXML(Element parentElement, Document doc, AbstractWorldType type) {
        ...
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Cell import error 1");
        }
