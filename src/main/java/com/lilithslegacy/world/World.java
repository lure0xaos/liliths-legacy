...
public class World implements XMLSaving {
    ...
    public Cell getCell(Vector2i vec) {
        try {
            ...
            String message = "Error in WorldType: " + WorldType.getIdFromWorldType(this.getWorldType());
    ...
    public Cell getRandomUnoccupiedCell(AbstractPlaceType place) {
        ...
        if (cells.isEmpty()) {
//			if(Main.DEBUG) {
//				com.lilithslegacy.utils.log.Log.log("World.getRandomUnoccupiedCell() - No unoccupied cells found, occupied one returned instead.");
//			}
