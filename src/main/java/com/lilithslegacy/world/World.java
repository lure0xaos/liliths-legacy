...
public class World implements XMLSaving {
    ...
    public Cell getCell(Vector2i vec) {
        try {
            ...
            System.getLogger("").log(System.Logger.Level.ERROR, "Error in WorldType: " + WorldType.getIdFromWorldType(this.getWorldType()));
            throw ex;
        }
    }
    ...
    public Cell getRandomUnoccupiedCell(AbstractPlaceType place) {
        ...
        if (cells.isEmpty()) {
//			if(Main.DEBUG) {
//				System.getLogger("").log(System.Logger.Level.ERROR,"World.getRandomUnoccupiedCell() - No unoccupied cells found, occupied one returned instead.");
//			}
