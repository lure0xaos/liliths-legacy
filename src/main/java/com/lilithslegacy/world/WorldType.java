...
public class WorldType {
    ...
    public static final AbstractWorldType EMPTY = new AbstractWorldType(WorldRegion.MISC,
            "Empty (Holding world)",
            PresetColour.BASE_BROWN,
            false,
            true,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/empty.png"),
    ...
    public static final AbstractWorldType WORLD_MAP = new AbstractWorldType(WorldRegion.MISC,
            "Lilith's Realm",
            PresetColour.BASE_TAN,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/global/world_map.png"), null, null, Util.newHashMapOfValues(
...
//		}
    ...
    public static final AbstractWorldType DOMINION = new AbstractWorldType(WorldRegion.DOMINION,
            "Dominion",
            PresetColour.BASE_PURPLE,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/dominion.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_PLAZA, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType MUSEUM = new AbstractWorldType(WorldRegion.OLD_WORLD,
            "Museum",
            PresetColour.BASE_BROWN,
            false,
            true,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/prologue/museum.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.MUSEUM_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType MUSEUM_LOST = new AbstractWorldType(WorldRegion.OLD_WORLD,
            "Museum",
            PresetColour.BASE_BROWN,
            false,
            true,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/prologue/museum_lost.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.MUSEUM_MIRROR, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
            new Value<>(new Color(0xff8000), PlaceType.MUSEUM_ROOM),
    ...
    public static final AbstractWorldType LILAYAS_HOUSE_GROUND_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Lilaya's Home F0",
            PresetColour.BASE_BLUE_LIGHT,
            true,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/lilayasHome/lilayas_home_ground_floor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.LILAYA_HOME_ENTRANCE_HALL, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType LILAYAS_HOUSE_FIRST_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Lilaya's Home F1",
            PresetColour.BASE_BLUE_LIGHT,
            true,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/lilayasHome/lilayas_home_first_floor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.LILAYA_HOME_STAIR_DOWN, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
            new Value<>(new Color(0x808080), PlaceType.LILAYA_HOME_CORRIDOR),
    ...
    public static final AbstractWorldType ZARANIX_HOUSE_FIRST_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Zaranix's Home F1",
            PresetColour.BASE_CRIMSON,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/zaranixHome/first_floor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.ZARANIX_FF_STAIRS, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType ZARANIX_HOUSE_GROUND_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Zaranix's Home F0",
            PresetColour.BASE_CRIMSON,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/zaranixHome/ground_floor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.ZARANIX_GF_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType HARPY_NEST = new AbstractWorldType(WorldRegion.HARPY_NESTS,
            "Harpy Nests",
            PresetColour.BASE_CRIMSON,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/harpyNests/harpyNests.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.HARPY_NESTS_ENTRANCE_ENFORCER_POST, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType SLAVER_ALLEY = new AbstractWorldType(WorldRegion.DOMINION,
            "Slaver Alley",
            PresetColour.BASE_RED,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/slaverAlley/slaverAlley.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.SLAVER_ALLEY_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType BOUNTY_HUNTER_LODGE = new AbstractWorldType(WorldRegion.DOMINION,
            "The Rusty Collar",
            PresetColour.BASE_COPPER,
            false,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/slaverAlley/bountyHunterLodge/bountyHunterLodge.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.BOUNTY_HUNTER_LODGE_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType BOUNTY_HUNTER_LODGE_UPSTAIRS = new AbstractWorldType(WorldRegion.DOMINION,
            "The Rusty Collar (Upstairs)",
            PresetColour.BASE_COPPER,
            false,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/slaverAlley/bountyHunterLodge/bountyHunterLodgeUpstairs.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.BOUNTY_HUNTER_LODGE_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType SHOPPING_ARCADE = new AbstractWorldType(WorldRegion.DOMINION,
            "Shopping Arcade",
            PresetColour.BASE_YELLOW,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/shoppingArcade/shoppingArcade.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.SHOPPING_ARCADE_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType TEXTILES_WAREHOUSE = new AbstractWorldType(WorldRegion.DOMINION,
            "Kay's Textiles",
            PresetColour.GENERIC_ARCANE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/textilesWarehouse/textilesWarehouse.png"),
    ...
    public static final AbstractWorldType ENFORCER_HQ = new AbstractWorldType(WorldRegion.DOMINION,
            "Enforcer HQ",
            PresetColour.BASE_BLUE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/enforcerHQ/enforcerHQ.png"),
    ...
    public static final AbstractWorldType ENFORCER_WAREHOUSE = new AbstractWorldType(WorldRegion.DOMINION,
            "SWORD Warehouse",
            PresetColour.BASE_BLUE,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/enforcerWarehouse/enforcerWarehouse.png"),
    ...
    public static final AbstractWorldType CITY_HALL = new AbstractWorldType(WorldRegion.DOMINION,
            "City Hall",
            PresetColour.BASE_PURPLE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/cityHall/city_hall.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.CITY_HALL_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType HOME_IMPROVEMENTS = new AbstractWorldType(WorldRegion.DOMINION,
            "Argus's DIY Depot",
            PresetColour.BASE_ORANGE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/homeImprovements/homeImprovements.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.HOME_IMPROVEMENTS_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType DOMINION_EXPRESS = new AbstractWorldType(WorldRegion.DOMINION,
            "Dominion Express",
            PresetColour.BASE_BROWN,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/dominion/dominionExpress/dominionExpress.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.HOME_IMPROVEMENTS_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType ANGELS_KISS_GROUND_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Angel's Kiss F0",
            PresetColour.BASE_MAGENTA,
            false,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/angelsKiss/angelsKissGroundFloor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.ANGELS_KISS_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType ANGELS_KISS_FIRST_FLOOR = new AbstractWorldType(WorldRegion.DOMINION,
            "Angel's Kiss F1",
            PresetColour.BASE_MAGENTA,
            false,
            false,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/dominion/angelsKiss/angelsKissFirstFloor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.ANGELS_KISS_STAIRCASE_DOWN, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
            new Value<>(new Color(0x808080), PlaceType.ANGELS_KISS_CORRIDOR),
    ...
    public static final AbstractWorldType NIGHTLIFE_CLUB = new AbstractWorldType(WorldRegion.DOMINION,
            "The Watering Hole",
            PresetColour.BASE_BLUE,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/nightLife/wateringHole.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.WATERING_HOLE_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType DADDYS_APARTMENT = new AbstractWorldType(WorldRegion.DOMINION,
            "Daddy's apartment",
            PresetColour.RACE_DEMON,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/daddy/apartment.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_DEMON_HOME_DADDY, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType FELICIA_APARTMENT = new AbstractWorldType(
            ...
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/feliciaApartment/feliciaApartment.png"),
            PlaceType.WORLD_MAP_DOMINION,
    ...
    public static final AbstractWorldType HELENAS_APARTMENT = new AbstractWorldType(WorldRegion.DOMINION,
            "Helena's apartment",
            PresetColour.BASE_GOLD,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/helenaApartment/apartment.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_HELENA_HOTEL, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType NYANS_APARTMENT = new AbstractWorldType(WorldRegion.DOMINION,
            "Nyan's apartment",
            PresetColour.BASE_PINK_LIGHT,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/dominion/nyanApartment/apartment.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.DOMINION_NYAN_APARTMENT, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType SUBMISSION = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Submission",
            PresetColour.BASE_GREEN,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/submission/submission.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.SUBMISSION_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType LYSSIETH_PALACE = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Lyssieth's Palace",
            PresetColour.BASE_PURPLE,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/submission/lyssiethsPalace/groundFloor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.LYSSIETH_PALACE_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType IMP_FORTRESS_ALPHA = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Imp Fortress A",
            PresetColour.BASE_CRIMSON,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/impFortress/fortress1Map.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_ALPHA_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType IMP_FORTRESS_DEMON = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Imp Citadel",
            PresetColour.BASE_PURPLE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/impFortress/fortress2Map.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_DEMON_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType IMP_FORTRESS_FEMALES = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Imp Fortress F",
            PresetColour.BASE_PINK,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/impFortress/fortress3Map.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_FEMALES_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType IMP_FORTRESS_MALES = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Imp Fortress M",
            PresetColour.BASE_BLUE,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/impFortress/fortress4Map.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.FORTRESS_MALES_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType BAT_CAVERNS = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Bat Caverns",
            PresetColour.BASE_BLACK,
            true,
            true,
            TeleportPermissions.BOTH,
            FS.newPath("/com/lilithslegacy/res/map/submission/batCaverns/batCaverns.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.BAT_CAVERN_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType SLIME_QUEENS_LAIR_GROUND_FLOOR = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Slime Queen's Tower F0",
            PresetColour.BASE_PINK,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/slimeQueensLair/slimeQueensLairGroundFloor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.SLIME_QUEENS_LAIR_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType SLIME_QUEENS_LAIR_FIRST_FLOOR = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Slime Queen's Tower F1",
            PresetColour.BASE_PINK,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/slimeQueensLair/slimeQueensLairFirstFloor.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.SLIME_QUEENS_LAIR_STAIRS_DOWN, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType GAMBLING_DEN = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Gambling Den",
            PresetColour.BASE_GOLD,
            false,
            false,
            TeleportPermissions.OUTGOING_ONLY,
            FS.newPath("/com/lilithslegacy/res/map/submission/gamblingDen/gamblingDen.png"), PlaceType.WORLD_MAP_DOMINION, PlaceType.GAMBLING_DEN_ENTRANCE, Util.newHashMapOfValues(
            new Value<>(new Color(0xFFFFFF), PlaceType.GENERIC_IMPASSABLE),
    ...
    public static final AbstractWorldType RAT_WARRENS = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Rat Warrens",
            PresetColour.BASE_BROWN,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/submission/ratWarrens/ratWarrens.png"),
            PlaceType.WORLD_MAP_DOMINION,
    ...
    public static final AbstractWorldType REBEL_BASE = new AbstractWorldType(WorldRegion.SUBMISSION,
            "Mysterious Cave",
            PresetColour.BASE_GREY,
            false,
            false,
            TeleportPermissions.NONE,
            FS.newPath("/com/lilithslegacy/res/map/submission/rebelBase/rebelBase.png"),
            PlaceType.WORLD_MAP_DOMINION,
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/maps", null, "worldType");
...
//					System.out.println("modded WT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded world type failed at 'WorldType'. File path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/maps", null, "worldType");
...
//					System.out.println("res WT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading world type failed at 'WorldType'. File path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
