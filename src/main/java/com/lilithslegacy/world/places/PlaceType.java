...
import com.lilithslegacy.game.dialogue.npcDialogue.dominion.DaddyDialogue;
import com.lilithslegacy.game.dialogue.places.dominion.DemonHome;
import com.lilithslegacy.game.dialogue.places.dominion.DominionPark;
...
import com.lilithslegacy.game.dialogue.places.dominion.HomeImprovements;
import com.lilithslegacy.game.dialogue.places.dominion.LilithsTower;
...
import com.lilithslegacy.game.dialogue.places.dominion.cityHall.CityHallProperty;
import com.lilithslegacy.game.dialogue.places.dominion.enforcerHQ.BraxOffice;
import com.lilithslegacy.game.dialogue.places.dominion.enforcerHQ.EnforcerHQDialogue;
import com.lilithslegacy.game.dialogue.places.dominion.feliciaApartment.FeliciaApartment;
import com.lilithslegacy.game.dialogue.places.dominion.harpyNests.HarpyNestHelena;
import com.lilithslegacy.game.dialogue.places.dominion.harpyNests.HarpyNestsDialogue;
import com.lilithslegacy.game.dialogue.places.dominion.helenaHotel.HelenaApartment;
...
import com.lilithslegacy.game.dialogue.places.dominion.lilayashome.LilayaSpa;
import com.lilithslegacy.game.dialogue.places.dominion.lilayashome.LilayasRoom;
import com.lilithslegacy.game.dialogue.places.dominion.lilayashome.RoomArthur;
...
import com.lilithslegacy.game.dialogue.places.dominion.nyansApartment.NyanApartment;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.ArcaneArts;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.ClothingEmporium;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.DreamLover;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.PixsPlayground;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.RalphsSnacks;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.ShoppingArcadeDialogue;
import com.lilithslegacy.game.dialogue.places.dominion.shoppingArcade.SuccubisSecrets;
import com.lilithslegacy.game.dialogue.places.dominion.slaverAlley.BountyHunterLodge;
...
import com.lilithslegacy.game.dialogue.places.dominion.slaverAlley.SlaveryAdministration;
...
import com.lilithslegacy.game.dialogue.places.dominion.warehouseDistrict.Warehouses;
import com.lilithslegacy.game.dialogue.places.dominion.zaranixHome.ZaranixHomeFirstFloor;
import com.lilithslegacy.game.dialogue.places.dominion.zaranixHome.ZaranixHomeFirstFloorRepeat;
import com.lilithslegacy.game.dialogue.places.dominion.zaranixHome.ZaranixHomeGroundFloor;
import com.lilithslegacy.game.dialogue.places.dominion.zaranixHome.ZaranixHomeGroundFloorRepeat;
import com.lilithslegacy.game.dialogue.places.fields.FieldsDialogue;
import com.lilithslegacy.game.dialogue.places.submission.BatCaverns;
import com.lilithslegacy.game.dialogue.places.submission.LyssiethPalaceDialogue;
import com.lilithslegacy.game.dialogue.places.submission.SlimeQueensLair;
import com.lilithslegacy.game.dialogue.places.submission.SubmissionGenericPlaces;
import com.lilithslegacy.game.dialogue.places.submission.gamblingDen.GamblingDenDialogue;
import com.lilithslegacy.game.dialogue.places.submission.gamblingDen.PregnancyRoulette;
import com.lilithslegacy.game.dialogue.places.submission.gamblingDen.RoxysShop;
...
import com.lilithslegacy.game.dialogue.places.submission.ratWarrens.RatWarrensCaptiveDialogue;
...
import com.lilithslegacy.game.dialogue.places.submission.rebelBase.RebelBase;
...
import com.lilithslegacy.world.TeleportPermissions;
...
import com.lilithslegacy.world.population.PopulationDensity;
...
//		}
    ...
    public static final AbstractPlaceType RAT_WARRENS_VENGARS_HALL = new AbstractPlaceType(
            WorldRegion.SUBMISSION,
            "Vengar's Hall",
            "A huge, stone hall, filled with numerous long wooden benches and with a raised legacy at the far end.",
    ...
    static {
        ...
        Map<String, Map<String, Path>> moddedFilesMap = Util.getExternalModFilesById("/maps", "placeTypes", null);
...
//					System.out.println("modded PT: "+innerEntry.getKey());
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading modded place type failed at 'PlaceType'. FSPath path: " + innerEntry.getValue());
        ...
        Map<String, Map<String, Path>> filesMap = Util.getExternalFilesById("/res/maps", "placeTypes", null);
...
//					System.out.println("res PT: "+innerEntry.getKey()+" | "+id);
                    ...
                    System.getLogger("").log(System.Logger.Level.ERROR, "Loading place type failed at 'PlaceType'. FSPath path: " + innerEntry.getValue());
                    System.getLogger("").log(System.Logger.Level.ERROR, "Actual exception: ");
                    ex.printStackTrace(System.err);
                }
            }
