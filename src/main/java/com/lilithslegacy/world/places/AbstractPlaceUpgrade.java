...
public abstract class AbstractPlaceUpgrade {
    ...
    protected final String descriptionForPurchase;
    protected final String descriptionAfterPurchase;
    protected final String roomDescription;
    private final boolean isCoreRoomUpgrade;
    private final int installCost;
    ...
    private final float affectionGain;
    private final float obedienceGain;

    private final List<AbstractPlaceUpgrade> prerequisites;
