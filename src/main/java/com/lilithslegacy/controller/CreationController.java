            ...
            if (MainController.document.getElementById(id) != null) {
                ...
                if (Main.game.isInNewWorld()) {
                    if (Main.game.getPlayer().getMoney() >= 100) {
                        sb.append("It will cost ").append(UtilText.formatAsMoney(100, "span")).append(" to remove this tattoo!");
                    } else {
                        sb.append("You don't have the required ").append(UtilText.formatAsMoney(100, "span")).append(" to remove this tattoo!");
                        confirm = false;
                    }
                } else {
