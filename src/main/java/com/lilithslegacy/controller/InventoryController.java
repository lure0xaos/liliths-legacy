            ...
            for (Sticker s : stickerEntry.getValue()) {
                ...
                if (MainController.document.getElementById(id) != null) {
                    ...
                    if (!requirements.isEmpty()) {
                        tooltipDescriptionSB.append("[style.boldBad(Locked:)] <i>").append(requirements).append("</i><br/>");
                        lineHeight += 2;
                    } else {
                        if (!s.getAvailabilityText().isEmpty()) {
                            tooltipDescriptionSB.append("[style.boldGood(Unlocked:)] <i>").append(s.getAvailabilityText()).append("</i><br/>");
                            lineHeight += 2;
                        }
                        ...
                        for (ItemTag tag : s.getTagsApplied()) {
                            for (String tagTooltip : tag.getClothingTooltipAdditions()) {
                                ...
                                tooltipDescriptionSB.append(tagTooltip).append("<br/>");
                                lineHeight++;
                            }
                        }
