...
import com.lilithslegacy.controller.eventListeners.InventorySelectedItemEventListener;
import com.lilithslegacy.controller.eventListeners.SetContentEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonCharactersEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonCopyDialogueEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonInventoryEventHandler;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonJournalEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonMainMenuEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonMoveEastEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonMoveNorthEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonMoveSouthEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonMoveWestEventListener;
import com.lilithslegacy.controller.eventListeners.buttons.ButtonZoomEventListener;
import com.lilithslegacy.controller.eventListeners.tooltips.TooltipHideEventListener;
...
import com.lilithslegacy.controller.eventListeners.tooltips.TooltipMoveEventListener;
import com.lilithslegacy.controller.eventListeners.tooltips.TooltipResponseDescriptionEventListener;
import com.lilithslegacy.controller.eventListeners.tooltips.TooltipResponseMoveEventListener;
import com.lilithslegacy.game.Game;
import com.lilithslegacy.game.PropertyValue;
import com.lilithslegacy.game.character.CharacterChangeEventListener;
...
import com.lilithslegacy.game.dialogue.places.dominion.lilayashome.LilayaMilkingRoomDialogue;
...
import com.lilithslegacy.game.dialogue.places.dominion.warehouseDistrict.KaysWarehouse;
...
import com.lilithslegacy.game.dialogue.utils.GiftDialogue;
...
import com.lilithslegacy.game.sex.InitialSexActionInformation;
...
public class MainController implements Initializable {
    ...
    // General tooltips:
    static final TooltipMoveEventListener moveTooltipListener = new TooltipMoveEventListener();
    static final TooltipHideEventListener hideTooltipListener = new TooltipHideEventListener();
    // Buttons:
    static final ButtonCopyDialogueEventListener copyDialogueButtonListener = new ButtonCopyDialogueEventListener();
    static final ButtonCharactersEventListener charactersPresentButtonListener = new ButtonCharactersEventListener();
    static final ButtonInventoryEventHandler inventoryButtonListener = new ButtonInventoryEventHandler();
    static final ButtonJournalEventListener journalButtonListener = new ButtonJournalEventListener();
    static final ButtonMainMenuEventListener menuButtonListener = new ButtonMainMenuEventListener();
    static final ButtonZoomEventListener zoomButtonListener = new ButtonZoomEventListener();
    // Responses:
    static final TooltipResponseMoveEventListener responseTooltipListener = new TooltipResponseMoveEventListener();
    static final SetContentEventListener nextResponsePageListener = new SetContentEventListener().nextPage();
    static final SetContentEventListener previousResponsePageListener = new SetContentEventListener().previousPage();
    // Temporary ones to clear:
    static final Map<Document, List<EventListenerData>> EventListenerDataMap = new HashMap<>();
    /**
     * Sets up buttons and hotkeys.
     */
    public final List<KeyCode> buttonsPressed = new ArrayList<>();
    ...
    private void setUpButtons() {
        ...
        actionKeyPressed = new EventHandler<KeyEvent>() {
            ...
            private void printAlreadyExistingBinding(String primarySecondary, String actionName, String eventCodeName) {
                Main.game.getTextStartStringBuilder().append("<p style='text-align:center;'>" + "<b style='color:").append(PresetColour.GENERIC_BAD.toWebHexString()).append(";'>The key '").append(eventCodeName).append("' is already the ").append(primarySecondary).append(" bind for the action '").append(actionName).append("'!</b>").append("</p>");
                Main.game.setContent(new Response("", "", Main.game.getCurrentDialogueNode()));
            }
...
//							System.out.println(Main.sex.isSexStarted());
                                ...
                                if (event.getCode() == KeyCode.ENTER) {
                                    ...
                                    if (Main.mainController.getWebEngine().executeScript("document.getElementById('nameInput')") != null) {
                                        ...
                                        if (Main.mainController.getWebEngine().getDocument() != null) {
                                            unsuitableName = Main.mainController.getWebEngine().getDocument().getElementById("hiddenFieldName").getTextContent().isEmpty()
                        ...
                        if (((boolean) Main.mainController.getWebEngine().executeScript("document.getElementById('offspringPetNameInput') === document.activeElement"))) {
                            ...
                            if (event.getCode() == KeyCode.ENTER) {
                                ...
                                if (Main.mainController.getWebEngine().executeScript("document.getElementById('offspringPetNameInput')") != null) {
                                    ...
                                    if (Main.mainController.getWebEngine().getDocument() != null) {
                                        unsuitableName = Main.mainController.getWebEngine().getDocument().getElementById("hiddenFieldName").getTextContent().length() < 2
                                                || Main.mainController.getWebEngine().getDocument().getElementById("hiddenFieldName").getTextContent().length() > 32;
                                    }
    ...
    private void setUpWebViews() {
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngineTooltip.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewTooltip_stylesheet_light.css").toExternalForm());
        } else {
            webEngineTooltip.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewTooltip_stylesheet.css").toExternalForm());
        }
...
//		webEngine.setJavaScriptEnabled(false);
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngine.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webView_stylesheet_light.css").toExternalForm());
        } else {
            webEngine.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webView_stylesheet.css").toExternalForm());
        }
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngineButtonsLeft.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet_light.css").toExternalForm());
        } else {
            webEngineButtonsLeft.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet.css").toExternalForm());
        }
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngineButtonsRight.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet_light.css").toExternalForm());
        } else {
            webEngineButtonsRight.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet.css").toExternalForm());
        }
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngineAttributes.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet_light.css").toExternalForm());
        } else {
            webEngineAttributes.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet.css").toExternalForm());
        }
        ...
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            webEngineRight.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet_light.css").toExternalForm());
        } else {
            webEngineRight.setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet.css").toExternalForm());
        }
    ...
    private void manageMainListeners() {
        ...
        if (!Game.informationTooltips.isEmpty()) {
    ...
    private void manageButtonLeftListeners() {
        ...
        if (documentButtonsLeft.getElementById("mainMenu") != null) {
        ...
        if (documentButtonsLeft.getElementById("inventory") != null) {
        ...
        if (documentButtonsLeft.getElementById("journal") != null) {
        ...
        if (documentButtonsLeft.getElementById("charactersPresent") != null) {
        ...
        if (documentButtonsLeft.getElementById("mapZoom") != null) {
    ...
    private void manageButtonRightListeners() {
        ...
        if (documentButtonsRight.getElementById(id) != null) {
            ...
            MainController.addEventListener(documentButtonsRight, id, "mouseenter", new TooltipInformationEventListener().setInformation(
                    Main.game.getCurrentDialogueNode().getLabel().equals("") || Main.game.getCurrentDialogueNode().getLabel() == null ? "-" : Main.game.getCurrentDialogueNode().getLabel(),
    ...
    private void manageAttributeListeners() {
        ...
        if (documentAttributes.getElementById(id) != null) {
            ...
            if (Main.game.isBadEnd()) {
                ...
                if (!dateKnown) {
                    ...
                    dateSB.append("The current date is: [style.colourGood(").append(Main.game.getDisplayDate(true)).append(")]");
                }
                dateSB.append("<br/>");
                dateSB.append("It is currently ").append(UtilText.generateSingularDeterminer(day)).append(" [style.colourBlueLight(").append(day).append(")].<br/>").append("You've been in this new world for: [style.colourExcellent(").append(Main.game.getDayNumber()).append(" day").append(Main.game.getDayNumber() > 1 ? "s" : "").append(")]");
        ...
        if (documentAttributes.getElementById(id) != null) {
            ...
            if (Main.game.isBadEnd()) {
                ...
                timeSB.append("Current time: ").append(Units.time(Main.game.getDateNow())).append(" (<span style='color:").append(dp.getColour().toWebHexString()).append(";'>").append(Util.capitaliseSentence(dp.getName())).append("</span>)<br/>").append("Sunrise: ").append(!dateKnown ? "[style.colourMinorBad(??/??/??)] [style.colourYellow(" + Units.time(ldt[0]) : "[style.colourYellow(" + Units.dateTime(ldt[0])).append(")]<br/>").append("Sunset: ").append(!dateKnown ? "[style.colourMinorBad(??/??/??)] [style.colourOrange(" + Units.time(ldt[1]) : "[style.colourOrange(" + Units.dateTime(ldt[1])).append(")]<br/>").append("<i>Click to toggle the time display between a 24-hour and 12-hour clock.</i>");
            }
            TooltipInformationEventListener el2 = new TooltipInformationEventListener().setInformation(
...
//										|| Main.game.getCurrentDialogueNode().getDialogueNodeType() == DialogueNodeType.OCCUPANT_MANAGEMENT
            ...
            for (AbstractFetish f : character.getFetishes(true)) {
                if (documentAttributes.getElementById("FETISH_" + idModifier + Fetish.getIdFromFetish(f)) != null) {
            ...
            for (Spell s : character.getAllSpells()) {
                if (documentAttributes.getElementById("SPELL_" + idModifier + s) != null) {
    ...
    private void manageRightListeners() {
        ...
        for (InventorySlot invSlot : InventorySlot.values()) {
            ...
            if (!invSlot.isWeapon()) {
                if (documentRight.getElementById(id) != null) {
                    if (concealedSlots.containsKey(invSlot)) {
            ...
            if (Main.game.isStarted()) {
                ...
                for (Population pop : Main.game.getPlayer().getLocationPlace().getPlaceType().getPopulation()) {
                    ...
                    if (documentRight.getElementById(id) != null) {
                        ...
                        Set<AbstractSubspecies> subspecies = new HashSet<>(pop.getSpecies().keySet());
        ...
        for (GameCharacter character : charactersBeingRendered) {
            ...
            for (AbstractAttribute a : attributes) {
                if (documentRight.getElementById("NPC_" + idModifier + a.getName()) != null) {
            ...
            if (documentRight.getElementById("NPC_" + idModifier + "ATTRIBUTES") != null) {
            ...
            if (RenderingEngine.ENGINE.isRenderingCharactersRightPanel()) {
                ...
                for (AbstractFetish f : character.getFetishes(true)) {
                    if (documentRight.getElementById("FETISH_NPC_" + idModifier + Fetish.getIdFromFetish(f)) != null) {
                ...
                for (Spell s : character.getAllSpells()) {
                    if (documentRight.getElementById("SPELL_" + idModifier + s) != null) {
...
//					Main.game.setContent(new Response("", "", Main.game.getDefaultDialogue(false)));
    ...
    public void switchTheme() {
        if (Main.getProperties().hasValue(PropertyValue.lightTheme)) {
            getWebEngineTooltip().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewTooltip_stylesheet.css").toExternalForm());
            getWebEngine().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webView_stylesheet.css").toExternalForm());
            getWebEngineButtonsLeft().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet.css").toExternalForm());
            getWebEngineButtonsRight().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet.css").toExternalForm());
            getWebEngineAttributes().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet.css").toExternalForm());
            getWebEngineRight().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet.css").toExternalForm());

            Main.mainScene.getStylesheets().clear();
            Main.mainScene.getStylesheets().add(FS.newResource("/com/lilithslegacy/res/css/stylesheet.css").toExternalForm());
            Main.primaryStage.setScene(Main.mainScene);
        } else {
            getWebEngineTooltip().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewTooltip_stylesheet_light.css").toExternalForm());
            getWebEngine().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webView_stylesheet_light.css").toExternalForm());
            getWebEngineButtonsLeft().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet_light.css").toExternalForm());
            getWebEngineButtonsRight().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewButtons_stylesheet_light.css").toExternalForm());
            getWebEngineAttributes().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet_light.css").toExternalForm());
            getWebEngineRight().setUserStyleSheetLocation(FS.newResource("/com/lilithslegacy/res/css/webViewAttributes_stylesheet_light.css").toExternalForm());

            Main.mainScene.getStylesheets().clear();
            Main.mainScene.getStylesheets().add("/com/lilithslegacy/res/css/stylesheet_light.css");
            Main.primaryStage.setScene(Main.mainScene);
        }
