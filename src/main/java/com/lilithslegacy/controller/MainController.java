...
import com.lilithslegacy.controller.eventListeners.buttons.*;
import com.lilithslegacy.controller.eventListeners.tooltips.*;
...
import com.lilithslegacy.game.dialogue.utils.*;
...
//							System.out.println(Main.sex.isSexStarted());
    ...
    private void unbindListeners(Document document) {
        ...
        if (document != null) {
            for (EventListenerData data : EventListenerDataMap.get(document)) {
                if (data.documentHolder)
                    ((EventTarget) document.getDocumentElement()).removeEventListener(data.type, data.listener, data.useCapture);
                else
    ...
    static void addCapturingEventListener(Document document, String ID, String type, EventListener listener, boolean useCapture) {
        ((EventTarget) document.getDocumentElement()).addEventListener(type, new EventListener() {
            @Override
        ...
        EventListenerDataMap.get(document).add(new EventListenerData(ID, type, listener, useCapture, true));
    }
...
//		webEngine.setJavaScriptEnabled(false);
    ...
    private void manageButtonLeftListeners() {
        ...
        if (((EventTarget) documentButtonsLeft.getElementById("inventory")) != null) {
            MainController.addCapturingEventListener(documentButtonsLeft, "inventory", "click", inventoryButtonListener, true);
        ...
        if (((EventTarget) documentButtonsLeft.getElementById("journal")) != null) {
            MainController.addCapturingEventListener(documentButtonsLeft, "journal", "click", journalButtonListener, true);
        ...
        if (((EventTarget) documentButtonsLeft.getElementById("charactersPresent")) != null) {
            MainController.addCapturingEventListener(documentButtonsLeft, "charactersPresent", "click", charactersPresentButtonListener, true);
        ...
        if (((EventTarget) documentButtonsLeft.getElementById("mapZoom")) != null) {
            MainController.addCapturingEventListener(documentButtonsLeft, "mapZoom", "click", zoomButtonListener, true);
    ...
    private void manageButtonRightListeners() {
        ...
        if (((EventTarget) documentButtonsRight.getElementById("quickSave")) != null) {
            addCapturingEventListener(documentButtonsRight, "quickSave", "click", e -> {
                Main.quickSaveGame();
            }, false);
        ...
        if (((EventTarget) documentButtonsRight.getElementById("quickLoad")) != null) {
            addCapturingEventListener(documentButtonsRight, "quickLoad", "click", e -> {
                Main.quickLoadGame();
            }, false);
        ...
        if (((EventTarget) documentButtonsRight.getElementById(id)) != null) {
            MainController.addCapturingEventListener(documentButtonsRight, id, "click", copyDialogueButtonListener, false);
        ...
        if (((EventTarget) documentButtonsRight.getElementById(id)) != null) {
            ...
            if (exportAvailable) {
                ...
                MainController.addCapturingEventListener(documentButtonsRight, id, "click", e -> {
