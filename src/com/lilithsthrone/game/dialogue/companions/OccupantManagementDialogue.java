				...
				"<div class='container-full-width inner' style='margin-bottom:0;"+(alternateBackground?"background:"+PresetColour.BACKGROUND_ALT.toWebHexString()+";'":"'")+"'>"
						+ "<div style='width:20%; float:left; margin:0; padding:0;'>"
							...
							+ "<span style='color:"+slave.getRace().getColour().toWebHexString()+";'>"
								+Util.capitaliseSentence((slave.showWinged()?"winged ":"")+(slave.isFeminine()?slave.getSubspecies().getSingularFemaleName(slave.getBody()):slave.getSubspecies().getSingularMaleName(slave.getBody())))+"</span><br/>"
				...
				"<div class='container-full-width inner' style='margin-bottom:0;"+(alternateBackground?"background:"+PresetColour.BACKGROUND_ALT.toWebHexString()+";'":"'")+"'>"
						+ "<div style='width:20%; float:left; margin:0; padding:0;'>"
							...
							+ "<span style='color:"+occupant.getRace().getColour().toWebHexString()+";'>"
								+Util.capitaliseSentence((occupant.showWinged()?"winged ":"")+(occupant.isFeminine()?occupant.getSubspecies().getSingularFemaleName(occupant.getBody()):occupant.getSubspecies().getSingularMaleName(occupant.getBody())))+"</span><br/>"
