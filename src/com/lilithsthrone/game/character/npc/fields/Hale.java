 ...
 * @author Innoxia
 */
public class Hale extends NPC {

	public Hale() {
		this(false);
	}
	
	public Hale(boolean isImported) {
		super(isImported, new NameTriplet("Hale"), "Loviennemartu",
				"Hale is one of the two baphomets who operate the blacksmiths, 'The Ninth Strike', in Elis's shopping precinct."
						+ " While most of his work involves manufacturing or repairing mundane items and machinery, his real passion is creating ranged weapons.",
				41, Month.MAY, 8,
				25,
		...
		this.setGenericName("grey-furred baphomet");
	...
	public void setStartingBody(boolean setPersona) {
		...
		if(setPersona) {
			...
			this.addFetish(Fetish.FETISH_LEG_LOVER);
...
//		this.setAssPlasticity(OrificePlasticity.THREE_RESILIENT.getValue());
	...
	public void equipClothing(List<EquipClothingSetting> settings) {
		...
		this.equipClothingFromNowhere(Main.game.getItemGen().generateClothing("innoxia_eye_safety_glasses", PresetColour.CLOTHING_BLACK, PresetColour.CLOTHING_BLACK, PresetColour.CLOTHING_WHITE, false), true, this);
		this.equipClothingFromNowhere(Main.game.getItemGen().generateClothing("innoxia_leg_jeans", PresetColour.CLOTHING_BLACK, PresetColour.CLOTHING_STEEL, null, false), true, this);
	...
	public String getTraderDescription() {
		return UtilText.parseFromXMLFile("places/fields/elis/shops/blacksmith", "HALE_TRANSACTION_START");
	}
	...
	public void applyItemTransactionEffects(AbstractCoreItem itemSold, int quantity, int individualPrice, boolean soldToPlayer) {
		...
		if(soldToPlayer) {
			Main.game.appendToTextStartStringBuilder(UtilText.parseFromXMLFile("places/fields/elis/shops/blacksmith", "HALE_BUY_TRANSACTION_COMPLETE"));
		} else {
			Main.game.appendToTextStartStringBuilder(UtilText.parseFromXMLFile("places/fields/elis/shops/blacksmith", "HALE_SELL_TRANSACTION_COMPLETE"));
		}
	}
