 ...
 * @author Innoxia
 */
public class Lovienne extends NPC {

	public Lovienne() {
		this(false);
	}
	
	public Lovienne(boolean isImported) {
		super(isImported,
				new NameTriplet("Lovienne"), "Lilithmartuilani",
				"One of the seven elder Lilin, Lovienne is one of the most powerful beings in existence.",
				7901, Month.MARCH, 22,
				1000,
...
//		this.setBody(Gender.F_V_B_FEMALE, Subspecies.CENTAUR, RaceStage.GREATER, false);
		...
		this.setAgeAppearanceAbsolute(21);
	...
	protected Set<GameCharacter> getChildren() {
		...
		children.add(Main.game.getNpc(Saellatrix.class));
		children.add(Main.game.getNpc(Angelixx.class));
		
		if(Main.game.getDialogueFlags().hasFlag("innoxia_child_of_lovienne")) {
